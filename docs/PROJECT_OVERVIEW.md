...
> 专为中小学生（8-18岁）设计，参考 Duolingo、Kahoot 等成功教育 App 的设计语言。

#### 色彩系统
| 角色 | 名称 | 色值 | 用途 |
|------|------|------|------|
| 主色 | 活力蓝 | `#4A6CF7` | 主要按钮、标题、强调 |
| 辅色 | 珊瑚色 | `#FF6B6B` | 辅助操作、重要标记 |
| 点缀 | 琥珀金 | `#FFB84D` | 奖励、成就、高亮 |
| 成功 | 翡翠绿 | `#2DD4A8` | 掌握、正确、完成 |
| 背景 | 清爽白 | `#F5F7FA` | 页面背景 |
...
### 设计语言
- **风格**：青春活力风格，明亮、活泼、友好，专为中小学生打造
- **配色**：活力蓝 + 珊瑚色 + 琥珀金
- **图标**：统一使用 Ionicons 图标库
- **按钮**：主要 CTA 使用 pill 圆角形状，增大触摸区域
- **卡片**：圆角 16-24px，柔和阴影，宽敞内边距
