...
-- 6 word books with vocabulary for CET4, CET6, KAOYAN, IELTS, TOEFL, GRE
...
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, word_count = EXCLUDED.word_count;
...
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
...
-- KAOYAN words (197)
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000593-ba01-0000-0000-000000000000', 'adhere', '/ədˈhɪər/', 'v.', '[{"pos": "v.", "meaning": "坚持；粘附", "example": "You must adhere to the rules and regulations.", "translation": "你必须遵守规章制度。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000594-ba01-0000-0000-000000000000', 'administer', '/ədˈmɪnɪstər/', 'v.', '[{"pos": "v.", "meaning": "管理；执行", "example": "The committee administers the funds.", "translation": "委员会管理这些资金。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000595-ba01-0000-0000-000000000000', 'adolescent', '/ˌædəˈlesənt/', 'n.', '[{"pos": "n.", "meaning": "青少年", "example": "The program is designed for adolescents aged 13 to 18.", "translation": "该项目是为13至18岁的青少年设计的。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000596-ba01-0000-0000-000000000000', 'ambiguous', '/æmˈbɪɡjuəs/', 'adj.', '[{"pos": "adj.", "meaning": "模棱两可的；含糊的", "example": "The instructions were ambiguous and confusing.", "translation": "说明含糊不清，令人困惑。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000597-ba01-0000-0000-000000000000', 'amend', '/əˈmend/', 'v.', '[{"pos": "v.", "meaning": "修改；修正", "example": "The law was amended to include new provisions.", "translation": "该法律被修改以纳入新条款。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000598-ba01-0000-0000-000000000000', 'ample', '/ˈæmpəl/', 'adj.', '[{"pos": "adj.", "meaning": "充足的；丰富的", "example": "There is ample evidence to support the theory.", "translation": "有充足的证据支持这一理论。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000599-ba01-0000-0000-000000000000', 'apprehend', '/ˌæprɪˈhend/', 'v.', '[{"pos": "v.", "meaning": "逮捕；理解", "example": "The police apprehended the suspect within hours.", "translation": "警方在几小时内逮捕了嫌疑人。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000600-ba01-0000-0000-000000000000', 'approximate', '/əˈprɒksɪmət/', 'adj.', '[{"pos": "adj.", "meaning": "大约的；近似的", "example": "The approximate cost of the project is one million dollars.", "translation": "该项目的大约成本为一百万美元。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000601-ba01-0000-0000-000000000000', 'aspire', '/əˈspaɪər/', 'v.', '[{"pos": "v.", "meaning": "渴望；追求", "example": "She aspires to become a successful writer.", "translation": "她渴望成为一名成功的作家。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000602-ba01-0000-0000-000000000000', 'assert', '/əˈsɜːt/', 'v.', '[{"pos": "v.", "meaning": "断言；声称", "example": "He asserted his innocence throughout the trial.", "translation": "他在整个审判过程中都声称自己无罪。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000603-ba01-0000-0000-000000000000', 'assimilate', '/əˈsɪməleɪt/', 'v.', '[{"pos": "v.", "meaning": "吸收；同化", "example": "Immigrants often struggle to assimilate into a new culture.", "translation": "移民往往难以融入新文化。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000604-ba01-0000-0000-000000000000', 'authentic', '/ɔːˈθentɪk/', 'adj.', '[{"pos": "adj.", "meaning": "真实的；可靠的", "example": "The painting was confirmed to be authentic.", "translation": "这幅画被确认为真品。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000605-ba01-0000-0000-000000000000', 'autonomy', '/ɔːˈtɒnəmi/', 'n.', '[{"pos": "n.", "meaning": "自治；自主权", "example": "The region was granted greater autonomy.", "translation": "该地区被授予更大的自治权。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000606-ba01-0000-0000-000000000000', 'avert', '/əˈvɜːt/', 'v.', '[{"pos": "v.", "meaning": "避免；转移", "example": "Quick action averted a major disaster.", "translation": "迅速的行动避免了一场重大灾难。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000607-ba01-0000-0000-000000000000', 'biased', '/ˈbaɪəst/', 'adj.', '[{"pos": "adj.", "meaning": "有偏见的；偏袒的", "example": "The report was criticized for being biased.", "translation": "该报告因存在偏见而受到批评。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000608-ba01-0000-0000-000000000000', 'bureaucracy', '/bjʊˈrɒkrəsi/', 'n.', '[{"pos": "n.", "meaning": "官僚机构；官僚主义", "example": "Excessive bureaucracy slows down decision-making.", "translation": "过度的官僚主义会减慢决策速度。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000609-ba01-0000-0000-000000000000', 'calibrate', '/ˈkælɪbreɪt/', 'v.', '[{"pos": "v.", "meaning": "校准；调整", "example": "You need to calibrate the instrument before use.", "translation": "使用前需要校准仪器。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000610-ba01-0000-0000-000000000000', 'catastrophe', '/kəˈtæstrəfi/', 'n.', '[{"pos": "n.", "meaning": "灾难；大祸", "example": "The earthquake was a major catastrophe.", "translation": "这场地震是一场重大灾难。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000611-ba01-0000-0000-000000000000', 'chronic', '/ˈkrɒnɪk/', 'adj.', '[{"pos": "adj.", "meaning": "慢性的；长期的", "example": "He suffers from chronic back pain.", "translation": "他患有慢性背痛。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000612-ba01-0000-0000-000000000000', 'cite', '/saɪt/', 'v.', '[{"pos": "v.", "meaning": "引用；举例", "example": "She cited several studies to support her argument.", "translation": "她引用了几项研究来支持自己的论点。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000613-ba01-0000-0000-000000000000', 'collaborate', '/kəˈlæbəreɪt/', 'v.', '[{"pos": "v.", "meaning": "合作；协作", "example": "The two companies decided to collaborate on the project.", "translation": "两家公司决定在这个项目上合作。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000614-ba01-0000-0000-000000000000', 'commence', '/kəˈmens/', 'v.', '[{"pos": "v.", "meaning": "开始；着手", "example": "The ceremony will commence at nine o''clock.", "translation": "仪式将在九点开始。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000615-ba01-0000-0000-000000000000', 'compile', '/kəmˈpaɪl/', 'v.', '[{"pos": "v.", "meaning": "汇编；编辑", "example": "She compiled a list of all the participants.", "translation": "她汇编了一份所有参与者的名单。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000616-ba01-0000-0000-000000000000', 'complement', '/ˈkɒmplɪment/', 'v.', '[{"pos": "v.", "meaning": "补充；补足", "example": "The wine complements the meal perfectly.", "translation": "这顿酒与餐食完美搭配。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000617-ba01-0000-0000-000000000000', 'comprehensive', '/ˌkɒmprɪˈhensɪv/', 'adj.', '[{"pos": "adj.", "meaning": "全面的；综合的", "example": "The report provides a comprehensive analysis of the situation.", "translation": "该报告对情况进行了全面分析。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000618-ba01-0000-0000-000000000000', 'compromise', '/ˈkɒmprəmaɪz/', 'n.', '[{"pos": "n.", "meaning": "妥协；折中", "example": "They reached a compromise after long negotiations.", "translation": "经过长时间谈判，他们达成了妥协。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000619-ba01-0000-0000-000000000000', 'compulsory', '/kəmˈpʌlsəri/', 'adj.', '[{"pos": "adj.", "meaning": "强制的；义务的", "example": "Education is compulsory for children aged 5 to 16.", "translation": "5至16岁的儿童必须接受义务教育。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000620-ba01-0000-0000-000000000000', 'conceive', '/kənˈsiːv/', 'v.', '[{"pos": "v.", "meaning": "构想；怀孕", "example": "She conceived a plan to increase sales.", "translation": "她构想了一个增加销售的计划。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000621-ba01-0000-0000-000000000000', 'confine', '/kənˈfaɪn/', 'v.', '[{"pos": "v.", "meaning": "限制；禁闭", "example": "The discussion was confined to the main topic.", "translation": "讨论被限制在主要话题上。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000622-ba01-0000-0000-000000000000', 'conform', '/kənˈfɔːm/', 'v.', '[{"pos": "v.", "meaning": "遵守；符合", "example": "You must conform to the company''s dress code.", "translation": "你必须遵守公司的着装规范。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000623-ba01-0000-0000-000000000000', 'consensus', '/kənˈsensəs/', 'n.', '[{"pos": "n.", "meaning": "共识；一致意见", "example": "The committee reached a consensus on the issue.", "translation": "委员会就这个问题达成了共识。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000624-ba01-0000-0000-000000000000', 'consequent', '/ˈkɒnsɪkwənt/', 'adj.', '[{"pos": "adj.", "meaning": "随之发生的；作为结果的", "example": "The flood and consequent damage were devastating.", "translation": "洪水及其造成的破坏是毁灭性的。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000625-ba01-0000-0000-000000000000', 'conserve', '/kənˈsɜːv/', 'v.', '[{"pos": "v.", "meaning": "保存；节约", "example": "We must conserve water during the drought.", "translation": "干旱期间我们必须节约用水。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000626-ba01-0000-0000-000000000000', 'constitute', '/ˈkɒnstɪtjuːt/', 'v.', '[{"pos": "v.", "meaning": "构成；组成", "example": "Women constitute a majority of the workforce.", "translation": "女性构成了劳动力的大多数。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000627-ba01-0000-0000-000000000000', 'constrain', '/kənˈstreɪn/', 'v.', '[{"pos": "v.", "meaning": "限制；约束", "example": "Budget constraints limit our options.", "translation": "预算限制了我们的选择。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000628-ba01-0000-0000-000000000000', 'contemplate', '/ˈkɒntəmpleɪt/', 'v.', '[{"pos": "v.", "meaning": "沉思；考虑", "example": "She contemplated the meaning of life.", "translation": "她沉思人生的意义。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000629-ba01-0000-0000-000000000000', 'contend', '/kənˈtend/', 'v.', '[{"pos": "v.", "meaning": "竞争；主张", "example": "Several companies contend for the contract.", "translation": "几家公司竞争这份合同。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000630-ba01-0000-0000-000000000000', 'convene', '/kənˈviːn/', 'v.', '[{"pos": "v.", "meaning": "召集；集合", "example": "The board will convene tomorrow to discuss the matter.", "translation": "董事会明天将召开会议讨论此事。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000631-ba01-0000-0000-000000000000', 'convey', '/kənˈveɪ/', 'v.', '[{"pos": "v.", "meaning": "传达；运输", "example": "Words cannot convey how grateful I am.", "translation": "言语无法表达我有多么感激。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000632-ba01-0000-0000-000000000000', 'curb', '/kɜːb/', 'v.', '[{"pos": "v.", "meaning": "抑制；控制", "example": "The government took measures to curb inflation.", "translation": "政府采取措施抑制通货膨胀。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000633-ba01-0000-0000-000000000000', 'decisive', '/dɪˈsaɪsɪv/', 'adj.', '[{"pos": "adj.", "meaning": "决定性的；果断的", "example": "Her decisive leadership saved the company.", "translation": "她果断的领导拯救了公司。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000634-ba01-0000-0000-000000000000', 'deem', '/diːm/', 'v.', '[{"pos": "v.", "meaning": "认为；视为", "example": "The plan was deemed too risky.", "translation": "该计划被认为风险太大。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000635-ba01-0000-0000-000000000000', 'deficiency', '/dɪˈfɪʃənsi/', 'n.', '[{"pos": "n.", "meaning": "缺乏；不足", "example": "Vitamin D deficiency is common in winter.", "translation": "冬季维生素D缺乏很常见。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000636-ba01-0000-0000-000000000000', 'degrade', '/dɪˈɡreɪd/', 'v.', '[{"pos": "v.", "meaning": "降级；退化", "example": "Pollution can degrade the quality of water.", "translation": "污染会降低水质。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000637-ba01-0000-0000-000000000000', 'denote', '/dɪˈnəʊt/', 'v.', '[{"pos": "v.", "meaning": "表示；指示", "example": "The symbol ''X'' denotes the unknown variable.", "translation": "符号''X''表示未知变量。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000638-ba01-0000-0000-000000000000', 'depict', '/dɪˈpɪkt/', 'v.', '[{"pos": "v.", "meaning": "描绘；描述", "example": "The painting depicts a beautiful landscape.", "translation": "这幅画描绘了一幅美丽的风景。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000639-ba01-0000-0000-000000000000', 'deteriorate', '/dɪˈtɪəriəreɪt/', 'v.', '[{"pos": "v.", "meaning": "恶化；变坏", "example": "His health deteriorated rapidly.", "translation": "他的健康状况迅速恶化。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000640-ba01-0000-0000-000000000000', 'deviate', '/ˈdiːvieɪt/', 'v.', '[{"pos": "v.", "meaning": "偏离；背离", "example": "Do not deviate from the established procedures.", "translation": "不要偏离既定程序。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000641-ba01-0000-0000-000000000000', 'devise', '/dɪˈvaɪz/', 'v.', '[{"pos": "v.", "meaning": "设计；发明", "example": "They devised a plan to increase efficiency.", "translation": "他们设计了一个提高效率的计划。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000642-ba01-0000-0000-000000000000', 'diagnose', '/ˈdaɪəɡnəʊz/', 'v.', '[{"pos": "v.", "meaning": "诊断", "example": "The doctor diagnosed her with diabetes.", "translation": "医生诊断她患有糖尿病。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000643-ba01-0000-0000-000000000000', 'disclose', '/dɪsˈkləʊz/', 'v.', '[{"pos": "v.", "meaning": "揭露；公开", "example": "The company refused to disclose its financial records.", "translation": "公司拒绝公开其财务记录。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000644-ba01-0000-0000-000000000000', 'discourse', '/ˈdɪskɔːs/', 'n.', '[{"pos": "n.", "meaning": "论述；演讲", "example": "The professor delivered a discourse on modern philosophy.", "translation": "教授发表了关于现代哲学的演讲。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000645-ba01-0000-0000-000000000000', 'discrete', '/dɪˈskriːt/', 'adj.', '[{"pos": "adj.", "meaning": "离散的；不相关的", "example": "The data is divided into discrete categories.", "translation": "数据被分为离散的类别。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000646-ba01-0000-0000-000000000000', 'discriminate', '/dɪˈskrɪmɪneɪt/', 'v.', '[{"pos": "v.", "meaning": "歧视；区分", "example": "It is illegal to discriminate against people based on race.", "translation": "基于种族歧视是非法的。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000647-ba01-0000-0000-000000000000', 'displace', '/dɪsˈpleɪs/', 'v.', '[{"pos": "v.", "meaning": "取代；迫使离开", "example": "The war displaced thousands of families.", "translation": "战争迫使数千个家庭流离失所。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000648-ba01-0000-0000-000000000000', 'dispose', '/dɪˈspəʊz/', 'v.', '[{"pos": "v.", "meaning": "处理；处置", "example": "Please dispose of the waste properly.", "translation": "请妥善处理废物。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000649-ba01-0000-0000-000000000000', 'dispute', '/dɪˈspjuːt/', 'n.', '[{"pos": "n.", "meaning": "争端；纠纷", "example": "The two countries are trying to resolve their territorial dispute.", "translation": "两国正试图解决领土争端。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000650-ba01-0000-0000-000000000000', 'disrupt', '/dɪsˈrʌpt/', 'v.', '[{"pos": "v.", "meaning": "扰乱；中断", "example": "The protest disrupted traffic in the city center.", "translation": "抗议活动扰乱了市中心的交通。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000651-ba01-0000-0000-000000000000', 'distort', '/dɪˈstɔːt/', 'v.', '[{"pos": "v.", "meaning": "扭曲；歪曲", "example": "The media often distorts the facts.", "translation": "媒体常常歪曲事实。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000652-ba01-0000-0000-000000000000', 'divert', '/daɪˈvɜːt/', 'v.', '[{"pos": "v.", "meaning": "转移；使转向", "example": "Traffic was diverted to a different route.", "translation": "交通被分流到另一条路线。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000653-ba01-0000-0000-000000000000', 'doctrine', '/ˈdɒktrɪn/', 'n.', '[{"pos": "n.", "meaning": "教义；学说", "example": "The doctrine of free speech is fundamental to democracy.", "translation": "言论自由的学说是民主的基础。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000654-ba01-0000-0000-000000000000', 'domain', '/dəˈmeɪn/', 'n.', '[{"pos": "n.", "meaning": "领域；领地", "example": "This topic falls within the domain of psychology.", "translation": "这个话题属于心理学领域。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000655-ba01-0000-0000-000000000000', 'dominate', '/ˈdɒmɪneɪt/', 'v.', '[{"pos": "v.", "meaning": "支配；占主导地位", "example": "The company dominates the global market.", "translation": "该公司在全球市场占主导地位。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000656-ba01-0000-0000-000000000000', 'drain', '/dreɪn/', 'v.', '[{"pos": "v.", "meaning": "排出；耗尽", "example": "The long meeting drained everyone''s energy.", "translation": "漫长的会议耗尽了每个人的精力。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000657-ba01-0000-0000-000000000000', 'eligible', '/ˈelɪdʒəbəl/', 'adj.', '[{"pos": "adj.", "meaning": "有资格的；合格的", "example": "Only citizens are eligible to vote.", "translation": "只有公民才有资格投票。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000658-ba01-0000-0000-000000000000', 'empirical', '/ɪmˈpɪrɪkəl/', 'adj.', '[{"pos": "adj.", "meaning": "经验主义的；以观察为依据的", "example": "The theory is supported by empirical evidence.", "translation": "该理论有经验证据支持。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000659-ba01-0000-0000-000000000000', 'encounter', '/ɪnˈkaʊntər/', 'v.', '[{"pos": "v.", "meaning": "遇到；遭遇", "example": "We encountered several problems during the project.", "translation": "我们在项目期间遇到了几个问题。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000660-ba01-0000-0000-000000000000', 'enhance', '/ɪnˈhɑːns/', 'v.', '[{"pos": "v.", "meaning": "增强；提高", "example": "Technology can enhance the learning experience.", "translation": "技术可以增强学习体验。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000661-ba01-0000-0000-000000000000', 'enormous', '/ɪˈnɔːməs/', 'adj.', '[{"pos": "adj.", "meaning": "巨大的；庞大的", "example": "The project requires an enormous amount of resources.", "translation": "该项目需要大量的资源。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000662-ba01-0000-0000-000000000000', 'envisage', '/ɪnˈvɪzɪdʒ/', 'v.', '[{"pos": "v.", "meaning": "想象；设想", "example": "It is hard to envisage a world without technology.", "translation": "很难想象一个没有科技的世界。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000663-ba01-0000-0000-000000000000', 'equivalent', '/ɪˈkwɪvələnt/', 'adj.', '[{"pos": "adj.", "meaning": "等同的；相当的", "example": "One mile is equivalent to 1.6 kilometers.", "translation": "一英里相当于1.6公里。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000664-ba01-0000-0000-000000000000', 'erode', '/ɪˈrəʊd/', 'v.', '[{"pos": "v.", "meaning": "侵蚀；腐蚀", "example": "Wind and rain erode the mountains over time.", "translation": "风雨随着时间的推移侵蚀着山脉。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000665-ba01-0000-0000-000000000000', 'essence', '/ˈesəns/', 'n.', '[{"pos": "n.", "meaning": "本质；精华", "example": "The essence of the argument is about fairness.", "translation": "争论的本质是关于公平。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000666-ba01-0000-0000-000000000000', 'establish', '/ɪˈstæblɪʃ/', 'v.', '[{"pos": "v.", "meaning": "建立；确立", "example": "The company was established in 1990.", "translation": "该公司成立于1990年。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000667-ba01-0000-0000-000000000000', 'evaluate', '/ɪˈvæljueɪt/', 'v.', '[{"pos": "v.", "meaning": "评估；评价", "example": "The committee will evaluate all the proposals.", "translation": "委员会将评估所有提案。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000668-ba01-0000-0000-000000000000', 'evoke', '/ɪˈvəʊk/', 'v.', '[{"pos": "v.", "meaning": "唤起；引起", "example": "The song evoked memories of childhood.", "translation": "这首歌唤起了童年的回忆。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000669-ba01-0000-0000-000000000000', 'exaggerate', '/ɪɡˈzædʒəreɪt/', 'v.', '[{"pos": "v.", "meaning": "夸大；夸张", "example": "He tends to exaggerate his achievements.", "translation": "他倾向于夸大自己的成就。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000670-ba01-0000-0000-000000000000', 'exceed', '/ɪkˈsiːd/', 'v.', '[{"pos": "v.", "meaning": "超过；超越", "example": "Sales exceeded expectations this quarter.", "translation": "本季度销售额超出了预期。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000671-ba01-0000-0000-000000000000', 'excerpt', '/ˈeksɜːpt/', 'n.', '[{"pos": "n.", "meaning": "摘录；节选", "example": "She read an excerpt from the novel.", "translation": "她读了小说的一段摘录。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000672-ba01-0000-0000-000000000000', 'feasible', '/ˈfiːzəbəl/', 'adj.', '[{"pos": "adj.", "meaning": "可行的；可能的", "example": "The plan is technically feasible.", "translation": "该计划在技术上是可行的。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000673-ba01-0000-0000-000000000000', 'fluctuate', '/ˈflʌktʃueɪt/', 'v.', '[{"pos": "v.", "meaning": "波动；起伏", "example": "Oil prices fluctuate throughout the year.", "translation": "石油价格全年都在波动。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000674-ba01-0000-0000-000000000000', 'formidable', '/ˈfɔːmɪdəbəl/', 'adj.', '[{"pos": "adj.", "meaning": "强大的；令人敬畏的", "example": "She is a formidable opponent in the debate.", "translation": "她是辩论中一个强大的对手。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000675-ba01-0000-0000-000000000000', 'formulate', '/ˈfɔːmjəleɪt/', 'v.', '[{"pos": "v.", "meaning": "制定；阐述", "example": "The team formulated a new strategy.", "translation": "团队制定了一项新战略。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000676-ba01-0000-0000-000000000000', 'friction', '/ˈfrɪkʃən/', 'n.', '[{"pos": "n.", "meaning": "摩擦；摩擦力", "example": "There is friction between the two departments.", "translation": "两个部门之间存在摩擦。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000677-ba01-0000-0000-000000000000', 'fundamental', '/ˌfʌndəˈmentəl/', 'adj.', '[{"pos": "adj.", "meaning": "基本的；根本的", "example": "Education is a fundamental right.", "translation": "教育是一项基本权利。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000678-ba01-0000-0000-000000000000', 'genuine', '/ˈdʒenjuɪn/', 'adj.', '[{"pos": "adj.", "meaning": "真正的；真诚的", "example": "Her concern for others is genuine.", "translation": "她对他人的关心是真诚的。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000679-ba01-0000-0000-000000000000', 'grasp', '/ɡrɑːsp/', 'v.', '[{"pos": "v.", "meaning": "理解；抓住", "example": "He quickly grasped the main concepts.", "translation": "他很快就掌握了主要概念。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000680-ba01-0000-0000-000000000000', 'halt', '/hɔːlt/', 'v.', '[{"pos": "v.", "meaning": "停止；暂停", "example": "Production was halted due to the strike.", "translation": "由于罢工，生产停止了。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000681-ba01-0000-0000-000000000000', 'hierarchy', '/ˈhaɪərɑːki/', 'n.', '[{"pos": "n.", "meaning": "等级制度；层次结构", "example": "The company has a strict hierarchy.", "translation": "公司有严格的等级制度。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000682-ba01-0000-0000-000000000000', 'hinder', '/ˈhɪndər/', 'v.', '[{"pos": "v.", "meaning": "阻碍；妨碍", "example": "Lack of funding hindered the research.", "translation": "缺乏资金阻碍了研究。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000683-ba01-0000-0000-000000000000', 'hypothesis', '/haɪˈpɒθəsɪs/', 'n.', '[{"pos": "n.", "meaning": "假设；假说", "example": "The scientist tested her hypothesis through experiments.", "translation": "科学家通过实验检验了她的假设。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000684-ba01-0000-0000-000000000000', 'identical', '/aɪˈdentɪkəl/', 'adj.', '[{"pos": "adj.", "meaning": "相同的；完全一样的", "example": "The two documents are almost identical.", "translation": "这两份文件几乎完全相同。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000685-ba01-0000-0000-000000000000', 'illuminate', '/ɪˈluːmɪneɪt/', 'v.', '[{"pos": "v.", "meaning": "照亮；阐明", "example": "The study illuminates the causes of the disease.", "translation": "这项研究阐明了该疾病的原因。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000686-ba01-0000-0000-000000000000', 'immerse', '/ɪˈmɜːs/', 'v.', '[{"pos": "v.", "meaning": "沉浸；使陷入", "example": "She immersed herself in her studies.", "translation": "她全身心投入到学习中。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000687-ba01-0000-0000-000000000000', 'immune', '/ɪˈmjuːn/', 'adj.', '[{"pos": "adj.", "meaning": "免疫的；不受影响的", "example": "Some people are immune to the disease.", "translation": "有些人对该疾病免疫。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000688-ba01-0000-0000-000000000000', 'impair', '/ɪmˈpeər/', 'v.', '[{"pos": "v.", "meaning": "损害；削弱", "example": "Alcohol impairs your ability to drive.", "translation": "酒精会损害你的驾驶能力。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000689-ba01-0000-0000-000000000000', 'implement', '/ˈɪmplɪment/', 'v.', '[{"pos": "v.", "meaning": "实施；执行", "example": "The government plans to implement new policies.", "translation": "政府计划实施新政策。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000690-ba01-0000-0000-000000000000', 'impose', '/ɪmˈpəʊz/', 'v.', '[{"pos": "v.", "meaning": "强加；征收", "example": "The government imposed a tax on luxury goods.", "translation": "政府对奢侈品征税。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000691-ba01-0000-0000-000000000000', 'impulse', '/ˈɪmpʌls/', 'n.', '[{"pos": "n.", "meaning": "冲动；脉冲", "example": "She bought the dress on impulse.", "translation": "她一时冲动买了这条裙子。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000692-ba01-0000-0000-000000000000', 'incentive', '/ɪnˈsentɪv/', 'n.', '[{"pos": "n.", "meaning": "激励；动机", "example": "The bonus serves as an incentive for employees.", "translation": "奖金是对员工的一种激励。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000693-ba01-0000-0000-000000000000', 'incline', '/ɪnˈklaɪn/', 'v.', '[{"pos": "v.", "meaning": "倾斜；倾向于", "example": "I am inclined to agree with your proposal.", "translation": "我倾向于同意你的提议。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000694-ba01-0000-0000-000000000000', 'indicate', '/ˈɪndɪkeɪt/', 'v.', '[{"pos": "v.", "meaning": "表明；指示", "example": "The results indicate a positive trend.", "translation": "结果表明呈积极趋势。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000695-ba01-0000-0000-000000000000', 'inhibit', '/ɪnˈhɪbɪt/', 'v.', '[{"pos": "v.", "meaning": "抑制；阻止", "example": "Fear can inhibit personal growth.", "translation": "恐惧会抑制个人成长。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000696-ba01-0000-0000-000000000000', 'initiate', '/ɪˈnɪʃieɪt/', 'v.', '[{"pos": "v.", "meaning": "开始；发起", "example": "The company initiated a new marketing campaign.", "translation": "公司发起了一场新的营销活动。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000697-ba01-0000-0000-000000000000', 'innovate', '/ˈɪnəveɪt/', 'v.', '[{"pos": "v.", "meaning": "创新；革新", "example": "Companies must innovate to stay competitive.", "translation": "公司必须创新以保持竞争力。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000698-ba01-0000-0000-000000000000', 'insight', '/ˈɪnsaɪt/', 'n.', '[{"pos": "n.", "meaning": "洞察力；见解", "example": "The book provides valuable insights into human behavior.", "translation": "这本书提供了对人类行为的宝贵见解。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000699-ba01-0000-0000-000000000000', 'inspect', '/ɪnˈspekt/', 'v.', '[{"pos": "v.", "meaning": "检查；视察", "example": "Health inspectors regularly inspect restaurants.", "translation": "卫生检查员定期检查餐馆。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000700-ba01-0000-0000-000000000000', 'integrate', '/ˈɪntɪɡreɪt/', 'v.', '[{"pos": "v.", "meaning": "整合；融入", "example": "The school works to integrate technology into the curriculum.", "translation": "学校努力将技术融入课程。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000701-ba01-0000-0000-000000000000', 'integrity', '/ɪnˈteɡrəti/', 'n.', '[{"pos": "n.", "meaning": "正直；完整性", "example": "He is a man of great integrity.", "translation": "他是一个非常正直的人。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000702-ba01-0000-0000-000000000000', 'interact', '/ˌɪntərˈækt/', 'v.', '[{"pos": "v.", "meaning": "互动；相互作用", "example": "Students learn by interacting with each other.", "translation": "学生通过相互交流来学习。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000703-ba01-0000-0000-000000000000', 'interpret', '/ɪnˈtɜːprɪt/', 'v.', '[{"pos": "v.", "meaning": "解释；口译", "example": "Different people may interpret the same data differently.", "translation": "不同的人可能对同一数据有不同的解释。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000704-ba01-0000-0000-000000000000', 'intervene', '/ˌɪntəˈviːn/', 'v.', '[{"pos": "v.", "meaning": "干预；介入", "example": "The government intervened to stabilize the economy.", "translation": "政府进行了干预以稳定经济。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000705-ba01-0000-0000-000000000000', 'intimate', '/ˈɪntɪmət/', 'adj.', '[{"pos": "adj.", "meaning": "亲密的；私人的", "example": "They have been intimate friends for years.", "translation": "他们多年来一直是亲密的朋友。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000706-ba01-0000-0000-000000000000', 'irrelevant', '/ɪˈreləvənt/', 'adj.', '[{"pos": "adj.", "meaning": "不相关的；无关紧要的", "example": "Your comment is irrelevant to the discussion.", "translation": "你的评论与讨论无关。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000707-ba01-0000-0000-000000000000', 'isolate', '/ˈaɪsəleɪt/', 'v.', '[{"pos": "v.", "meaning": "隔离；孤立", "example": "The patient was isolated to prevent the spread of infection.", "translation": "患者被隔离以防止感染传播。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000708-ba01-0000-0000-000000000000', 'justify', '/ˈdʒʌstɪfaɪ/', 'v.', '[{"pos": "v.", "meaning": "证明...正当；为...辩护", "example": "He couldn''t justify his actions.", "translation": "他无法为自己的行为辩护。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000709-ba01-0000-0000-000000000000', 'legitimate', '/lɪˈdʒɪtɪmət/', 'adj.', '[{"pos": "adj.", "meaning": "合法的；正当的", "example": "The claim is legitimate and should be honored.", "translation": "这项索赔是合法的，应该予以兑现。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000710-ba01-0000-0000-000000000000', 'liable', '/ˈlaɪəbəl/', 'adj.', '[{"pos": "adj.", "meaning": "有责任的；有义务的", "example": "The company is liable for any damages.", "translation": "公司对任何损害负有责任。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000711-ba01-0000-0000-000000000000', 'likewise', '/ˈlaɪkwaɪz/', 'adv.', '[{"pos": "adv.", "meaning": "同样地；也", "example": "She enjoyed the film, and I likewise found it entertaining.", "translation": "她喜欢这部电影，我也觉得它很有趣。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000712-ba01-0000-0000-000000000000', 'lure', '/lʊər/', 'v.', '[{"pos": "v.", "meaning": "引诱；诱惑", "example": "The promise of high salaries lured many applicants.", "translation": "高薪的承诺吸引了许多申请者。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000713-ba01-0000-0000-000000000000', 'magnitude', '/ˈmæɡnɪtjuːd/', 'n.', '[{"pos": "n.", "meaning": "巨大；重要性；震级", "example": "The magnitude of the problem is only now becoming clear.", "translation": "这个问题的严重性直到现在才变得清晰。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000714-ba01-0000-0000-000000000000', 'mandatory', '/ˈmændətəri/', 'adj.', '[{"pos": "adj.", "meaning": "强制的；必须的", "example": "Attendance at the meeting is mandatory.", "translation": "出席会议是强制性的。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000715-ba01-0000-0000-000000000000', 'manipulate', '/məˈnɪpjəleɪt/', 'v.', '[{"pos": "v.", "meaning": "操纵；操作", "example": "He tried to manipulate the situation to his advantage.", "translation": "他试图操纵局势以利于自己。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000716-ba01-0000-0000-000000000000', 'margin', '/ˈmɑːdʒɪn/', 'n.', '[{"pos": "n.", "meaning": "边缘；利润；差额", "example": "The company operates on a narrow profit margin.", "translation": "公司的利润率很薄。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000717-ba01-0000-0000-000000000000', 'mechanism', '/ˈmekənɪzəm/', 'n.', '[{"pos": "n.", "meaning": "机制；机械装置", "example": "The clock has a complex mechanism.", "translation": "这个钟有一个复杂的机械装置。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000718-ba01-0000-0000-000000000000', 'mediate', '/ˈmiːdieɪt/', 'v.', '[{"pos": "v.", "meaning": "调解；斡旋", "example": "A neutral party mediated the dispute.", "translation": "一个中立方调解了争端。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000719-ba01-0000-0000-000000000000', 'migrate', '/maɪˈɡreɪt/', 'v.', '[{"pos": "v.", "meaning": "迁移；移居", "example": "Many birds migrate south in winter.", "translation": "许多鸟类在冬天向南迁移。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000720-ba01-0000-0000-000000000000', 'minimize', '/ˈmɪnɪmaɪz/', 'v.', '[{"pos": "v.", "meaning": "最小化；减少", "example": "We must minimize the risk of failure.", "translation": "我们必须将失败的风险降到最低。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000721-ba01-0000-0000-000000000000', 'modify', '/ˈmɒdɪfaɪ/', 'v.', '[{"pos": "v.", "meaning": "修改；改变", "example": "The plan was modified to meet new requirements.", "translation": "计划被修改以满足新要求。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000722-ba01-0000-0000-000000000000', 'monitor', '/ˈmɒnɪtər/', 'v.', '[{"pos": "v.", "meaning": "监控；监测", "example": "Doctors monitor the patient''s vital signs.", "translation": "医生监测患者的生命体征。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000723-ba01-0000-0000-000000000000', 'negate', '/nɪˈɡeɪt/', 'v.', '[{"pos": "v.", "meaning": "否定；取消", "example": "His actions negated all our efforts.", "translation": "他的行为否定了我们所有的努力。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000724-ba01-0000-0000-000000000000', 'negotiate', '/nɪˈɡəʊʃieɪt/', 'v.', '[{"pos": "v.", "meaning": "谈判；协商", "example": "The unions negotiated with management for better conditions.", "translation": "工会与管理层谈判以争取更好的条件。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000725-ba01-0000-0000-000000000000', 'norm', '/nɔːm/', 'n.', '[{"pos": "n.", "meaning": "规范；标准", "example": "Working from home has become the norm.", "translation": "在家工作已成为常态。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000726-ba01-0000-0000-000000000000', 'notable', '/ˈnəʊtəbəl/', 'adj.', '[{"pos": "adj.", "meaning": "值得注意的；显著的", "example": "There has been a notable improvement in her work.", "translation": "她的工作有了显著的进步。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000727-ba01-0000-0000-000000000000', 'notion', '/ˈnəʊʃən/', 'n.', '[{"pos": "n.", "meaning": "概念；想法", "example": "I reject the notion that money equals happiness.", "translation": "我拒绝接受金钱等于幸福的观念。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000728-ba01-0000-0000-000000000000', 'nurture', '/ˈnɜːtʃər/', 'v.', '[{"pos": "v.", "meaning": "培养；养育", "example": "Parents nurture their children with love and care.", "translation": "父母用爱和关怀养育孩子。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000729-ba01-0000-0000-000000000000', 'obligation', '/ˌɒblɪˈɡeɪʃən/', 'n.', '[{"pos": "n.", "meaning": "义务；责任", "example": "You are under no obligation to accept.", "translation": "你没有义务接受。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000730-ba01-0000-0000-000000000000', 'obscure', '/əbˈskjʊər/', 'adj.', '[{"pos": "adj.", "meaning": "模糊的；晦涩的", "example": "The meaning of the poem is obscure.", "translation": "这首诗的含义很晦涩。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000731-ba01-0000-0000-000000000000', 'observe', '/əbˈzɜːv/', 'v.', '[{"pos": "v.", "meaning": "观察；遵守", "example": "Scientists observe the behavior of animals in the wild.", "translation": "科学家观察野生动物的行为。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000732-ba01-0000-0000-000000000000', 'obtain', '/əbˈteɪn/', 'v.', '[{"pos": "v.", "meaning": "获得；得到", "example": "She obtained a degree in engineering.", "translation": "她获得了工程学学位。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000733-ba01-0000-0000-000000000000', 'ongoing', '/ˈɒnɡəʊɪŋ/', 'adj.', '[{"pos": "adj.", "meaning": "进行中的；持续的", "example": "There is an ongoing investigation into the matter.", "translation": "对此事正在进行调查。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000734-ba01-0000-0000-000000000000', 'opt', '/ɒpt/', 'v.', '[{"pos": "v.", "meaning": "选择；决定", "example": "She opted to take the train instead of driving.", "translation": "她选择乘火车而不是开车。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000735-ba01-0000-0000-000000000000', 'orient', '/ˈɔːrient/', 'v.', '[{"pos": "v.", "meaning": "使适应；确定方向", "example": "The program helps new employees orient themselves.", "translation": "该项目帮助新员工适应环境。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000736-ba01-0000-0000-000000000000', 'outcome', '/ˈaʊtkʌm/', 'n.', '[{"pos": "n.", "meaning": "结果；后果", "example": "The outcome of the election was unexpected.", "translation": "选举结果出乎意料。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000737-ba01-0000-0000-000000000000', 'outline', '/ˈaʊtlaɪn/', 'v.', '[{"pos": "v.", "meaning": "概述；描画轮廓", "example": "She outlined the main points of her proposal.", "translation": "她概述了提案的要点。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000738-ba01-0000-0000-000000000000', 'overlap', '/ˌəʊvəˈlæp/', 'v.', '[{"pos": "v.", "meaning": "重叠；部分相同", "example": "The two projects overlap in several areas.", "translation": "这两个项目在几个领域有重叠。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000739-ba01-0000-0000-000000000000', 'overwhelm', '/ˌəʊvəˈwelm/', 'v.', '[{"pos": "v.", "meaning": "压倒；使不知所措", "example": "The amount of work overwhelmed her.", "translation": "工作量让她不知所措。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000740-ba01-0000-0000-000000000000', 'parallel', '/ˈpærəlel/', 'adj.', '[{"pos": "adj.", "meaning": "平行的；类似的", "example": "The two roads run parallel to each other.", "translation": "这两条路彼此平行。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000741-ba01-0000-0000-000000000000', 'perceive', '/pəˈsiːv/', 'v.', '[{"pos": "v.", "meaning": "感知；认为", "example": "She perceived a change in his attitude.", "translation": "她察觉到他态度的变化。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000742-ba01-0000-0000-000000000000', 'persist', '/pəˈsɪst/', 'v.', '[{"pos": "v.", "meaning": "坚持；持续", "example": "If symptoms persist, consult a doctor.", "translation": "如果症状持续，请咨询医生。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000743-ba01-0000-0000-000000000000', 'perspective', '/pəˈspektɪv/', 'n.', '[{"pos": "n.", "meaning": "观点；视角", "example": "Try to see the problem from a different perspective.", "translation": "试着从不同的角度看这个问题。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000744-ba01-0000-0000-000000000000', 'phenomenon', '/fɪˈnɒmɪnən/', 'n.', '[{"pos": "n.", "meaning": "现象", "example": "Global warming is a well-documented phenomenon.", "translation": "全球变暖是一个有充分记录的现象。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000745-ba01-0000-0000-000000000000', 'pledge', '/pledʒ/', 'v.', '[{"pos": "v.", "meaning": "保证；承诺", "example": "The government pledged to reduce pollution.", "translation": "政府承诺减少污染。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000746-ba01-0000-0000-000000000000', 'portray', '/pɔːˈtreɪ/', 'v.', '[{"pos": "v.", "meaning": "描绘；扮演", "example": "The actor portrayed the historical figure brilliantly.", "translation": "这位演员出色地扮演了这个历史人物。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000747-ba01-0000-0000-000000000000', 'postpone', '/pəˈspəʊn/', 'v.', '[{"pos": "v.", "meaning": "推迟；延期", "example": "The meeting was postponed until next week.", "translation": "会议被推迟到下周。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000748-ba01-0000-0000-000000000000', 'potential', '/pəˈtenʃəl/', 'n.', '[{"pos": "n.", "meaning": "潜力；可能性", "example": "She has the potential to become a great leader.", "translation": "她有成为伟大领袖的潜力。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000749-ba01-0000-0000-000000000000', 'precede', '/prɪˈsiːd/', 'v.', '[{"pos": "v.", "meaning": "先于；在...之前", "example": "A brief introduction preceded the main lecture.", "translation": "主讲之前有一段简短的介绍。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000750-ba01-0000-0000-000000000000', 'precise', '/prɪˈsaɪs/', 'adj.', '[{"pos": "adj.", "meaning": "精确的；准确的", "example": "Please give me the precise time of the meeting.", "translation": "请告诉我会议的确切时间。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000751-ba01-0000-0000-000000000000', 'predict', '/prɪˈdɪkt/', 'v.', '[{"pos": "v.", "meaning": "预测；预言", "example": "It is difficult to predict the weather accurately.", "translation": "准确预测天气是很困难的。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000752-ba01-0000-0000-000000000000', 'presume', '/prɪˈzjuːm/', 'v.', '[{"pos": "v.", "meaning": "假定；认为", "example": "I presume you have already read the instructions.", "translation": "我假定你已经读过说明了。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000753-ba01-0000-0000-000000000000', 'prior', '/ˈpraɪər/', 'adj.', '[{"pos": "adj.", "meaning": "优先的；在前的", "example": "Prior experience is required for this position.", "translation": "这个职位需要先前的经验。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000754-ba01-0000-0000-000000000000', 'prohibit', '/prəˈhɪbɪt/', 'v.', '[{"pos": "v.", "meaning": "禁止；阻止", "example": "Smoking is prohibited in public buildings.", "translation": "公共建筑内禁止吸烟。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000755-ba01-0000-0000-000000000000', 'prompt', '/prɒmpt/', 'v.', '[{"pos": "v.", "meaning": "促使；提示", "example": "The discovery prompted further research.", "translation": "这一发现促使了进一步的研究。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000756-ba01-0000-0000-000000000000', 'proportion', '/prəˈpɔːʃən/', 'n.', '[{"pos": "n.", "meaning": "比例；部分", "example": "A large proportion of the budget goes to education.", "translation": "预算的很大一部分用于教育。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000757-ba01-0000-0000-000000000000', 'qualitative', '/ˈkwɒlɪtətɪv/', 'adj.', '[{"pos": "adj.", "meaning": "定性的；性质上的", "example": "The study uses qualitative research methods.", "translation": "该研究使用定性研究方法。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000758-ba01-0000-0000-000000000000', 'quantify', '/ˈkwɒntɪfaɪ/', 'v.', '[{"pos": "v.", "meaning": "量化；确定数量", "example": "It is difficult to quantify the benefits of exercise.", "translation": "很难量化锻炼的好处。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000759-ba01-0000-0000-000000000000', 'random', '/ˈrændəm/', 'adj.', '[{"pos": "adj.", "meaning": "随机的；任意的", "example": "The participants were selected at random.", "translation": "参与者是随机选出的。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000760-ba01-0000-0000-000000000000', 'rational', '/ˈræʃənəl/', 'adj.', '[{"pos": "adj.", "meaning": "理性的；合理的", "example": "We need to make rational decisions.", "translation": "我们需要做出理性的决定。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000761-ba01-0000-0000-000000000000', 'realm', '/relm/', 'n.', '[{"pos": "n.", "meaning": "领域；王国", "example": "This discovery opened up new realms of possibility.", "translation": "这一发现开辟了新的可能性领域。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000762-ba01-0000-0000-000000000000', 'refine', '/rɪˈfaɪn/', 'v.', '[{"pos": "v.", "meaning": "精炼；改进", "example": "She refined her essay through several drafts.", "translation": "她通过几次修改完善了她的论文。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000763-ba01-0000-0000-000000000000', 'reform', '/rɪˈfɔːm/', 'n.', '[{"pos": "n.", "meaning": "改革；改良", "example": "The government introduced economic reforms.", "translation": "政府推出了经济改革。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000764-ba01-0000-0000-000000000000', 'refrain', '/rɪˈfreɪn/', 'v.', '[{"pos": "v.", "meaning": "克制；避免", "example": "Please refrain from smoking in the building.", "translation": "请勿在大楼内吸烟。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000765-ba01-0000-0000-000000000000', 'regime', '/reɪˈʒiːm/', 'n.', '[{"pos": "n.", "meaning": "政权；制度", "example": "The old regime was overthrown in a revolution.", "translation": "旧政权在一场革命中被推翻。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000766-ba01-0000-0000-000000000000', 'reinforce', '/ˌriːɪnˈfɔːs/', 'v.', '[{"pos": "v.", "meaning": "加强；增援", "example": "The evidence reinforced her argument.", "translation": "证据加强了她的论点。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000767-ba01-0000-0000-000000000000', 'reluctant', '/rɪˈlʌktənt/', 'adj.', '[{"pos": "adj.", "meaning": "不情愿的；勉强的", "example": "He was reluctant to admit his mistake.", "translation": "他不情愿承认自己的错误。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000768-ba01-0000-0000-000000000000', 'render', '/ˈrendər/', 'v.', '[{"pos": "v.", "meaning": "使成为；提供", "example": "The accident rendered him unconscious.", "translation": "事故使他失去了知觉。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000769-ba01-0000-0000-000000000000', 'reproduce', '/ˌriːprəˈdjuːs/', 'v.', '[{"pos": "v.", "meaning": "复制；繁殖", "example": "The experiment was difficult to reproduce.", "translation": "这个实验很难复制。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000770-ba01-0000-0000-000000000000', 'resemble', '/rɪˈzembəl/', 'v.', '[{"pos": "v.", "meaning": "类似；像", "example": "She strongly resembles her mother.", "translation": "她长得很像她母亲。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000771-ba01-0000-0000-000000000000', 'reside', '/rɪˈzaɪd/', 'v.', '[{"pos": "v.", "meaning": "居住；存在", "example": "The power resides in the hands of the people.", "translation": "权力掌握在人民手中。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000772-ba01-0000-0000-000000000000', 'resolve', '/rɪˈzɒlv/', 'v.', '[{"pos": "v.", "meaning": "解决；决心", "example": "They resolved the conflict through negotiation.", "translation": "他们通过谈判解决了冲突。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000773-ba01-0000-0000-000000000000', 'resort', '/rɪˈzɔːt/', 'v.', '[{"pos": "v.", "meaning": "诉诸；求助", "example": "They had to resort to legal action.", "translation": "他们不得不诉诸法律行动。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000774-ba01-0000-0000-000000000000', 'restore', '/rɪˈstɔːr/', 'v.', '[{"pos": "v.", "meaning": "恢复；修复", "example": "The old building was carefully restored.", "translation": "这座老建筑被精心修复了。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000775-ba01-0000-0000-000000000000', 'retain', '/rɪˈteɪn/', 'v.', '[{"pos": "v.", "meaning": "保留；保持", "example": "She retained her title as champion.", "translation": "她保留了冠军头衔。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000776-ba01-0000-0000-000000000000', 'retrieve', '/rɪˈtriːv/', 'v.', '[{"pos": "v.", "meaning": "检索；取回", "example": "You can retrieve the data from the database.", "translation": "你可以从数据库中检索数据。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000777-ba01-0000-0000-000000000000', 'reveal', '/rɪˈviːl/', 'v.', '[{"pos": "v.", "meaning": "揭示；透露", "example": "The investigation revealed the truth.", "translation": "调查揭示了真相。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000778-ba01-0000-0000-000000000000', 'reverse', '/rɪˈvɜːs/', 'v.', '[{"pos": "v.", "meaning": "颠倒；撤销", "example": "The court reversed the decision.", "translation": "法院撤销了这一决定。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000779-ba01-0000-0000-000000000000', 'revise', '/rɪˈvaɪz/', 'v.', '[{"pos": "v.", "meaning": "修改；复习", "example": "She revised her essay before submitting it.", "translation": "她在提交前修改了论文。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000780-ba01-0000-0000-000000000000', 'scenario', '/sɪˈnɑːriəʊ/', 'n.', '[{"pos": "n.", "meaning": "情景；方案", "example": "In the worst-case scenario, we could lose everything.", "translation": "在最坏的情况下，我们可能会失去一切。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000781-ba01-0000-0000-000000000000', 'scope', '/skəʊp/', 'n.', '[{"pos": "n.", "meaning": "范围；机会", "example": "The scope of the project has expanded.", "translation": "项目的范围已经扩大了。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000782-ba01-0000-0000-000000000000', 'simulate', '/ˈsɪmjəleɪt/', 'v.', '[{"pos": "v.", "meaning": "模拟；假装", "example": "The software simulates real-world conditions.", "translation": "该软件模拟真实世界的条件。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000783-ba01-0000-0000-000000000000', 'sophisticated', '/səˈfɪstɪkeɪtɪd/', 'adj.', '[{"pos": "adj.", "meaning": "复杂的；精密的", "example": "The system uses sophisticated technology.", "translation": "该系统使用了精密的技术。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000784-ba01-0000-0000-000000000000', 'speculate', '/ˈspekjəleɪt/', 'v.', '[{"pos": "v.", "meaning": "推测；投机", "example": "Analysts speculate about the future of the market.", "translation": "分析师推测市场的未来。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000785-ba01-0000-0000-000000000000', 'stagnant', '/ˈstæɡnənt/', 'adj.', '[{"pos": "adj.", "meaning": "停滞的；不景气的", "example": "The economy has been stagnant for years.", "translation": "经济多年来一直停滞不前。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000786-ba01-0000-0000-000000000000', 'stakeholder', '/ˈsteɪkhəʊldər/', 'n.', '[{"pos": "n.", "meaning": "利益相关者", "example": "All stakeholders were invited to the meeting.", "translation": "所有利益相关者都被邀请参加会议。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000787-ba01-0000-0000-000000000000', 'statistic', '/stəˈtɪstɪk/', 'n.', '[{"pos": "n.", "meaning": "统计数据", "example": "The statistics show a decline in crime rates.", "translation": "统计数据显示犯罪率下降。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000788-ba01-0000-0000-000000000000', 'stimulate', '/ˈstɪmjəleɪt/', 'v.', '[{"pos": "v.", "meaning": "刺激；激励", "example": "The policy aims to stimulate economic growth.", "translation": "该政策旨在刺激经济增长。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000789-ba01-0000-0000-000000000000', 'strategy', '/ˈstrætədʒi/', 'n.', '[{"pos": "n.", "meaning": "策略；战略", "example": "We need a new strategy to increase sales.", "translation": "我们需要一个新策略来增加销售。"}]'::jsonb, 'KAOYAN', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;

-- IELTS words (113)
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000790-1e01-0000-0000-000000000000', 'administration', '/ədˌmɪnɪˈstreɪʃn/', 'n.', '[{"pos": "n.", "meaning": "管理；行政", "example": "The administration announced new education policies.", "translation": "行政部门宣布了新的教育政策。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000791-1e01-0000-0000-000000000000', 'aspect', '/ˈæspekt/', 'n.', '[{"pos": "n.", "meaning": "方面；层面", "example": "We must consider every aspect of the situation.", "translation": "我们必须考虑情况的各个方面。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000792-1e01-0000-0000-000000000000', 'cease', '/siːs/', 'v.', '[{"pos": "v.", "meaning": "停止；终止", "example": "The company ceased operations due to financial problems.", "translation": "该公司因财务问题停止了运营。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000793-1e01-0000-0000-000000000000', 'comparable', '/ˈkɒmpərəbl/', 'adj.', '[{"pos": "adj.", "meaning": "可比较的；类似的", "example": "The two products are comparable in quality.", "translation": "这两种产品的质量相当。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000794-1e01-0000-0000-000000000000', 'competent', '/ˈkɒmpɪtənt/', 'adj.', '[{"pos": "adj.", "meaning": "有能力的；胜任的", "example": "She is a highly competent engineer.", "translation": "她是一位非常有能力的工程师。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000795-1e01-0000-0000-000000000000', 'comprise', '/kəmˈpraɪz/', 'v.', '[{"pos": "v.", "meaning": "包含；由...组成", "example": "The committee comprises ten members.", "translation": "该委员会由十名成员组成。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000796-1e01-0000-0000-000000000000', 'confront', '/kənˈfrʌnt/', 'v.', '[{"pos": "v.", "meaning": "面对；对抗", "example": "We must confront the reality of climate change.", "translation": "我们必须面对气候变化的现实。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000797-1e01-0000-0000-000000000000', 'considerable', '/kənˈsɪdərəbl/', 'adj.', '[{"pos": "adj.", "meaning": "相当大的；重要的", "example": "A considerable amount of money was spent on the project.", "translation": "相当多的资金被花在了这个项目上。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000798-1e01-0000-0000-000000000000', 'consistent', '/kənˈsɪstənt/', 'adj.', '[{"pos": "adj.", "meaning": "一致的；始终如一的", "example": "Her performance has been consistent throughout the season.", "translation": "她整个赛季的表现始终如一。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000799-1e01-0000-0000-000000000000', 'core', '/kɔːr/', 'n.', '[{"pos": "n.", "meaning": "核心；果心", "example": "Innovation is the core of our business strategy.", "translation": "创新是我们商业战略的核心。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000800-1e01-0000-0000-000000000000', 'currency', '/ˈkʌrənsi/', 'n.', '[{"pos": "n.", "meaning": "货币；通用", "example": "The local currency has depreciated significantly.", "translation": "当地货币大幅贬值。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000801-1e01-0000-0000-000000000000', 'decade', '/ˈdekeɪd/', 'n.', '[{"pos": "n.", "meaning": "十年", "example": "The city has changed dramatically over the past decade.", "translation": "这座城市在过去十年中发生了巨大变化。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000802-1e01-0000-0000-000000000000', 'defect', '/ˈdiːfekt/', 'n.', '[{"pos": "n.", "meaning": "缺陷；缺点", "example": "The product was recalled due to a manufacturing defect.", "translation": "该产品因制造缺陷被召回。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000803-1e01-0000-0000-000000000000', 'despite', '/dɪˈspaɪt/', 'prep.', '[{"pos": "prep.", "meaning": "尽管；不管", "example": "Despite the rain, the match continued as planned.", "translation": "尽管下雨，比赛仍按计划进行。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000804-1e01-0000-0000-000000000000', 'drama', '/ˈdrɑːmə/', 'n.', '[{"pos": "n.", "meaning": "戏剧；剧本", "example": "The school drama club performed a Shakespeare play.", "translation": "学校戏剧社表演了一部莎士比亚戏剧。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000805-1e01-0000-0000-000000000000', 'duration', '/djuˈreɪʃn/', 'n.', '[{"pos": "n.", "meaning": "持续时间", "example": "The duration of the course is three months.", "translation": "该课程的持续时间为三个月。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000806-1e01-0000-0000-000000000000', 'dynamic', '/daɪˈnæmɪk/', 'adj.', '[{"pos": "adj.", "meaning": "动态的；有活力的", "example": "She is a dynamic leader who inspires others.", "translation": "她是一位激励他人的充满活力的领导者。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000807-1e01-0000-0000-000000000000', 'enable', '/ɪˈneɪbl/', 'v.', '[{"pos": "v.", "meaning": "使能够；启用", "example": "Technology enables people to work from home.", "translation": "技术使人们能够在家工作。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000808-1e01-0000-0000-000000000000', 'encourage', '/ɪnˈkʌrɪdʒ/', 'v.', '[{"pos": "v.", "meaning": "鼓励；促进", "example": "Parents should encourage children to read more books.", "translation": "父母应该鼓励孩子多读书。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000809-1e01-0000-0000-000000000000', 'engage', '/ɪnˈɡeɪdʒ/', 'v.', '[{"pos": "v.", "meaning": "从事；吸引", "example": "The teacher engages students with interactive activities.", "translation": "老师通过互动活动吸引学生。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000810-1e01-0000-0000-000000000000', 'ensure', '/ɪnˈʃʊər/', 'v.', '[{"pos": "v.", "meaning": "确保；保证", "example": "Please ensure that all doors are locked before leaving.", "translation": "离开前请确保所有门都已锁好。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000811-1e01-0000-0000-000000000000', 'enterprise', '/ˈentərpraɪz/', 'n.', '[{"pos": "n.", "meaning": "企业；事业", "example": "Small enterprises are vital to the national economy.", "translation": "小型企业对国民经济至关重要。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000812-1e01-0000-0000-000000000000', 'entire', '/ɪnˈtaɪər/', 'adj.', '[{"pos": "adj.", "meaning": "全部的；整个的", "example": "The entire building was evacuated within minutes.", "translation": "整栋建筑在几分钟内被疏散。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000813-1e01-0000-0000-000000000000', 'environment', '/ɪnˈvaɪrənmənt/', 'n.', '[{"pos": "n.", "meaning": "环境", "example": "Protecting the environment is everyone''s responsibility.", "translation": "保护环境是每个人的责任。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000814-1e01-0000-0000-000000000000', 'episode', '/ˈepɪsəʊd/', 'n.', '[{"pos": "n.", "meaning": "插曲；一集", "example": "The final episode of the series attracted millions of viewers.", "translation": "该剧最后一集吸引了数百万观众。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000815-1e01-0000-0000-000000000000', 'equality', '/ɪˈkwɒləti/', 'n.', '[{"pos": "n.", "meaning": "平等；相等", "example": "The organisation fights for gender equality.", "translation": "该组织为性别平等而奋斗。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000816-1e01-0000-0000-000000000000', 'equip', '/ɪˈkwɪp/', 'v.', '[{"pos": "v.", "meaning": "装备；配备", "example": "The lab is equipped with the latest technology.", "translation": "该实验室配备了最新的技术设备。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000817-1e01-0000-0000-000000000000', 'essential', '/ɪˈsenʃl/', 'adj.', '[{"pos": "adj.", "meaning": "必要的；本质的", "example": "Sleep is essential for good health.", "translation": "睡眠对健康至关重要。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000818-1e01-0000-0000-000000000000', 'estimate', '/ˈestɪmeɪt/', 'v.', '[{"pos": "v.", "meaning": "估计；估算", "example": "Experts estimate that the cost will exceed one million.", "translation": "专家估计成本将超过一百万。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000819-1e01-0000-0000-000000000000', 'eventually', '/ɪˈventʃuəli/', 'adv.', '[{"pos": "adv.", "meaning": "最终；终于", "example": "After years of hard work, she eventually achieved her dream.", "translation": "经过多年努力，她终于实现了梦想。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000820-1e01-0000-0000-000000000000', 'evidence', '/ˈevɪdəns/', 'n.', '[{"pos": "n.", "meaning": "证据；证明", "example": "There is strong evidence to support this theory.", "translation": "有强有力的证据支持这一理论。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000821-1e01-0000-0000-000000000000', 'evolve', '/ɪˈvɒlv/', 'v.', '[{"pos": "v.", "meaning": "进化；发展", "example": "Languages evolve over time through daily use.", "translation": "语言通过日常使用随时间演变。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000822-1e01-0000-0000-000000000000', 'exclude', '/ɪkˈskluːd/', 'v.', '[{"pos": "v.", "meaning": "排除；排斥", "example": "The price excludes delivery charges.", "translation": "价格不包括配送费。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000823-1e01-0000-0000-000000000000', 'execute', '/ˈeksɪkjuːt/', 'v.', '[{"pos": "v.", "meaning": "执行；实施", "example": "The team executed the plan perfectly.", "translation": "团队完美地执行了计划。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000824-1e01-0000-0000-000000000000', 'expand', '/ɪkˈspænd/', 'v.', '[{"pos": "v.", "meaning": "扩展；膨胀", "example": "The company plans to expand into Asian markets.", "translation": "该公司计划向亚洲市场扩张。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000825-1e01-0000-0000-000000000000', 'expertise', '/ˌekspɜːrˈtiːz/', 'n.', '[{"pos": "n.", "meaning": "专业知识；专长", "example": "We need someone with expertise in data analysis.", "translation": "我们需要一位有数据分析专业知识的人。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000826-1e01-0000-0000-000000000000', 'expose', '/ɪkˈspəʊz/', 'v.', '[{"pos": "v.", "meaning": "暴露；揭露", "example": "The investigation exposed widespread corruption.", "translation": "调查揭露了普遍存在的腐败。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000827-1e01-0000-0000-000000000000', 'external', '/ɪkˈstɜːrnl/', 'adj.', '[{"pos": "adj.", "meaning": "外部的；外面的", "example": "The building needs external repairs.", "translation": "该建筑需要外部维修。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000828-1e01-0000-0000-000000000000', 'factor', '/ˈfæktər/', 'n.', '[{"pos": "n.", "meaning": "因素；因子", "example": "Cost is an important factor in the decision.", "translation": "成本是决策中的一个重要因素。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000829-1e01-0000-0000-000000000000', 'feature', '/ˈfiːtʃər/', 'n.', '[{"pos": "n.", "meaning": "特征；特色", "example": "The phone has many impressive features.", "translation": "这款手机有许多令人印象深刻的功能。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000830-1e01-0000-0000-000000000000', 'federal', '/ˈfedərəl/', 'adj.', '[{"pos": "adj.", "meaning": "联邦的", "example": "The federal government introduced new tax regulations.", "translation": "联邦政府引入了新的税收法规。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000831-1e01-0000-0000-000000000000', 'finance', '/ˈfaɪnæns/', 'n.', '[{"pos": "n.", "meaning": "金融；财政", "example": "She studied finance at university.", "translation": "她在大学学习金融。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000832-1e01-0000-0000-000000000000', 'flexible', '/ˈfleksəbl/', 'adj.', '[{"pos": "adj.", "meaning": "灵活的；可弯曲的", "example": "The company offers flexible working hours.", "translation": "该公司提供弹性工作时间。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000833-1e01-0000-0000-000000000000', 'focus', '/ˈfəʊkəs/', 'n.', '[{"pos": "n.", "meaning": "焦点；重点", "example": "The focus of the discussion was education reform.", "translation": "讨论的重点是教育改革。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000834-1e01-0000-0000-000000000000', 'forecast', '/ˈfɔːrkɑːst/', 'n.', '[{"pos": "n.", "meaning": "预测；预报", "example": "The weather forecast predicts heavy rain tomorrow.", "translation": "天气预报预测明天有大雨。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000835-1e01-0000-0000-000000000000', 'formula', '/ˈfɔːrmjələ/', 'n.', '[{"pos": "n.", "meaning": "公式；配方", "example": "The scientist developed a new formula for the experiment.", "translation": "科学家为实验开发了一个新公式。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000836-1e01-0000-0000-000000000000', 'foundation', '/faʊnˈdeɪʃn/', 'n.', '[{"pos": "n.", "meaning": "基础；基金会", "example": "A good education is the foundation of a successful career.", "translation": "良好的教育是成功事业的基础。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000837-1e01-0000-0000-000000000000', 'fragment', '/ˈfræɡmənt/', 'n.', '[{"pos": "n.", "meaning": "碎片；片段", "example": "Fragments of the vase were scattered across the floor.", "translation": "花瓶的碎片散落在地板上。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000838-1e01-0000-0000-000000000000', 'framework', '/ˈfreɪmwɜːrk/', 'n.', '[{"pos": "n.", "meaning": "框架；体系", "example": "We need a legal framework to regulate the industry.", "translation": "我们需要一个法律框架来规范该行业。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000839-1e01-0000-0000-000000000000', 'frequent', '/ˈfriːkwənt/', 'adj.', '[{"pos": "adj.", "meaning": "频繁的；经常的", "example": "Frequent exercise helps maintain good health.", "translation": "经常锻炼有助于保持健康。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000840-1e01-0000-0000-000000000000', 'function', '/ˈfʌŋkʃn/', 'n.', '[{"pos": "n.", "meaning": "功能；职能", "example": "The main function of the heart is to pump blood.", "translation": "心脏的主要功能是泵送血液。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000841-1e01-0000-0000-000000000000', 'generate', '/ˈdʒenəreɪt/', 'v.', '[{"pos": "v.", "meaning": "产生；发电", "example": "The wind turbines generate enough electricity for the town.", "translation": "风力涡轮机为该镇产生了足够的电力。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000842-1e01-0000-0000-000000000000', 'global', '/ˈɡləʊbl/', 'adj.', '[{"pos": "adj.", "meaning": "全球的；全面的", "example": "Global warming is a serious environmental issue.", "translation": "全球变暖是一个严重的环境问题。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000843-1e01-0000-0000-000000000000', 'goal', '/ɡəʊl/', 'n.', '[{"pos": "n.", "meaning": "目标；目的", "example": "Our goal is to reduce pollution by 50 percent.", "translation": "我们的目标是将污染减少50%。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000844-1e01-0000-0000-000000000000', 'grade', '/ɡreɪd/', 'n.', '[{"pos": "n.", "meaning": "等级；成绩", "example": "She received the highest grade in her class.", "translation": "她在班里获得了最高分。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000845-1e01-0000-0000-000000000000', 'grant', '/ɡrɑːnt/', 'n.', '[{"pos": "n.", "meaning": "补助金；拨款", "example": "The university received a research grant from the government.", "translation": "该大学获得了政府的研究拨款。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000846-1e01-0000-0000-000000000000', 'guarantee', '/ˌɡærənˈtiː/', 'v.', '[{"pos": "v.", "meaning": "保证；担保", "example": "The product comes with a two-year guarantee.", "translation": "该产品附带两年保修。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000847-1e01-0000-0000-000000000000', 'guideline', '/ˈɡaɪdlaɪn/', 'n.', '[{"pos": "n.", "meaning": "指导方针；准则", "example": "The government issued new guidelines on food safety.", "translation": "政府发布了新的食品安全准则。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000848-1e01-0000-0000-000000000000', 'hazard', '/ˈhæzərd/', 'n.', '[{"pos": "n.", "meaning": "危险；危害", "example": "Smoking is a serious health hazard.", "translation": "吸烟是一个严重的健康危害。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000849-1e01-0000-0000-000000000000', 'highlight', '/ˈhaɪlaɪt/', 'v.', '[{"pos": "v.", "meaning": "强调；突出", "example": "The report highlights the need for more investment.", "translation": "报告强调了需要更多投资。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000850-1e01-0000-0000-000000000000', 'identify', '/aɪˈdentɪfaɪ/', 'v.', '[{"pos": "v.", "meaning": "识别；确认", "example": "The police identified the suspect from security footage.", "translation": "警方从监控录像中识别出了嫌疑人。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000851-1e01-0000-0000-000000000000', 'illustrate', '/ˈɪləstreɪt/', 'v.', '[{"pos": "v.", "meaning": "说明；插图", "example": "The chart illustrates the growth trend clearly.", "translation": "该图表清楚地说明了增长趋势。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000852-1e01-0000-0000-000000000000', 'impact', '/ˈɪmpækt/', 'n.', '[{"pos": "n.", "meaning": "影响；冲击", "example": "The policy had a significant impact on education.", "translation": "该政策对教育产生了重大影响。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000853-1e01-0000-0000-000000000000', 'implication', '/ˌɪmplɪˈkeɪʃn/', 'n.', '[{"pos": "n.", "meaning": "含义；影响", "example": "The findings have important implications for policy.", "translation": "这些发现对政策有重要影响。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000854-1e01-0000-0000-000000000000', 'imply', '/ɪmˈplaɪ/', 'v.', '[{"pos": "v.", "meaning": "暗示；意味着", "example": "Are you implying that I made a mistake?", "translation": "你是在暗示我犯了错误吗？"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000855-1e01-0000-0000-000000000000', 'incident', '/ˈɪnsɪdənt/', 'n.', '[{"pos": "n.", "meaning": "事件；事故", "example": "The police investigated the incident thoroughly.", "translation": "警方对该事件进行了彻底调查。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000856-1e01-0000-0000-000000000000', 'individual', '/ˌɪndɪˈvɪdʒuəl/', 'n.', '[{"pos": "n.", "meaning": "个人；个体", "example": "Each individual has the right to freedom of speech.", "translation": "每个人都有言论自由的权利。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000857-1e01-0000-0000-000000000000', 'inevitable', '/ɪnˈevɪtəbl/', 'adj.', '[{"pos": "adj.", "meaning": "不可避免的", "example": "Change is an inevitable part of life.", "translation": "变化是生活中不可避免的一部分。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000858-1e01-0000-0000-000000000000', 'infrastructure', '/ˈɪnfrəstrʌktʃər/', 'n.', '[{"pos": "n.", "meaning": "基础设施", "example": "The country needs to invest in its transport infrastructure.", "translation": "该国需要投资交通基础设施。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000859-1e01-0000-0000-000000000000', 'initial', '/ɪˈnɪʃl/', 'adj.', '[{"pos": "adj.", "meaning": "最初的；开始的", "example": "The initial results of the study are promising.", "translation": "该研究的初步结果令人鼓舞。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000860-1e01-0000-0000-000000000000', 'initiative', '/ɪˈnɪʃətɪv/', 'n.', '[{"pos": "n.", "meaning": "倡议；主动性", "example": "The government launched a new green energy initiative.", "translation": "政府发起了一项新的绿色能源倡议。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000861-1e01-0000-0000-000000000000', 'input', '/ˈɪnpʊt/', 'n.', '[{"pos": "n.", "meaning": "投入；输入", "example": "We need more input from the research team.", "translation": "我们需要研究团队提供更多的投入。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000862-1e01-0000-0000-000000000000', 'instance', '/ˈɪnstəns/', 'n.', '[{"pos": "n.", "meaning": "实例；情况", "example": "In this instance, the exception is justified.", "translation": "在这种情况下，例外是合理的。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000863-1e01-0000-0000-000000000000', 'institute', '/ˈɪnstɪtjuːt/', 'n.', '[{"pos": "n.", "meaning": "机构；学院", "example": "The research institute published its annual report.", "translation": "该研究所发布了年度报告。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000864-1e01-0000-0000-000000000000', 'intelligence', '/ɪnˈtelɪdʒəns/', 'n.', '[{"pos": "n.", "meaning": "智力；情报", "example": "Artificial intelligence is transforming many industries.", "translation": "人工智能正在改变许多行业。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000865-1e01-0000-0000-000000000000', 'intense', '/ɪnˈtens/', 'adj.', '[{"pos": "adj.", "meaning": "强烈的；紧张的", "example": "The competition for the job was intense.", "translation": "这份工作的竞争非常激烈。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000866-1e01-0000-0000-000000000000', 'investigate', '/ɪnˈvestɪɡeɪt/', 'v.', '[{"pos": "v.", "meaning": "调查；研究", "example": "Police are investigating the cause of the fire.", "translation": "警方正在调查火灾原因。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000867-1e01-0000-0000-000000000000', 'involve', '/ɪnˈvɒlv/', 'v.', '[{"pos": "v.", "meaning": "涉及；包含", "example": "The job involves a lot of travelling.", "translation": "这份工作涉及大量出差。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000868-1e01-0000-0000-000000000000', 'label', '/ˈleɪbl/', 'n.', '[{"pos": "n.", "meaning": "标签；标记", "example": "Check the label for nutritional information.", "translation": "查看标签上的营养信息。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000869-1e01-0000-0000-000000000000', 'layer', '/ˈleɪər/', 'n.', '[{"pos": "n.", "meaning": "层；层次", "example": "The atmosphere consists of several layers.", "translation": "大气层由几个层组成。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000870-1e01-0000-0000-000000000000', 'lecture', '/ˈlektʃər/', 'n.', '[{"pos": "n.", "meaning": "讲座；演讲", "example": "The professor delivered a fascinating lecture on astronomy.", "translation": "教授发表了一场关于天文学的精彩讲座。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000871-1e01-0000-0000-000000000000', 'legal', '/ˈliːɡl/', 'adj.', '[{"pos": "adj.", "meaning": "法律的；合法的", "example": "Is it legal to park here?", "translation": "在这里停车合法吗？"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000872-1e01-0000-0000-000000000000', 'leisure', '/ˈleʒər/', 'n.', '[{"pos": "n.", "meaning": "闲暇；休闲", "example": "People should balance work and leisure time.", "translation": "人们应该平衡工作和休闲时间。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000873-1e01-0000-0000-000000000000', 'link', '/lɪŋk/', 'n.', '[{"pos": "n.", "meaning": "联系；链接", "example": "There is a clear link between diet and health.", "translation": "饮食和健康之间有明显的联系。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000874-1e01-0000-0000-000000000000', 'locate', '/ləʊˈkeɪt/', 'v.', '[{"pos": "v.", "meaning": "找到；位于", "example": "The hotel is located in the city centre.", "translation": "该酒店位于市中心。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000875-1e01-0000-0000-000000000000', 'logic', '/ˈlɒdʒɪk/', 'n.', '[{"pos": "n.", "meaning": "逻辑；推理", "example": "His argument lacks logic and evidence.", "translation": "他的论点缺乏逻辑和证据。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000876-1e01-0000-0000-000000000000', 'maintain', '/meɪnˈteɪn/', 'v.', '[{"pos": "v.", "meaning": "维持；维护", "example": "It is important to maintain a healthy lifestyle.", "translation": "保持健康的生活方式很重要。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000877-1e01-0000-0000-000000000000', 'major', '/ˈmeɪdʒər/', 'adj.', '[{"pos": "adj.", "meaning": "主要的；重大的", "example": "Pollution is a major concern for urban areas.", "translation": "污染是城市地区的一个主要问题。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000878-1e01-0000-0000-000000000000', 'mature', '/məˈtʃʊər/', 'adj.', '[{"pos": "adj.", "meaning": "成熟的", "example": "She is very mature for her age.", "translation": "就她的年龄而言，她非常成熟。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000879-1e01-0000-0000-000000000000', 'maximum', '/ˈmæksɪməm/', 'n.', '[{"pos": "n.", "meaning": "最大值；最大限度", "example": "The maximum speed limit on this road is 60 mph.", "translation": "这条路的最高限速是每小时60英里。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000880-1e01-0000-0000-000000000000', 'media', '/ˈmiːdiə/', 'n.', '[{"pos": "n.", "meaning": "媒体；媒介", "example": "Social media has changed the way people communicate.", "translation": "社交媒体改变了人们的交流方式。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000881-1e01-0000-0000-000000000000', 'medium', '/ˈmiːdiəm/', 'n.', '[{"pos": "n.", "meaning": "媒介；中等", "example": "English is the medium of instruction at this school.", "translation": "英语是这所学校的教学语言。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000882-1e01-0000-0000-000000000000', 'mental', '/ˈmentl/', 'adj.', '[{"pos": "adj.", "meaning": "精神的；心理的", "example": "Mental health is just as important as physical health.", "translation": "心理健康与身体健康同样重要。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000883-1e01-0000-0000-000000000000', 'method', '/ˈmeθəd/', 'n.', '[{"pos": "n.", "meaning": "方法；方式", "example": "We need a more efficient method of data collection.", "translation": "我们需要一种更高效的数据收集方法。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000884-1e01-0000-0000-000000000000', 'minister', '/ˈmɪnɪstər/', 'n.', '[{"pos": "n.", "meaning": "部长；大臣", "example": "The prime minister addressed the nation on television.", "translation": "首相在电视上向全国发表讲话。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000885-1e01-0000-0000-000000000000', 'minor', '/ˈmaɪnər/', 'adj.', '[{"pos": "adj.", "meaning": "较小的；次要的", "example": "The car suffered only minor damage in the accident.", "translation": "汽车在事故中只受到了轻微损坏。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000886-1e01-0000-0000-000000000000', 'moreover', '/mɔːrˈəʊvər/', 'adv.', '[{"pos": "adv.", "meaning": "此外；而且", "example": "The plan is too expensive. Moreover, it is impractical.", "translation": "该计划成本太高。此外，它也不切实际。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000887-1e01-0000-0000-000000000000', 'motive', '/ˈməʊtɪv/', 'n.', '[{"pos": "n.", "meaning": "动机；目的", "example": "The police are investigating the motive behind the crime.", "translation": "警方正在调查犯罪背后的动机。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000888-1e01-0000-0000-000000000000', 'mutual', '/ˈmjuːtʃuəl/', 'adj.', '[{"pos": "adj.", "meaning": "相互的；共同的", "example": "The agreement was based on mutual respect.", "translation": "该协议基于相互尊重。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000889-1e01-0000-0000-000000000000', 'network', '/ˈnetwɜːrk/', 'n.', '[{"pos": "n.", "meaning": "网络；人脉", "example": "Building a professional network is essential for career growth.", "translation": "建立专业人脉对职业发展至关重要。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000890-1e01-0000-0000-000000000000', 'neutral', '/ˈnjuːtrəl/', 'adj.', '[{"pos": "adj.", "meaning": "中立的；中性的", "example": "Switzerland remained neutral during the war.", "translation": "瑞士在战争期间保持中立。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000891-1e01-0000-0000-000000000000', 'nevertheless', '/ˌnevərðəˈles/', 'adv.', '[{"pos": "adv.", "meaning": "然而；不过", "example": "The task was difficult. Nevertheless, they completed it on time.", "translation": "任务很困难。然而，他们按时完成了。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000892-1e01-0000-0000-000000000000', 'nuclear', '/ˈnjuːkliər/', 'adj.', '[{"pos": "adj.", "meaning": "核的；原子能的", "example": "Nuclear energy remains a controversial topic.", "translation": "核能仍然是一个有争议的话题。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000893-1e01-0000-0000-000000000000', 'objective', '/əbˈdʒektɪv/', 'n.', '[{"pos": "n.", "meaning": "目标；目的", "example": "The main objective of the project is to reduce costs.", "translation": "该项目的主要目标是降低成本。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000894-1e01-0000-0000-000000000000', 'obvious', '/ˈɒbviəs/', 'adj.', '[{"pos": "adj.", "meaning": "明显的；显而易见的", "example": "The answer to the question was obvious.", "translation": "问题的答案是显而易见的。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000895-1e01-0000-0000-000000000000', 'occupy', '/ˈɒkjupaɪ/', 'v.', '[{"pos": "v.", "meaning": "占据；占用", "example": "The meeting occupied the entire morning.", "translation": "会议占用了整个上午。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000896-1e01-0000-0000-000000000000', 'occur', '/əˈkɜːr/', 'v.', '[{"pos": "v.", "meaning": "发生；出现", "example": "Accidents often occur at busy intersections.", "translation": "事故经常发生在繁忙的十字路口。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000897-1e01-0000-0000-000000000000', 'option', '/ˈɒpʃn/', 'n.', '[{"pos": "n.", "meaning": "选择；选项", "example": "You have several options to choose from.", "translation": "你有几个选项可以选择。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000898-1e01-0000-0000-000000000000', 'output', '/ˈaʊtpʊt/', 'n.', '[{"pos": "n.", "meaning": "产出；输出", "example": "The factory''s output has doubled this year.", "translation": "该工厂的产量今年翻了一番。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000899-1e01-0000-0000-000000000000', 'overall', '/ˌəʊvərˈɔːl/', 'adj.', '[{"pos": "adj.", "meaning": "总体的；全面的", "example": "The overall quality of the product has improved.", "translation": "产品的整体质量有所提高。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000900-1e01-0000-0000-000000000000', 'overcome', '/ˌəʊvərˈkʌm/', 'v.', '[{"pos": "v.", "meaning": "克服；战胜", "example": "She overcame many obstacles to achieve her goals.", "translation": "她克服了许多障碍来实现自己的目标。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000901-1e01-0000-0000-000000000000', 'overlook', '/ˌəʊvərˈlʊk/', 'v.', '[{"pos": "v.", "meaning": "忽视；俯瞰", "example": "Don''t overlook the small details in the contract.", "translation": "不要忽视合同中的小细节。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000902-1e01-0000-0000-000000000000', 'overseas', '/ˌəʊvərˈsiːz/', 'adv.', '[{"pos": "adv.", "meaning": "在海外", "example": "Many students choose to study overseas.", "translation": "许多学生选择出国留学。"}]'::jsonb, 'IELTS', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;

-- TOEFL words (58)
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000903-7001-0000-0000-000000000000', 'approximately', '/əˈprɒksɪmətli/', 'adv.', '[{"pos": "adv.", "meaning": "大约；大概", "example": "The project will take approximately three months.", "translation": "这个项目大约需要三个月。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000904-7001-0000-0000-000000000000', 'consecutive', '/kənˈsekjətɪv/', 'adj.', '[{"pos": "adj.", "meaning": "连续的", "example": "It rained for five consecutive days.", "translation": "连续下了五天雨。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000905-7001-0000-0000-000000000000', 'consent', '/kənˈsent/', 'n.', '[{"pos": "n.", "meaning": "同意；许可", "example": "You need parental consent to go on the trip.", "translation": "你需要父母的同意才能去旅行。"}, {"pos": "v.", "meaning": "同意", "example": "She consented to the medical procedure.", "translation": "她同意了医疗程序。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000906-7001-0000-0000-000000000000', 'deduce', '/dɪˈdjuːs/', 'v.', '[{"pos": "v.", "meaning": "推断；演绎", "example": "We can deduce from the data that the experiment was successful.", "translation": "我们可以从数据推断出实验是成功的。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000907-7001-0000-0000-000000000000', 'discern', '/dɪˈsɜːrn/', 'v.', '[{"pos": "v.", "meaning": "辨别；识别", "example": "It was difficult to discern the truth.", "translation": "辨别真相很困难。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000908-7001-0000-0000-000000000000', 'entity', '/ˈentəti/', 'n.', '[{"pos": "n.", "meaning": "实体；存在", "example": "The company is a separate legal entity.", "translation": "该公司是一个独立的法律实体。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000909-7001-0000-0000-000000000000', 'evident', '/ˈevɪdənt/', 'adj.', '[{"pos": "adj.", "meaning": "明显的；显然的", "example": "It was evident that she was the best candidate.", "translation": "很明显她是最佳人选。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000910-7001-0000-0000-000000000000', 'forthcoming', '/ˌfɔːrθˈkʌmɪŋ/', 'adj.', '[{"pos": "adj.", "meaning": "即将到来的；乐于助人的", "example": "The forthcoming election will be closely watched.", "translation": "即将到来的选举将受到密切关注。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000911-7001-0000-0000-000000000000', 'ignorance', '/ˈɪɡnərəns/', 'n.', '[{"pos": "n.", "meaning": "无知；愚昧", "example": "Ignorance of the law is no excuse.", "translation": "不知法律不能成为借口。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000912-7001-0000-0000-000000000000', 'incidence', '/ˈɪnsɪdəns/', 'n.', '[{"pos": "n.", "meaning": "发生率", "example": "The incidence of heart disease has increased.", "translation": "心脏病的发病率增加了。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000913-7001-0000-0000-000000000000', 'insert', '/ɪnˈsɜːrt/', 'v.', '[{"pos": "v.", "meaning": "插入；嵌入", "example": "Insert the key into the lock.", "translation": "把钥匙插入锁中。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000914-7001-0000-0000-000000000000', 'majority', '/məˈdʒɒrəti/', 'n.', '[{"pos": "n.", "meaning": "多数；大多数", "example": "The majority of students passed the exam.", "translation": "大多数学生通过了考试。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000915-7001-0000-0000-000000000000', 'notwithstanding', '/ˌnɒtwɪθˈstændɪŋ/', 'prep.', '[{"pos": "prep.", "meaning": "尽管", "example": "Notwithstanding the rain, the game continued.", "translation": "尽管下雨，比赛继续进行。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000916-7001-0000-0000-000000000000', 'obligate', '/ˈɒblɪɡeɪt/', 'v.', '[{"pos": "v.", "meaning": "使负有义务", "example": "The contract obligates both parties to fulfill their duties.", "translation": "合同使双方有义务履行各自的职责。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000917-7001-0000-0000-000000000000', 'parameter', '/pəˈræmɪtər/', 'n.', '[{"pos": "n.", "meaning": "参数；范围", "example": "We need to define the parameters of the study.", "translation": "我们需要定义研究的参数。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000918-7001-0000-0000-000000000000', 'phase', '/feɪz/', 'n.', '[{"pos": "n.", "meaning": "阶段；时期", "example": "The project is in its final phase.", "translation": "项目正处于最后阶段。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000919-7001-0000-0000-000000000000', 'philosophy', '/fɪˈlɒsəfi/', 'n.', '[{"pos": "n.", "meaning": "哲学；理念", "example": "His teaching philosophy emphasizes critical thinking.", "translation": "他的教学理念强调批判性思维。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000920-7001-0000-0000-000000000000', 'pioneer', '/ˌpaɪəˈnɪr/', 'n.', '[{"pos": "n.", "meaning": "先驱；开拓者", "example": "She was a pioneer in the field of genetics.", "translation": "她是遗传学领域的先驱。"}, {"pos": "v.", "meaning": "开创", "example": "The company pioneered the use of artificial intelligence.", "translation": "该公司开创了人工智能的使用。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000921-7001-0000-0000-000000000000', 'policy', '/ˈpɒləsi/', 'n.', '[{"pos": "n.", "meaning": "政策；方针", "example": "The government introduced a new health policy.", "translation": "政府推出了一项新的卫生政策。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000922-7001-0000-0000-000000000000', 'portion', '/ˈpɔːrʃən/', 'n.', '[{"pos": "n.", "meaning": "部分；一份", "example": "A significant portion of the budget goes to education.", "translation": "预算的很大一部分用于教育。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000923-7001-0000-0000-000000000000', 'possess', '/pəˈzes/', 'v.', '[{"pos": "v.", "meaning": "拥有；具有", "example": "She possesses excellent communication skills.", "translation": "她拥有出色的沟通能力。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000924-7001-0000-0000-000000000000', 'predominant', '/prɪˈdɒmɪnənt/', 'adj.', '[{"pos": "adj.", "meaning": "主要的；占主导地位的", "example": "Agriculture is the predominant industry in the region.", "translation": "农业是该地区的主要产业。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000925-7001-0000-0000-000000000000', 'preliminary', '/prɪˈlɪmɪneri/', 'adj.', '[{"pos": "adj.", "meaning": "初步的；预备的", "example": "Preliminary results suggest the treatment is effective.", "translation": "初步结果表明治疗是有效的。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000926-7001-0000-0000-000000000000', 'previous', '/ˈpriːviəs/', 'adj.', '[{"pos": "adj.", "meaning": "以前的；先前的", "example": "She had no previous experience in management.", "translation": "她以前没有管理经验。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000927-7001-0000-0000-000000000000', 'primary', '/ˈpraɪməri/', 'adj.', '[{"pos": "adj.", "meaning": "主要的；初级的", "example": "The primary goal is to improve quality.", "translation": "主要目标是提高质量。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000928-7001-0000-0000-000000000000', 'principle', '/ˈprɪnsəpəl/', 'n.', '[{"pos": "n.", "meaning": "原则；原理", "example": "The principle of equality is important in law.", "translation": "平等原则在法律中很重要。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000929-7001-0000-0000-000000000000', 'priority', '/praɪˈɒrəti/', 'n.', '[{"pos": "n.", "meaning": "优先事项；重点", "example": "Education should be a top priority.", "translation": "教育应该是首要优先事项。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000930-7001-0000-0000-000000000000', 'proceed', '/prəˈsiːd/', 'v.', '[{"pos": "v.", "meaning": "继续；进行", "example": "Please proceed with the next step.", "translation": "请继续下一步。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000931-7001-0000-0000-000000000000', 'promote', '/prəˈmoʊt/', 'v.', '[{"pos": "v.", "meaning": "促进；提升", "example": "The campaign promotes healthy eating habits.", "translation": "这项活动推广健康的饮食习惯。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000932-7001-0000-0000-000000000000', 'prospect', '/ˈprɒspekt/', 'n.', '[{"pos": "n.", "meaning": "前景；展望", "example": "The prospect of promotion motivated the employees.", "translation": "晋升的前景激励了员工。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000933-7001-0000-0000-000000000000', 'protocol', '/ˈproʊtəkɒl/', 'n.', '[{"pos": "n.", "meaning": "协议；礼仪", "example": "Follow the safety protocol at all times.", "translation": "始终遵守安全协议。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000934-7001-0000-0000-000000000000', 'province', '/ˈprɒvɪns/', 'n.', '[{"pos": "n.", "meaning": "省份；领域", "example": "This matter falls within the province of the local government.", "translation": "这件事属于地方政府的管辖范围。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000935-7001-0000-0000-000000000000', 'range', '/reɪndʒ/', 'n.', '[{"pos": "n.", "meaning": "范围；系列", "example": "The store offers a wide range of products.", "translation": "这家商店提供各种各样的产品。"}, {"pos": "v.", "meaning": "变化；涉及", "example": "Prices range from $10 to $100.", "translation": "价格从10美元到100美元不等。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000936-7001-0000-0000-000000000000', 'ratio', '/ˈreɪʃioʊ/', 'n.', '[{"pos": "n.", "meaning": "比率；比例", "example": "The ratio of boys to girls in the class is 2:1.", "translation": "班级里男生和女生的比例是2:1。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000937-7001-0000-0000-000000000000', 'react', '/riˈækt/', 'v.', '[{"pos": "v.", "meaning": "反应；起化学反应", "example": "How did she react to the news?", "translation": "她对这个消息有何反应？"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000938-7001-0000-0000-000000000000', 'recover', '/rɪˈkʌvər/', 'v.', '[{"pos": "v.", "meaning": "恢复；收回", "example": "It took her months to recover from the illness.", "translation": "她花了几个月才从疾病中恢复过来。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000939-7001-0000-0000-000000000000', 'region', '/ˈriːdʒən/', 'n.', '[{"pos": "n.", "meaning": "地区；区域", "example": "The northern region has a cold climate.", "translation": "北方地区气候寒冷。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000940-7001-0000-0000-000000000000', 'regulate', '/ˈreɡjuleɪt/', 'v.', '[{"pos": "v.", "meaning": "调节；管理", "example": "Laws regulate the use of public spaces.", "translation": "法律规范公共空间的使用。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000941-7001-0000-0000-000000000000', 'reject', '/rɪˈdʒekt/', 'v.', '[{"pos": "v.", "meaning": "拒绝；排斥", "example": "The committee rejected the proposal.", "translation": "委员会拒绝了这项提案。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000942-7001-0000-0000-000000000000', 'relevant', '/ˈreləvənt/', 'adj.', '[{"pos": "adj.", "meaning": "相关的；有关的", "example": "Please provide relevant documents.", "translation": "请提供相关文件。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000943-7001-0000-0000-000000000000', 'rely', '/rɪˈlaɪ/', 'v.', '[{"pos": "v.", "meaning": "依赖；依靠", "example": "Many people rely on public transportation.", "translation": "许多人依赖公共交通。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000944-7001-0000-0000-000000000000', 'remark', '/rɪˈmɑːrk/', 'n.', '[{"pos": "n.", "meaning": "评论；言论", "example": "His remark caused some controversy.", "translation": "他的言论引起了一些争议。"}, {"pos": "v.", "meaning": "评论", "example": "She remarked on the quality of the food.", "translation": "她评论了食物的质量。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000945-7001-0000-0000-000000000000', 'remove', '/rɪˈmuːv/', 'v.', '[{"pos": "v.", "meaning": "移除；去掉", "example": "Please remove your shoes before entering.", "translation": "进入前请脱鞋。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000946-7001-0000-0000-000000000000', 'require', '/rɪˈkwaɪər/', 'v.', '[{"pos": "v.", "meaning": "要求；需要", "example": "This job requires a lot of patience.", "translation": "这份工作需要很大的耐心。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000947-7001-0000-0000-000000000000', 'research', '/rɪˈsɜːrtʃ/', 'n.', '[{"pos": "n.", "meaning": "研究；调查", "example": "Scientific research has led to many discoveries.", "translation": "科学研究带来了许多发现。"}, {"pos": "v.", "meaning": "研究", "example": "She is researching the effects of climate change.", "translation": "她正在研究气候变化的影响。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000948-7001-0000-0000-000000000000', 'resource', '/rɪˈsɔːrs/', 'n.', '[{"pos": "n.", "meaning": "资源", "example": "Water is a precious natural resource.", "translation": "水是宝贵的自然资源。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000949-7001-0000-0000-000000000000', 'respond', '/rɪˈspɒnd/', 'v.', '[{"pos": "v.", "meaning": "回答；反应", "example": "Please respond to the invitation by Friday.", "translation": "请在周五之前回复邀请。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000950-7001-0000-0000-000000000000', 'restrict', '/rɪˈstrɪkt/', 'v.', '[{"pos": "v.", "meaning": "限制；约束", "example": "Access to the building is restricted.", "translation": "进入大楼受到限制。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000951-7001-0000-0000-000000000000', 'revenue', '/ˈrevənjuː/', 'n.', '[{"pos": "n.", "meaning": "收入；税收", "example": "The company''s revenue increased by 20%.", "translation": "公司的收入增长了20%。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000952-7001-0000-0000-000000000000', 'revolution', '/ˌrevəˈluːʃən/', 'n.', '[{"pos": "n.", "meaning": "革命；变革", "example": "The industrial revolution transformed society.", "translation": "工业革命改变了社会。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000953-7001-0000-0000-000000000000', 'role', '/roʊl/', 'n.', '[{"pos": "n.", "meaning": "角色；作用", "example": "Education plays a vital role in society.", "translation": "教育在社会中起着至关重要的作用。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000954-7001-0000-0000-000000000000', 'route', '/ruːt/', 'n.', '[{"pos": "n.", "meaning": "路线；途径", "example": "What''s the best route to the airport?", "translation": "去机场的最佳路线是什么？"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000955-7001-0000-0000-000000000000', 'scheme', '/skiːm/', 'n.', '[{"pos": "n.", "meaning": "计划；方案", "example": "The government launched a new housing scheme.", "translation": "政府推出了一项新的住房计划。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000956-7001-0000-0000-000000000000', 'sector', '/ˈsektər/', 'n.', '[{"pos": "n.", "meaning": "部门；领域", "example": "The private sector plays an important role in the economy.", "translation": "私营部门在经济中起着重要作用。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000957-7001-0000-0000-000000000000', 'seek', '/siːk/', 'v.', '[{"pos": "v.", "meaning": "寻求；寻找", "example": "She is seeking a new job opportunity.", "translation": "她正在寻找新的工作机会。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000958-7001-0000-0000-000000000000', 'select', '/sɪˈlekt/', 'v.', '[{"pos": "v.", "meaning": "选择；挑选", "example": "Please select your preferred option.", "translation": "请选择您偏好的选项。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000959-7001-0000-0000-000000000000', 'sequence', '/ˈsiːkwəns/', 'n.', '[{"pos": "n.", "meaning": "顺序；序列", "example": "Follow the sequence of steps in the manual.", "translation": "按照手册中的步骤顺序操作。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000960-7001-0000-0000-000000000000', 'shift', '/ʃɪft/', 'n.', '[{"pos": "n.", "meaning": "转变；轮班", "example": "There has been a shift in public opinion.", "translation": "公众舆论发生了转变。"}, {"pos": "v.", "meaning": "转移；改变", "example": "The wind shifted to the north.", "translation": "风转向了北方。"}]'::jsonb, 'TOEFL', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;

-- GRE words (228)
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000961-6001-0000-0000-000000000000', 'aberrant', '/æˈberənt/', 'adj.', '[{"pos": "adj.", "meaning": "异常的，偏离正道的", "example": "The aberrant behavior of the stock market alarmed investors.", "translation": "股票市场的异常行为令投资者感到恐慌。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000962-6001-0000-0000-000000000000', 'acrimony', '/ˈækrɪmoʊni/', 'n.', '[{"pos": "n.", "meaning": "尖刻，刻薄", "example": "The debate was marked by acrimony and personal attacks.", "translation": "这场辩论以刻薄和人身攻击为特点。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000963-6001-0000-0000-000000000000', 'adamant', '/ˈædəmənt/', 'adj.', '[{"pos": "adj.", "meaning": "坚定不移的，坚决的", "example": "She was adamant that she would not change her mind.", "translation": "她坚决表示不会改变主意。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000964-6001-0000-0000-000000000000', 'admonish', '/ədˈmɑːnɪʃ/', 'v.', '[{"pos": "v.", "meaning": "告诫，训诫", "example": "The teacher admonished the students for their disruptive behavior.", "translation": "老师因学生们的破坏性行为而训诫他们。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000965-6001-0000-0000-000000000000', 'adroit', '/əˈdrɔɪt/', 'adj.', '[{"pos": "adj.", "meaning": "灵巧的，熟练的", "example": "She is adroit at handling delicate negotiations.", "translation": "她擅长处理微妙的谈判。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000966-6001-0000-0000-000000000000', 'affable', '/ˈæfəbəl/', 'adj.', '[{"pos": "adj.", "meaning": "和蔼可亲的，友善的", "example": "His affable manner put everyone at ease.", "translation": "他和蔼可亲的态度让每个人都感到放松。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000967-6001-0000-0000-000000000000', 'aggrandize', '/əˈɡrændaɪz/', 'v.', '[{"pos": "v.", "meaning": "夸大，扩张", "example": "He sought to aggrandize his own reputation at others'' expense.", "translation": "他试图以牺牲他人为代价来夸大自己的声誉。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000968-6001-0000-0000-000000000000', 'alacrity', '/əˈlækrəti/', 'n.', '[{"pos": "n.", "meaning": "敏捷，乐意", "example": "She accepted the invitation with alacrity.", "translation": "她欣然接受了邀请。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000969-6001-0000-0000-000000000000', 'alcove', '/ˈælkoʊv/', 'n.', '[{"pos": "n.", "meaning": "凹室，壁龛", "example": "The reading nook was tucked away in a cozy alcove.", "translation": "阅读角隐藏在一个舒适的凹室里。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000970-6001-0000-0000-000000000000', 'altruistic', '/ˌæltruˈɪstɪk/', 'adj.', '[{"pos": "adj.", "meaning": "无私的，利他的", "example": "Her altruistic efforts helped countless families in need.", "translation": "她无私的努力帮助了无数需要帮助的家庭。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000971-6001-0000-0000-000000000000', 'amiable', '/ˈeɪmiəbəl/', 'adj.', '[{"pos": "adj.", "meaning": "和蔼的，友善的", "example": "Despite the tense situation, she maintained an amiable demeanor.", "translation": "尽管情况紧张，她仍保持着和蔼的态度。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000972-6001-0000-0000-000000000000', 'anachronism', '/əˈnækrənɪzəm/', 'n.', '[{"pos": "n.", "meaning": "时代错误", "example": "The horse-drawn carriage seemed an anachronism in the modern city.", "translation": "马车在现代城市中似乎是一种时代错误。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000973-6001-0000-0000-000000000000', 'anomaly', '/əˈnɑːməli/', 'n.', '[{"pos": "n.", "meaning": "异常，不规则", "example": "The test results showed an anomaly that required further investigation.", "translation": "测试结果显示了需要进一步调查的异常情况。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000974-6001-0000-0000-000000000000', 'antithesis', '/ænˈtɪθəsɪs/', 'n.', '[{"pos": "n.", "meaning": "对立面，对比", "example": "His calm demeanor was the antithesis of her anxious nature.", "translation": "他冷静的态度与她焦虑的天性形成对比。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000975-6001-0000-0000-000000000000', 'apathy', '/ˈæpəθi/', 'n.', '[{"pos": "n.", "meaning": "冷漠，无感情", "example": "Voter apathy led to low turnout in the election.", "translation": "选民冷漠导致了选举投票率低迷。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000976-6001-0000-0000-000000000000', 'appease', '/əˈpiːz/', 'v.', '[{"pos": "v.", "meaning": "安抚，平息", "example": "She tried to appease the angry crowd with promises of reform.", "translation": "她试图用改革的承诺来安抚愤怒的人群。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000977-6001-0000-0000-000000000000', 'arcane', '/ɑːrˈkeɪn/', 'adj.', '[{"pos": "adj.", "meaning": "神秘的，晦涩难懂的", "example": "The arcane rituals of the ancient civilization fascinated archaeologists.", "translation": "古代文明的神秘仪式令考古学家着迷。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000978-6001-0000-0000-000000000000', 'arduous', '/ˈɑːrdʒuəs/', 'adj.', '[{"pos": "adj.", "meaning": "艰巨的，困难的", "example": "The arduous journey through the mountains tested their endurance.", "translation": "穿越山区的艰巨旅程考验了他们的耐力。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000979-6001-0000-0000-000000000000', 'ascetic', '/əˈsetɪk/', 'adj.', '[{"pos": "adj.", "meaning": "禁欲的，苦行的", "example": "The monk led an ascetic life, renouncing all worldly pleasures.", "translation": "这位僧侣过着禁欲的生活，放弃了所有世俗的享乐。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000980-6001-0000-0000-000000000000', 'assiduous', '/əˈsɪdʒuəs/', 'adj.', '[{"pos": "adj.", "meaning": "勤奋的，刻苦的", "example": "Her assiduous efforts were rewarded with a promotion.", "translation": "她勤奋的努力得到了晋升的回报。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000981-6001-0000-0000-000000000000', 'astute', '/əˈstuːt/', 'adj.', '[{"pos": "adj.", "meaning": "精明的，敏锐的", "example": "The astute investor recognized the opportunity before others.", "translation": "这位精明的投资者在其他人之前就发现了机会。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000982-6001-0000-0000-000000000000', 'audacious', '/ɔːˈdeɪʃəs/', 'adj.', '[{"pos": "adj.", "meaning": "大胆的，无畏的", "example": "The audacious plan to climb the uncharted peak shocked the climbing community.", "translation": "攀登未被探索山峰的大胆计划震惊了登山界。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000983-6001-0000-0000-000000000000', 'avarice', '/ˈævərɪs/', 'n.', '[{"pos": "n.", "meaning": "贪婪，贪财", "example": "His avarice led him to exploit the weak and vulnerable.", "translation": "他的贪婪使他剥削弱者和弱势群体。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000984-6001-0000-0000-000000000000', 'aver', '/əˈvɜːr/', 'v.', '[{"pos": "v.", "meaning": "断言，声称", "example": "She averred that the accusations were completely false.", "translation": "她断言这些指控完全不属实。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000985-6001-0000-0000-000000000000', 'avid', '/ˈævɪd/', 'adj.', '[{"pos": "adj.", "meaning": "渴望的，热心的", "example": "He is an avid reader who finishes a book every week.", "translation": "他是一位热心的读者，每周读完一本书。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000986-6001-0000-0000-000000000000', 'bane', '/beɪn/', 'n.', '[{"pos": "n.", "meaning": "祸根，灾星", "example": "Procrastination is the bane of many students'' existence.", "translation": "拖延是许多学生的大敌。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000987-6001-0000-0000-000000000000', 'banter', '/ˈbæntər/', 'n.', '[{"pos": "n.", "meaning": "打趣，玩笑", "example": "The friendly banter between the colleagues lightened the mood.", "translation": "同事们之间友好的玩笑缓解了气氛。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000988-6001-0000-0000-000000000000', 'bellicose', '/ˈbelɪkoʊs/', 'adj.', '[{"pos": "adj.", "meaning": "好战的，好斗的", "example": "The bellicose rhetoric escalated tensions between the two nations.", "translation": "好战的言辞加剧了两国之间的紧张局势。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000989-6001-0000-0000-000000000000', 'belligerent', '/bəˈlɪdʒərənt/', 'adj.', '[{"pos": "adj.", "meaning": "好斗的，敌对的", "example": "The belligerent crowd threw bottles at the police.", "translation": "好斗的人群向警察扔瓶子。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000990-6001-0000-0000-000000000000', 'benign', '/bɪˈnaɪn/', 'adj.', '[{"pos": "adj.", "meaning": "良性的，和蔼的", "example": "The tumor was benign, much to the relief of the patient.", "translation": "肿瘤是良性的，这让患者大大松了口气。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000991-6001-0000-0000-000000000000', 'bolster', '/ˈboʊlstər/', 'v.', '[{"pos": "v.", "meaning": "支持，加强", "example": "The new evidence bolstered the prosecution''s case.", "translation": "新证据加强了控方的案件。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000992-6001-0000-0000-000000000000', 'bombastic', '/bɑːmˈbæstɪk/', 'adj.', '[{"pos": "adj.", "meaning": "浮夸的，言过其实的", "example": "The politician''s bombastic speech failed to impress the audience.", "translation": "这位政治家浮夸的演讲未能打动听众。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000993-6001-0000-0000-000000000000', 'brevity', '/ˈbrevəti/', 'n.', '[{"pos": "n.", "meaning": "简洁，简短", "example": "The speaker was known for his brevity and clarity.", "translation": "这位演讲者以简洁和清晰著称。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000994-6001-0000-0000-000000000000', 'bristle', '/ˈbrɪsəl/', 'v.', '[{"pos": "v.", "meaning": "发怒，竖起", "example": "She bristled at the suggestion that she was incompetent.", "translation": "她因暗示她不称职而发怒。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000995-6001-0000-0000-000000000000', 'broach', '/broʊtʃ/', 'v.', '[{"pos": "v.", "meaning": "提出，开始讨论", "example": "He hesitated to broach the subject of salary negotiations.", "translation": "他犹豫着是否要提出薪资谈判的话题。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000996-6001-0000-0000-000000000000', 'buffet', '/ˈbʌfɪt/', 'v.', '[{"pos": "v.", "meaning": "打击，冲击", "example": "The company was buffeted by the economic downturn.", "translation": "公司受到了经济衰退的打击。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000997-6001-0000-0000-000000000000', 'bulwark', '/ˈbʊlwərk/', 'n.', '[{"pos": "n.", "meaning": "堡垒，屏障", "example": "Education serves as a bulwark against ignorance and prejudice.", "translation": "教育是抵御无知和偏见的堡垒。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000998-6001-0000-0000-000000000000', 'bungle', '/ˈbʌŋɡəl/', 'v.', '[{"pos": "v.", "meaning": "搞砸，弄糟", "example": "The contractor bungled the renovation, leaving the house in disarray.", "translation": "承包商搞砸了翻修，使房子陷入混乱。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0000999-6001-0000-0000-000000000000', 'burgeon', '/ˈbɜːrdʒən/', 'v.', '[{"pos": "v.", "meaning": "迅速发展，萌芽", "example": "The tech industry continued to burgeon in the emerging market.", "translation": "科技行业在新兴市场继续迅速发展。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001000-6001-0000-0000-000000000000', 'cacophony', '/kəˈkɑːfəni/', 'n.', '[{"pos": "n.", "meaning": "刺耳的声音，嘈杂", "example": "The cacophony of car horns and construction noise was overwhelming.", "translation": "汽车喇叭和施工噪音的嘈杂声令人难以忍受。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001001-6001-0000-0000-000000000000', 'calamity', '/kəˈlæməti/', 'n.', '[{"pos": "n.", "meaning": "灾难，不幸", "example": "The earthquake was a calamity that devastated the entire region.", "translation": "地震是一场摧毁整个地区的灾难。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001002-6001-0000-0000-000000000000', 'candid', '/ˈkændɪd/', 'adj.', '[{"pos": "adj.", "meaning": "坦率的，直言不讳的", "example": "She appreciated his candid assessment of the situation.", "translation": "她感谢他对情况的坦率评估。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001003-6001-0000-0000-000000000000', 'capricious', '/kəˈprɪʃəs/', 'adj.', '[{"pos": "adj.", "meaning": "反复无常的，任性的", "example": "The capricious weather made it difficult to plan outdoor activities.", "translation": "反复无常的天气使户外活动难以计划。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001004-6001-0000-0000-000000000000', 'castigate', '/ˈkæstɪɡeɪt/', 'v.', '[{"pos": "v.", "meaning": "严厉批评，谴责", "example": "The press castigated the politician for his unethical behavior.", "translation": "媒体严厉批评了这位政治家的不道德行为。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001005-6001-0000-0000-000000000000', 'catalyst', '/ˈkætəlɪst/', 'n.', '[{"pos": "n.", "meaning": "催化剂，促进因素", "example": "The protest served as a catalyst for widespread social change抗议成为了广泛社会变革的催化剂。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001006-6001-0000-0000-000000000000', 'caustic', '/ˈkɔːstɪk/', 'adj.', '[{"pos": "adj.", "meaning": "刻薄的，腐蚀性的", "example": "His caustic remarks wounded many of his colleagues.", "translation": "他刻薄的言语伤害了许多同事。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001007-6001-0000-0000-000000000000', 'caveat', '/ˈkæviæt/', 'n.', '[{"pos": "n.", "meaning": "警告，告诫", "example": "The recommendation came with the caveat that results may vary.", "translation": "该建议附带了结果可能不同的警告。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001008-6001-0000-0000-000000000000', 'cessation', '/seˈseɪʃən/', 'n.', '[{"pos": "n.", "meaning": "停止，终止", "example": "The cessation of hostilities brought relief to the war-torn region.", "translation": "敌对行动的停止给饱受战争蹂躏的地区带来了 relief。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001009-6001-0000-0000-000000000000', 'chicanery', '/ʃɪˈkeɪnəri/', 'n.', '[{"pos": "n.", "meaning": "欺骗，诡计", "example": "The lawyer was known for his legal chicanery.", "translation": "这位律师以其法律诡计而闻名。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001010-6001-0000-0000-000000000000', 'circumlocution', '/ˌsɜːrkəmloʊˈkjuːʃən/', 'n.', '[{"pos": "n.", "meaning": "迂回的言辞，累赘", "example": "His circumlocution made it difficult to understand his true intentions.", "translation": "他迂回的言辞使人难以理解他的真实意图。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001011-6001-0000-0000-000000000000', 'clandestine', '/klænˈdestɪn/', 'adj.', '[{"pos": "adj.", "meaning": "秘密的，暗中的", "example": "The clandestine operation was conducted under the cover of darkness.", "translation": "秘密行动在黑暗的掩护下进行。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001012-6001-0000-0000-000000000000', 'clemency', '/ˈklemənsi/', 'n.', '[{"pos": "n.", "meaning": "仁慈，宽大", "example": "The governor granted clemency to the wrongly convicted prisoner.", "translation": "州长对被错误定罪的囚犯给予了宽大处理。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001013-6001-0000-0000-000000000000', 'coalesce', '/ˌkoʊəˈles/', 'v.', '[{"pos": "v.", "meaning": "合并，联合", "example": "The various factions coalesced to form a unified opposition.", "translation": "各派系联合起来形成了统一的反对派。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001014-6001-0000-0000-000000000000', 'coercion', '/koʊˈɜːrʒən/', 'n.', '[{"pos": "n.", "meaning": "强迫，胁迫", "example": "The confession was obtained through coercion and is therefore inadmissible.", "translation": "供词是通过胁迫获得的，因此不可采纳。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001015-6001-0000-0000-000000000000', 'cognizant', '/ˈkɑːɡnɪzənt/', 'adj.', '[{"pos": "adj.", "meaning": "认识到的，知晓的", "example": "She was cognizant of the risks involved in the venture.", "translation": "她认识到这项冒险所涉及的风险。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001016-6001-0000-0000-000000000000', 'compelling', '/kəmˈpelɪŋ/', 'adj.', '[{"pos": "adj.", "meaning": "引人注目的，令人信服的", "example": "The documentary presented a compelling case for environmental protection.", "translation": "这部纪录片为环境保护提出了令人信服的论点。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001017-6001-0000-0000-000000000000', 'complacent', '/kəmˈpleɪsənt/', 'adj.', '[{"pos": "adj.", "meaning": "自满的，沾沾自喜的", "example": "The company became complacent and lost its competitive edge.", "translation": "公司变得自满，失去了竞争优势。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001018-6001-0000-0000-000000000000', 'compliant', '/kəmˈplaɪənt/', 'adj.', '[{"pos": "adj.", "meaning": "顺从的，服从的", "example": "The employees were compliant with the new safety regulations.", "translation": "员工们遵守新的安全规定。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001019-6001-0000-0000-000000000000', 'conceited', '/kənˈsiːtɪd/', 'adj.', '[{"pos": "adj.", "meaning": "自负的，骄傲的", "example": "His conceited attitude made him unpopular among his peers.", "translation": "他自负的态度使他在同龄人中不受欢迎。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001020-6001-0000-0000-000000000000', 'concoct', '/kənˈkɑːkt/', 'v.', '[{"pos": "v.", "meaning": "编造，策划", "example": "She concocted an elaborate excuse for being late.", "translation": "她编造了一个精心设计的迟到借口。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001021-6001-0000-0000-000000000000', 'conjecture', '/kənˈdʒektʃər/', 'n.', '[{"pos": "n.", "meaning": "推测，猜测", "example": "The report was based on conjecture rather than hard evidence.", "translation": "这份报告是基于推测而非确凿证据。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001022-6001-0000-0000-000000000000', 'conscientious', '/ˌkɑːnʃiˈenʃəs/', 'adj.', '[{"pos": "adj.", "meaning": "认真的，尽责的", "example": "She is a conscientious worker who never misses a deadline.", "translation": "她是一位认真的工作者，从不误期。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001023-6001-0000-0000-000000000000', 'consecrate', '/ˈkɑːnsɪkreɪt/', 'v.', '[{"pos": "v.", "meaning": "奉献，祝圣", "example": "The priest consecrated the new church with a special ceremony.", "translation": "牧师通过特别仪式祝圣了新教堂。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001024-6001-0000-0000-000000000000', 'conspicuous', '/kənˈspɪkjuəs/', 'adj.', '[{"pos": "adj.", "meaning": "显眼的，引人注目的", "example": "Her absence from the meeting was conspicuous.", "translation": "她缺席会议是显而易见的。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001025-6001-0000-0000-000000000000', 'construe', '/kənˈstruː/', 'v.', '[{"pos": "v.", "meaning": "解释，理解", "example": "His silence was construed as an admission of guilt.", "translation": "他的沉默被理解为承认有罪。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001026-6001-0000-0000-000000000000', 'contention', '/kənˈtenʃən/', 'n.', '[{"pos": "n.", "meaning": "争论，论点", "example": "The main contention of the article is that climate change is accelerating.", "translation": "这篇文章的主要论点是气候变化正在加速。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001027-6001-0000-0000-000000000000', 'contrite', '/kənˈtraɪt/', 'adj.', '[{"pos": "adj.", "meaning": "悔恨的，忏悔的", "example": "He appeared genuinely contrite after realizing his mistake.", "translation": "在意识到自己的错误后，他看起来真的很悔恨。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001028-6001-0000-0000-000000000000', 'converge', '/kənˈvɜːrdʒ/', 'v.', '[{"pos": "v.", "meaning": "汇聚，聚集", "example": "The two rivers converge just south of the city.", "translation": "两条河流在城市以南汇合。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001029-6001-0000-0000-000000000000', 'corroborate', '/kəˈrɑːbəreɪt/', 'v.', '[{"pos": "v.", "meaning": "证实，支持", "example": "The witness''s testimony corroborated the defendant''s alibi.", "translation": "证人的证词证实了被告的不在场证明。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001030-6001-0000-0000-000000000000', 'countenance', '/ˈkaʊntənəns/', 'n.', '[{"pos": "n.", "meaning": "面容，表情", "example": "Her calm countenance betrayed no hint of her inner turmoil.", "translation": "她平静的面容没有流露出内心的混乱。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001031-6001-0000-0000-000000000000', 'credulous', '/ˈkredʒələs/', 'adj.', '[{"pos": "adj.", "meaning": "轻信的，易受骗的", "example": "The credulous investors fell for the elaborate Ponzi scheme.", "translation": "轻信的投资者陷入了精心设计的庞氏骗局。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001032-6001-0000-0000-000000000000', 'crux', '/krʌks/', 'n.', '[{"pos": "n.", "meaning": "关键，核心", "example": "The crux of the debate is whether the policy benefits outweigh the costs.", "translation": "辩论的关键是政策利益是否超过成本。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001033-6001-0000-0000-000000000000', 'culpable', '/ˈkʌlpəbəl/', 'adj.', '[{"pos": "adj.", "meaning": "有罪的，应受谴责的", "example": "The investigation found the company culpable for the environmental damage.", "translation": "调查发现该公司应对环境破坏负责。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001034-6001-0000-0000-000000000000', 'dearth', '/dɜːrθ/', 'n.', '[{"pos": "n.", "meaning": "缺乏，不足", "example": "There is a dearth of qualified candidates for the position.", "translation": "该职位缺乏合格的候选人。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001035-6001-0000-0000-000000000000', 'debacle', '/dɪˈbɑːkəl/', 'n.', '[{"pos": "n.", "meaning": "惨败，溃败", "example": "The product launch was a debacle that cost the company millions.", "translation": "产品发布是一场惨败，给公司造成了数百万损失。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001036-6001-0000-0000-000000000000', 'deft', '/deft/', 'adj.', '[{"pos": "adj.", "meaning": "灵巧的，熟练的", "example": "With deft fingers, she repaired the delicate mechanism.", "translation": "她用灵巧的手指修复了精密的机械装置。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001037-6001-0000-0000-000000000000', 'defunct', '/dɪˈfʌŋkt/', 'adj.', '[{"pos": "adj.", "meaning": "已废止的，不存在的", "example": "The defunct company left behind a trail of unpaid debts.", "translation": "这家已不存在的公司留下了一连串未付债务。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001038-6001-0000-0000-000000000000', 'deleterious', '/ˌdeləˈtɪriəs/', 'adj.', '[{"pos": "adj.", "meaning": "有害的，有毒的", "example": "The deleterious effects of pollution on public health are well-documented.", "translation": "污染对公众健康的有害影响已有充分记录。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001039-6001-0000-0000-000000000000', 'delineate', '/dɪˈlɪneɪt/', 'v.', '[{"pos": "v.", "meaning": "描绘，勾画", "example": "The report delineated the boundaries between the two territories.", "translation": "报告描绘了两个领土之间的边界。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001040-6001-0000-0000-000000000000', 'demagogue', '/ˈdeməɡɑːɡ/', 'n.', '[{"pos": "n.", "meaning": "煽动者，蛊惑民心的政客", "example": "The demagogue exploited public fears to gain political power.", "translation": "这位煽动者利用公众恐惧获取政治权力。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001041-6001-0000-0000-000000000000', 'demur', '/dɪˈmɜːr/', 'v.', '[{"pos": "v.", "meaning": "表示异议，反对", "example": "She demurred at the suggestion that she should apologize.", "translation": "她对应该道歉的建议表示异议。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001042-6001-0000-0000-000000000000', 'deprecate', '/ˈdeprɪkeɪt/', 'v.', '[{"pos": "v.", "meaning": "反对，贬低", "example": "She deprecated the importance of the minor details.", "translation": "她贬低了次要细节的重要性。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001043-6001-0000-0000-000000000000', 'deride', '/dɪˈraɪd/', 'v.', '[{"pos": "v.", "meaning": "嘲笑，嘲讽", "example": "Critics derided the proposal as impractical and naive.", "translation": "批评者嘲笑该提议不切实际和幼稚。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001044-6001-0000-0000-000000000000', 'despondent', '/dɪˈspɑːndənt/', 'adj.', '[{"pos": "adj.", "meaning": "沮丧的，泄气的", "example": "She became despondent after repeated failures.", "translation": "在反复失败后，她变得沮丧。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001045-6001-0000-0000-000000000000', 'destitute', '/ˈdestɪtuːt/', 'adj.', '[{"pos": "adj.", "meaning": "贫困的，赤贫的", "example": "The earthquake left thousands of families destitute.", "translation": "地震使数千个家庭陷入赤贫。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001046-6001-0000-0000-000000000000', 'diatribe', '/ˈdaɪətraɪb/', 'n.', '[{"pos": "n.", "meaning": "抨击，谩骂", "example": "The editorial was a diatribe against government corruption.", "translation": "这篇社论是对政府腐败的抨击。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001047-6001-0000-0000-000000000000', 'didactic', '/daɪˈdæktɪk/', 'adj.', '[{"pos": "adj.", "meaning": "说教的，教诲的", "example": "The novel''s didactic tone made it less enjoyable as literature.", "translation": "这部小说的说教语气使其作为文学作品不那么令人愉快。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001048-6001-0000-0000-000000000000', 'diffident', '/ˈdɪfɪdənt/', 'adj.', '[{"pos": "adj.", "meaning": "缺乏自信的，胆怯的", "example": "Despite his brilliance, he remained diffident about his abilities.", "translation": "尽管才华横溢，他仍然对自己的能力缺乏自信。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001049-6001-0000-0000-000000000000', 'dilatory', '/ˈdɪlətɔːri/', 'adj.', '[{"pos": "adj.", "meaning": "拖延的，磨蹭的", "example": "The dilatory response from management frustrated the employees.", "translation": "管理层拖延的回应让员工感到沮丧。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001050-6001-0000-0000-000000000000', 'disaffected', '/ˌdɪsəˈfektɪd/', 'adj.', '[{"pos": "adj.", "meaning": "不满的，反叛的", "example": "The disaffected workers organized a strike against the company.", "translation": "不满的工人组织了针对公司的罢工。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001051-6001-0000-0000-000000000000', 'disparage', '/dɪˈspærɪdʒ/', 'v.', '[{"pos": "v.", "meaning": "贬低，轻视", "example": "She refused to disparage her competitors in the business.", "translation": "她拒绝贬低商业竞争对手。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001052-6001-0000-0000-000000000000', 'disparate', '/ˈdɪspərət/', 'adj.', '[{"pos": "adj.", "meaning": "截然不同的，不相干的", "example": "The two cultures, though disparate, share a common love of music.", "translation": "这两种文化虽然截然不同，却对音乐有着共同的热爱。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001053-6001-0000-0000-000000000000', 'disseminate', '/dɪˈsemɪneɪt/', 'v.', '[{"pos": "v.", "meaning": "传播，散布", "example": "The organization worked to disseminate accurate health information.", "translation": "该组织致力于传播准确的健康信息。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001054-6001-0000-0000-000000000000', 'dissolution', '/ˌdɪsəˈluːʃən/', 'n.', '[{"pos": "n.", "meaning": "解散，解除", "example": "The dissolution of the partnership was amicable.", "translation": "合伙关系的解散是友好的。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001055-6001-0000-0000-000000000000', 'divulge', '/daɪˈvʌldʒ/', 'v.', '[{"pos": "v.", "meaning": "泄露，透露", "example": "She refused to divulge the confidential information.", "translation": "她拒绝泄露机密信息。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001056-6001-0000-0000-000000000000', 'dogma', '/ˈdɔːɡmə/', 'n.', '[{"pos": "n.", "meaning": "教条，信条", "example": "She challenged the religious dogma that had governed her community.", "translation": "她挑战了统治她社区的宗教教条。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001057-6001-0000-0000-000000000000', 'duplicity', '/duːˈplɪsəti/', 'n.', '[{"pos": "n.", "meaning": "欺骗，口是心非", "example": "His duplicity was exposed when the emails were made public.", "translation": "当电子邮件被公开时，他的口是心非被曝光了。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001058-6001-0000-0000-000000000000', 'ebullient', '/ɪˈbʌliənt/', 'adj.', '[{"pos": "adj.", "meaning": "热情洋溢的，兴高采烈的", "example": "Her ebullient personality made her the life of every party.", "translation": "她热情洋溢的性格使她成为每次派对的焦点。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001059-6001-0000-0000-000000000000', 'efficacy', '/ˈefɪkəsi/', 'n.', '[{"pos": "n.", "meaning": "功效，效力", "example": "The efficacy of the new vaccine was confirmed in clinical trials.", "translation": "新疫苗的功效在临床试验中得到证实。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001060-6001-0000-0000-000000000000', 'egregious', '/ɪˈɡriːdʒəs/', 'adj.', '[{"pos": "adj.", "meaning": "极其恶劣的，极坏的", "example": "The egregious error in the financial report led to an investigation.", "translation": "财务报告中的极其恶劣的错误导致了调查。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001061-6001-0000-0000-000000000000', 'elucidate', '/ɪˈluːsɪdeɪt/', 'v.', '[{"pos": "v.", "meaning": "阐明，解释", "example": "The professor elucidated the complex theory with clear examples.", "translation": "教授用清晰的例子阐明了复杂的理论。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001062-6001-0000-0000-000000000000', 'emancipate', '/ɪˈmænsɪpeɪt/', 'v.', '[{"pos": "v.", "meaning": "解放，使自由", "example": "The movement sought to emancipate oppressed peoples around the world.", "translation": "这场运动旨在解放世界各地受压迫的人民。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001063-6001-0000-0000-000000000000', 'embellish', '/ɪmˈbelɪʃ/', 'v.', '[{"pos": "v.", "meaning": "修饰，美化", "example": "He tended to embellish his stories to make them more interesting.", "translation": "他倾向于修饰他的故事使其更有趣。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001064-6001-0000-0000-000000000000', 'endemic', '/enˈdemɪk/', 'adj.', '[{"pos": "adj.", "meaning": "地方性的，特有的", "example": "Corruption is endemic in some parts of the government.", "translation": "腐败在政府的某些部门是普遍存在的。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001065-6001-0000-0000-000000000000', 'enervate', '/ˈenərveɪt/', 'v.', '[{"pos": "v.", "meaning": "使衰弱，使无力", "example": "The tropical heat enervated the travelers after hours of walking.", "translation": "热带的炎热在数小时的行走后使旅行者感到疲惫。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001066-6001-0000-0000-000000000000', 'engender', '/ɪnˈdʒendər/', 'v.', '[{"pos": "v.", "meaning": "引起，产生", "example": "The policy changes engendered widespread public debate.", "translation": "政策变化引起了广泛的公众辩论。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001067-6001-0000-0000-000000000000', 'ephemeral', '/ɪˈfemərəl/', 'adj.', '[{"pos": "adj.", "meaning": "短暂的，转瞬即逝的", "example": "The beauty of cherry blossoms is ephemeral, lasting only a few days.", "translation": "樱花之美是短暂的，只持续几天。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001068-6001-0000-0000-000000000000', 'equanimity', '/ˌekwəˈnɪməti/', 'n.', '[{"pos": "n.", "meaning": "平静，沉着", "example": "She faced the crisis with remarkable equanimity.", "translation": "她以非凡的平静面对危机。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001069-6001-0000-0000-000000000000', 'equivocal', '/ɪˈkwɪvəkəl/', 'adj.', '[{"pos": "adj.", "meaning": "模棱两可的，不明确的", "example": "The politician gave an equivocal answer that satisfied no one.", "translation": "这位政治家给出了一个模棱两可的答案，没有人满意。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001070-6001-0000-0000-000000000000', 'esoteric', '/ˌesəˈterɪk/', 'adj.', '[{"pos": "adj.", "meaning": "深奥的，难懂的", "example": "The professor''s esoteric lectures were lost on most students.", "translation": "教授深奥的讲座对大多数学生来说难以理解。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001071-6001-0000-0000-000000000000', 'exacerbate', '/ɪɡˈzæsərbeɪt/', 'v.', '[{"pos": "v.", "meaning": "加剧，恶化", "example": "The drought exacerbated the food shortage in the region.", "translation": "干旱加剧了该地区的粮食短缺。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001072-6001-0000-0000-000000000000', 'exhort', '/ɪɡˈzɔːrt/', 'v.', '[{"pos": "v.", "meaning": "劝诫，敦促", "example": "The coach exhorted the team to give their best performance.", "translation": "教练敦促球队发挥最佳水平。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001073-6001-0000-0000-000000000000', 'expedient', '/ɪkˈspiːdiənt/', 'adj.', '[{"pos": "adj.", "meaning": "权宜的，方便的", "example": "The expedient solution addressed the immediate problem but not the root cause.", "translation": "权宜的解决方案解决了眼前的问题，但没有解决根本原因。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001074-6001-0000-0000-000000000000', 'expurgate', '/ˈekspɜːrɡeɪt/', 'v.', '[{"pos": "v.", "meaning": "删去，净化", "example": "The publisher expurgated the controversial sections from the book.", "translation": "出版商从书中删去了有争议的部分。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001075-6001-0000-0000-000000000000', 'extol', '/ɪkˈstoʊl/', 'v.', '[{"pos": "v.", "meaning": "赞美，颂扬", "example": "The critic extolled the virtues of the innovative design.", "translation": "批评家赞扬了创新设计的优点。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001076-6001-0000-0000-000000000000', 'extraneous', '/ɪkˈstreɪniəs/', 'adj.', '[{"pos": "adj.", "meaning": "无关的，外来的", "example": "She removed all extraneous details from her presentation.", "translation": "她从演示中删除了所有无关的细节。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001077-6001-0000-0000-000000000000', 'facetious', '/fəˈsiːʃəs/', 'adj.', '[{"pos": "adj.", "meaning": "滑稽的，不当地幽默的", "example": "His facetious remarks during the serious meeting offended many people.", "translation": "他在严肃会议期间的滑稽言论冒犯了许多人。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001078-6001-0000-0000-000000000000', 'fallacious', '/fəˈleɪʃəs/', 'adj.', '[{"pos": "adj.", "meaning": "谬误的，虚假的", "example": "The argument was based on fallacious reasoning and had no merit.", "translation": "这个论点基于谬误的推理，没有任何价值。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001079-6001-0000-0000-000000000000', 'fastidious', '/fæˈstɪdiəs/', 'adj.', '[{"pos": "adj.", "meaning": "一丝不苟的，挑剔的", "example": "She was fastidious about every detail of the project.", "translation": "她对项目的每一个细节都一丝不苟。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001080-6001-0000-0000-000000000000', 'flag', '/flæɡ/', 'v.', '[{"pos": "v.", "meaning": "衰退，减退", "example": "The company''s profits began to flag after the economic downturn.", "translation": "经济衰退后，公司的利润开始下降。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001081-6001-0000-0000-000000000000', 'florid', '/ˈflɔːrɪd/', 'adj.', '[{"pos": "adj.", "meaning": "华丽的，过分装饰的", "example": "The author''s florid prose was admired by some but criticized by others.", "translation": "这位作者华丽的散文受到一些人的赞赏，但也受到其他人的批评。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001082-6001-0000-0000-000000000000', 'fortuitous', '/fɔːrˈtuːɪtəs/', 'adj.', '[{"pos": "adj.", "meaning": "偶然的，幸运的", "example": "Their fortuitous meeting led to a lasting friendship.", "translation": "他们的偶然相遇促成了持久的友谊。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001083-6001-0000-0000-000000000000', 'fractious', '/ˈfrækʃəs/', 'adj.', '[{"pos": "adj.", "meaning": "易怒的，难以控制的", "example": "The fractious child refused to cooperate during the family outing.", "translation": "这个易怒的孩子在家庭出游时拒绝合作。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001084-6001-0000-0000-000000000000', 'frivolous', '/ˈfrɪvələs/', 'adj.', '[{"pos": "adj.", "meaning": "轻浮的，琐碎的", "example": "The lawsuit was dismissed as frivolous and without merit.", "translation": "该诉讼被驳回，理由是轻浮且没有价值。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001085-6001-0000-0000-000000000000', 'frothy', '/ˈfrɔːθi/', 'adj.', '[{"pos": "adj.", "meaning": "泡沫的，浅薄的", "example": "The frothy conversation lacked any real substance.", "translation": "这场浅薄的对话缺乏任何实质内容。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001086-6001-0000-0000-000000000000', 'futile', '/ˈfjuːtaɪl/', 'adj.', '[{"pos": "adj.", "meaning": "徒劳的，无用的", "example": "Their attempts to negotiate a ceasefire proved futile.", "translation": "他们谈判停火的努力被证明是徒劳的"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001087-6001-0000-0000-000000000000', 'garrulous', '/ˈɡærələs/', 'adj.', '[{"pos": "adj.", "meaning": "话多的，唠叨的", "example": "The garrulous neighbor kept them talking for hours.", "translation": "这位话多的邻居让他们聊了好几个小时。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001088-6001-0000-0000-000000000000', 'glib', '/ɡlɪb/', 'adj.', '[{"pos": "adj.", "meaning": "油嘴滑舌的，口齿伶俐的", "example": "His glib explanation didn''t convince anyone of his innocence.", "translation": "他油嘴滑舌的解释没能说服任何人相信他的无辜。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001089-6001-0000-0000-000000000000', 'gregarious', '/ɡrɪˈɡeriəs/', 'adj.', '[{"pos": "adj.", "meaning": "社交的，合群的", "example": "Her gregarious nature made her popular at social gatherings.", "translation": "她合群的性格使她在社交聚会上很受欢迎。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001090-6001-0000-0000-000000000000', 'hackneyed', '/ˈhæknid/', 'adj.', '[{"pos": "adj.", "meaning": "陈腐的，老套的", "example": "The speech was full of hackneyed phrases that bored the audience.", "translation": "演讲充满了陈腐的短语，让听众感到无聊。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001091-6001-0000-0000-000000000000', 'harangue', '/həˈræŋ/', 'n.', '[{"pos": "n.", "meaning": "长篇大论，激昂的演说", "example": "The manager''s harangue about punctuality left the staff demoralized.", "translation": "经理关于守时的长篇大论让员工士气低落。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001092-6001-0000-0000-000000000000', 'hegemony', '/hɪˈɡeməni/', 'n.', '[{"pos": "n.", "meaning": "霸权，领导权", "example": "The empire maintained its hegemony over the region for centuries.", "translation": "这个帝国几个世纪以来一直维持着对该地区的霸权。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001093-6001-0000-0000-000000000000', 'heresy', '/ˈherəsi/', 'n.', '[{"pos": "n.", "meaning": "异端，异教", "example": "His scientific theories were considered heresy by the establishment.", "translation": "他的科学理论被当权者视为异端。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001094-6001-0000-0000-000000000000', 'heterogeneous', '/ˌhetərəˈdʒiːniəs/', 'adj.', '[{"pos": "adj.", "meaning": "异质的，不同种类的", "example": "The committee was a heterogeneous group with diverse perspectives.", "translation": "委员会是一个由不同视角组成的异质群体。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001095-6001-0000-0000-000000000000', 'hubris', '/ˈhjuːbrɪs/', 'n.', '[{"pos": "n.", "meaning": "傲慢，自大", "example": "His hubris led to his downfall when he ignored all advice.", "translation": "傲慢导致了他的垮台，因为他无视了所有建议。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001096-6001-0000-0000-000000000000', 'idiosyncratic', '/ˌɪdiəsɪŋˈkrætɪk/', 'adj.', '[{"pos": "adj.", "meaning": "独特的，有特点的", "example": "Her idiosyncratic writing style set her apart from other authors.", "translation": "她独特的写作风格使她与其他作家区分开来。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001097-6001-0000-0000-000000000000', 'ignominious', '/ˌɪɡnəˈmɪniəs/', 'adj.', '[{"pos": "adj.", "meaning": "可耻的，不光彩的", "example": "The team suffered an ignominious defeat in the championship.", "translation": "球队在锦标赛中遭受了可耻的失败。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001098-6001-0000-0000-000000000000', 'immutable', '/ɪˈmjuːtəbəl/', 'adj.', '[{"pos": "adj.", "meaning": "不可变的，永恒的", "example": "The laws of physics are considered immutable.", "translation": "物理定律被认为是不可变的。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001099-6001-0000-0000-000000000000', 'imperious', '/ɪmˈpɪriəs/', 'adj.', '[{"pos": "adj.", "meaning": "专横的，傲慢的", "example": "Her imperious manner alienated many of her subordinates.", "translation": "她专横的态度疏远了许多下属。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001100-6001-0000-0000-000000000000', 'impervious', '/ɪmˈpɜːrviəs/', 'adj.', '[{"pos": "adj.", "meaning": "不受影响的，不能渗透的", "example": "He seemed impervious to criticism from his peers.", "translation": "他似乎不受同龄人批评的影响。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001101-6001-0000-0000-000000000000', 'implacable', '/ɪmˈplækəbəl/', 'adj.', '[{"pos": "adj.", "meaning": "不可安抚的，无情的", "example": "She was implacable in her demand for justice.", "translation": "她在追求正义方面不可妥协。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001102-6001-0000-0000-000000000000', 'inauspicious', '/ˌɪnɔːˈspɪʃəs/', 'adj.', '[{"pos": "adj.", "meaning": "不祥的，不吉利的", "example": "The project got off to an inauspicious start with budget overruns.", "translation": "该项目以预算超支的不祥开局。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001103-6001-0000-0000-000000000000', 'incandescent', '/ˌɪnkænˈdesənt/', 'adj.', '[{"pos": "adj.", "meaning": "白热的，光芒四射的", "example": "The incandescent light of the fireworks illuminated the night sky.", "translation": "烟花的白热光芒照亮了夜空。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001104-6001-0000-0000-000000000000', 'incongruous', '/ɪnˈkɑːŋɡruəs/', 'adj.', '[{"pos": "adj.", "meaning": "不协调的，不一致的", "example": "The modern glass building looked incongruous next to the historic church.", "translation": "现代玻璃建筑与历史教堂并立显得不协调。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001105-6001-0000-0000-000000000000', 'incorrigible', '/ɪnˈkɔːrɪdʒəbəl/', 'adj.', '[{"pos": "adj.", "meaning": "无可救药的，不可救药的", "example": "He was an incorrigible optimist who never lost hope.", "translation": "他是一个无可救药的乐观主义者，从不失去希望。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001106-6001-0000-0000-000000000000', 'indifferent', '/ɪnˈdɪfərənt/', 'adj.', '[{"pos": "adj.", "meaning": "冷漠的，不关心的", "example": "She seemed indifferent to the outcome of the election.", "translation": "她似乎对选举结果漠不关心。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001107-6001-0000-0000-000000000000', 'indigent', '/ˈɪndɪdʒənt/', 'adj.', '[{"pos": "adj.", "meaning": "贫困的，贫穷的", "example": "The charity provided food and shelter for indigent families.", "translation": "慈善机构为贫困家庭提供食物和住所。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001108-6001-0000-0000-000000000000', 'indolent', '/ˈɪndələnt/', 'adj.', '[{"pos": "adj.", "meaning": "懒惰的，无所事事的", "example": "His indolent lifestyle prevented him from achieving his potential.", "translation": "他懒惰的生活方式阻止了他发挥潜力。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001109-6001-0000-0000-000000000000', 'ineffable', '/ɪˈnefəbəl/', 'adj.', '[{"pos": "adj.", "meaning": "难以表达的，难以形容的", "example": "The beauty of the sunset was ineffable.", "translation": "日落之美难以形容。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001110-6001-0000-0000-000000000000', 'inexorable', '/ɪˈneksərəbəl/', 'adj.', '[{"pos": "adj.", "meaning": "不可阻挡的，无情的", "example": "The inexorable march of technology has transformed every aspect of life.", "translation": "技术不可阻挡的进步改变了生活的方方面面。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001111-6001-0000-0000-000000000000', 'ingenuous', '/ɪnˈdʒenjuəs/', 'adj.', '[{"pos": "adj.", "meaning": "天真的，直率的", "example": "Her ingenuous questions revealed her lack of experience.", "translation": "她天真的问题暴露了她缺乏经验。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001112-6001-0000-0000-000000000000', 'iniquitous', '/ɪˈnɪkwɪtəs/', 'adj.', '[{"pos": "adj.", "meaning": "邪恶的，不公正的", "example": "The iniquitous treatment of workers sparked nationwide protests.", "translation": "对工人的不公正待遇引发了全国性的抗议。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001113-6001-0000-0000-000000000000', 'innocuous', '/ɪˈnɑːkjuəs/', 'adj.', '[{"pos": "adj.", "meaning": "无害的，无毒的", "example": "What seemed like an innocuous comment provoked a heated debate.", "translation": "看似无害的评论引发了一场激烈的辩论。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001114-6001-0000-0000-000000000000', 'inscrutable', '/ɪnˈskruːtəbəl/', 'adj.', '[{"pos": "adj.", "meaning": "神秘的，不可理解的", "example": "His inscrutable expression gave no hint of his true feelings.", "translation": "他神秘的表情没有流露出他的真实感受。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001115-6001-0000-0000-000000000000', 'insidious', '/ɪnˈsɪdiəs/', 'adj.', '[{"pos": "adj.", "meaning": "阴险的，潜伏的", "example": "The insidious effects of misinformation eroded public trust.", "translation": "错误信息的阴险影响侵蚀了公众信任。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001116-6001-0000-0000-000000000000', 'intransigent', '/ɪnˈtrænsɪdʒənt/', 'adj.', '[{"pos": "adj.", "meaning": "不妥协的，固执的", "example": "The intransigent negotiators refused to make any concessions.", "translation": "不妥协的谈判者拒绝做出任何让步。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001117-6001-0000-0000-000000000000', 'inundate', '/ˈɪnʌndeɪt/', 'v.', '[{"pos": "v.", "meaning": "淹没，使应接不暇", "example": "The office was inundated with calls after the announcement.", "translation": "公告发出后，办公室被电话淹没。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001118-6001-0000-0000-000000000000', 'inveigle', '/ɪnˈveɪɡəl/', 'v.', '[{"pos": "v.", "meaning": "诱骗，哄骗", "example": "She inveigled him into investing in her questionable scheme.", "translation": "她诱骗他投资她可疑的计划。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001119-6001-0000-0000-000000000000', 'irascible', '/ɪˈræsəbəl/', 'adj.', '[{"pos": "adj.", "meaning": "易怒的，暴躁的", "example": "The irascible professor was feared by his students.", "translation": "这位易怒的教授令学生们畏惧。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001120-6001-0000-0000-000000000000', 'itinerant', '/aɪˈtɪnərənt/', 'adj.', '[{"pos": "adj.", "meaning": "流动的，巡回的", "example": "The itinerant workers moved from farm to farm following the harvest.", "translation": "流动工人随着收获季节从一个农场搬到另一个农场。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001121-6001-0000-0000-000000000000', 'jaundiced', '/ˈdʒɔːndɪst/', 'adj.', '[{"pos": "adj.", "meaning": "偏见的，嫉妒的", "example": "His jaundiced view of the industry prevented him from seeing opportunities.", "translation": "他对行业偏见的看法使他看不到机会。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001122-6001-0000-0000-000000000000', 'judicious', '/dʒuːˈdɪʃəs/', 'adj.', '[{"pos": "adj.", "meaning": "明智的，审慎的", "example": "A judicious use of resources can improve outcomes significantly.", "translation": "明智地使用资源可以显著改善结果。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001123-6001-0000-0000-000000000000', 'laconic', '/ləˈkɑːnɪk/', 'adj.', '[{"pos": "adj.", "meaning": "简洁的，言简意赅的", "example": "His laconic reply left much to be interpreted.", "translation": "他言简意赅的回复留有很多解释空间。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001124-6001-0000-0000-000000000000', 'lament', '/ləˈment/', 'v.', '[{"pos": "v.", "meaning": "哀悼，悲叹", "example": "She lamented the loss of her childhood home.", "translation": "她哀悼失去了童年的家。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001125-6001-0000-0000-000000000000', 'lassitude', '/ˈlæsɪtuːd/', 'n.', '[{"pos": "n.", "meaning": "疲倦，倦怠", "example": "A feeling of lassitude overcame her after the long journey.", "translation": "长途旅行后，一种倦怠感袭来。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001126-6001-0000-0000-000000000000', 'libelous', '/ˈlaɪbələs/', 'adj.', '[{"pos": "adj.", "meaning": "诽谤的，中伤的", "example": "The libelous article was retracted after legal threats.", "translation": "在法律威胁后，那篇诽谤性文章被撤回。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001127-6001-0000-0000-000000000000', 'litigious', '/lɪˈtɪdʒəs/', 'adj.', '[{"pos": "adj.", "meaning": "好诉讼的，爱争论的", "example": "The company''s litigious reputation deterred potential partners.", "translation": "公司好诉讼的声誉阻止了潜在合作伙伴。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001128-6001-0000-0000-000000000000', 'loquacious', '/loʊˈkweɪʃəs/', 'adj.', '[{"pos": "adj.", "meaning": "健谈的，话多的", "example": "The loquacious host kept the conversation flowing all evening.", "translation": "健谈的主持人让整个晚上的谈话流畅进行。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001129-6001-0000-0000-000000000000', 'maudlin', '/ˈmɔːdlɪn/', 'adj.', '[{"pos": "adj.", "meaning": "伤感的，多愁善感的", "example": "The maudlin movie left the audience in tears.", "translation": "这部伤感的电影让观众泪流满面。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001130-6001-0000-0000-000000000000', 'meander', '/miˈændər/', 'v.', '[{"pos": "v.", "meaning": "蜿蜒，漫步", "example": "The river meanders through the valley before reaching the sea.", "translation": "河流蜿蜒穿过山谷，最终流入大海。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001131-6001-0000-0000-000000000000', 'mercenary', '/ˈmɜːrsəneri/', 'adj.', '[{"pos": "adj.", "meaning": "唯利是图的，雇佣的", "example": "His mercenary motives were evident in his business dealings.", "translation": "他唯利是图的动机在他的商业交易中显而易见。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001132-6001-0000-0000-000000000000', 'mercurial', '/mɜːrˈkjʊriəl/', 'adj.', '[{"pos": "adj.", "meaning": "善变的，反复无常的", "example": "Her mercurial temperament made it difficult to predict her reactions.", "translation": "她善变的性情使人难以预测她的反应。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001133-6001-0000-0000-000000000000', 'milieu', '/miːlˈjɜːr/', 'n.', '[{"pos": "n.", "meaning": "环境，背景", "example": "The novel accurately depicted the milieu of 19th-century Paris.", "translation": "这部小说准确地描绘了19世纪巴黎的环境。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001134-6001-0000-0000-000000000000', 'misanthrope', '/ˈmɪsənθroʊp/', 'n.', '[{"pos": "n.", "meaning": "厌世者，愤世嫉俗的人", "example": "The misanthrope preferred the company of books to people.", "translation": "这位厌世者更喜欢书的陪伴而非人类。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001135-6001-0000-0000-000000000000', 'mollify', '/ˈmɑːlɪfaɪ/', 'v.', '[{"pos": "v.", "meaning": "安抚，平息", "example": "She tried to mollify the angry customer with a full refund.", "translation": "她试图用全额退款来安抚愤怒的顾客。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001136-6001-0000-0000-000000000000', 'morose', '/məˈroʊs/', 'adj.', '[{"pos": "adj.", "meaning": "忧郁的，阴沉的", "example": "He became morose after losing his job.", "translation": "失业后他变得忧郁。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001137-6001-0000-0000-000000000000', 'munificent', '/mjuːˈnɪfɪsənt/', 'adj.', '[{"pos": "adj.", "meaning": "慷慨的，大方的", "example": "The munificent donation allowed the hospital to expand its facilities.", "translation": "慷慨的捐赠使医院得以扩展其设施。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001138-6001-0000-0000-000000000000', 'nefarious', '/nɪˈferiəs/', 'adj.', '[{"pos": "adj.", "meaning": "邪恶的，不法的", "example": "The criminal''s nefarious scheme was eventually uncovered.", "translation": "罪犯的邪恶阴谋最终被揭穿。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001139-6001-0000-0000-000000000000', 'neophyte', '/ˈniːəfaɪt/', 'n.', '[{"pos": "n.", "meaning": "新手，初学者", "example": "As a neophyte in the field, she had much to learn.", "translation": "作为该领域的新手，她有很多需要学习。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001140-6001-0000-0000-000000000000', 'nihilism', '/ˈnaɪɪlɪzəm/', 'n.', '[{"pos": "n.", "meaning": "虚无主义", "example": "The philosopher''s writings explored themes of existential nihilism.", "translation": "这位哲学家的作品探讨了存在主义虚无主义的主题。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001141-6001-0000-0000-000000000000', 'nonchalant', '/ˌnɑːnʃəˈlɑːnt/', 'adj.', '[{"pos": "adj.", "meaning": "漫不经心的，若无其事的", "example": "She remained nonchalant despite the mounting pressure.", "translation": "尽管压力不断增加，她仍然若无其事。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001142-6001-0000-0000-000000000000', 'nostalgia', '/nɔːˈstældʒə/', 'n.', '[{"pos": "n.", "meaning": "怀旧，乡愁", "example": "The old photographs filled her with nostalgia for her childhood.", "translation": "旧照片让她充满了对童年的怀念。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001143-6001-0000-0000-000000000000', 'obdurate', '/ˈɑːbdʒʊrət/', 'adj.', '[{"pos": "adj.", "meaning": "顽固的，执拗的", "example": "Despite all attempts at persuasion, he remained obdurate.", "translation": "尽管进行了所有说服尝试，他仍然顽固不化。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001144-6001-0000-0000-000000000000', 'obsequious', '/əbˈsiːkwiəs/', 'adj.', '[{"pos": "adj.", "meaning": "谄媚的，奉承的", "example": "The obsequious assistant agreed with everything the boss said.", "translation": "谄媚的助手同意老板说的每一句话。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001145-6001-0000-0000-000000000000', 'omnipotent', '/ɑːmˈnɪpətənt/', 'adj.', '[{"pos": "adj.", "meaning": "全能的，无所不能的", "example": "No leader is omnipotent, regardless of their power or authority.", "translation": "没有领导者是全能的，无论他们的权力或权威有多大。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001146-6001-0000-0000-000000000000', 'onerous', '/ˈoʊnərəs/', 'adj.', '[{"pos": "adj.", "meaning": "繁重的，艰巨的", "example": "The onerous task of reforming the tax system fell to the new administration.", "translation": "改革税制的艰巨任务落到了新政府身上。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001147-6001-0000-0000-000000000000', 'opulent', '/ˈɑːpjələnt/', 'adj.', '[{"pos": "adj.", "meaning": "富裕的，华丽的", "example": "The opulent ballroom was adorned with crystal chandeliers.", "translation": "华丽的宴会厅装饰着水晶吊灯。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001148-6001-0000-0000-000000000000', 'ornate', '/ɔːrˈneɪt/', 'adj.', '[{"pos": "adj.", "meaning": "华丽的，装饰的", "example": "The ornate architecture of the cathedral took decades to complete.", "translation": "大教堂华丽的建筑花了数十年才完成。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001149-6001-0000-0000-000000000000', 'ossify', '/ˈɑːsɪfaɪ/', 'v.', '[{"pos": "v.", "meaning": "僵化，骨化", "example": "The organization''s procedures had ossified over time.", "translation": "该组织的程序随着时间推移而僵化。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001150-6001-0000-0000-000000000000', 'ostentatious', '/ˌɑːstenˈteɪʃəs/', 'adj.', '[{"pos": "adj.", "meaning": "炫耀的，卖弄的", "example": "His ostentatious display of wealth alienated his modest friends.", "translation": "他炫耀财富的行为疏远了他谦虚的朋友们。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001151-6001-0000-0000-000000000000', 'palatial', '/pəˈleɪʃəl/', 'adj.', '[{"pos": "adj.", "meaning": "宫殿般的，宏伟的", "example": "The palatial estate featured manicured gardens and marble floors.", "translation": "这座宫殿般的庄园拥有精心修剪的花园和大理石地板。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001152-6001-0000-0000-000000000000', 'paragon', '/ˈpærəɡɑːn/', 'n.', '[{"pos": "n.", "meaning": "典范，榜样", "example": "She was considered a paragon of virtue in the community.", "translation": "她被视为社区美德的典范。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001153-6001-0000-0000-000000000000', 'parsimonious', '/ˌpɑːrsɪˈmoʊniəs/', 'adj.', '[{"pos": "adj.", "meaning": "吝啬的，小气的", "example": "The parsimonious employer refused to give raises to his staff.", "translation": "吝啬的雇主拒绝给员工加薪。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001154-6001-0000-0000-000000000000', 'pedantic', '/pɪˈdæntɪk/', 'adj.', '[{"pos": "adj.", "meaning": "学究式的，迂腐的", "example": "His pedantic approach to grammar annoyed his casual readers.", "translation": "他对语法的学究式方法惹恼了他随意的读者。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001155-6001-0000-0000-000000000000', 'penitent', '/ˈpenɪtənt/', 'adj.', '[{"pos": "adj.", "meaning": "悔过的，忏悔的", "example": "The penitent criminal vowed never to offend again.", "translation": "悔过的罪犯发誓不再犯罪。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001156-6001-0000-0000-000000000000', 'pensive', '/ˈpensɪv/', 'adj.', '[{"pos": "adj.", "meaning": "沉思的，忧郁的", "example": "She sat in a pensive mood, reflecting on her past decisions.", "translation": "她沉思着，反思过去的决定。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001157-6001-0000-0000-000000000000', 'perfidious', '/pərˈfɪdiəs/', 'adj.', '[{"pos": "adj.", "meaning": "背信弃义的，不忠的", "example": "The perfidious ally betrayed them at the critical moment.", "translation": "背信弃义的盟友在关键时刻背叛了他们。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001158-6001-0000-0000-000000000000', 'perfunctory', '/pərˈfʌŋktəri/', 'adj.', '[{"pos": "adj.", "meaning": "敷衍的，马虎的", "example": "He gave the report a perfunctory glance before signing it.", "translation": "他在签署报告前只是敷衍地看了一眼。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001159-6001-0000-0000-000000000000', 'pernicious', '/pərˈnɪʃəs/', 'adj.', '[{"pos": "adj.", "meaning": "有害的，致命的", "example": "The pernicious effects of corruption undermined public trust.", "translation": "腐败的有害影响削弱了公众信任。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001160-6001-0000-0000-000000000000', 'perquisite', '/ˈpɜːrskwɪzɪt/', 'n.', '[{"pos": "n.", "meaning": "特权，额外津贴", "example": "The corner office was a perquisite of the CEO position.", "translation": "角落办公室是首席执行官职位的额外津贴。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001161-6001-0000-0000-000000000000', 'pertinacious', '/ˌpɜːrtɪˈneɪʃəs/', 'adj.', '[{"pos": "adj.", "meaning": "执着的，固执的", "example": "Her pertinacious pursuit of justice inspired many activists.", "translation": "她对正义的执着追求激励了许多活动家。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001162-6001-0000-0000-000000000000', 'placate', '/ˈpleɪkeɪt/', 'v.', '[{"pos": "v.", "meaning": "安抚，平息", "example": "The company issued a public apology to placate angry customers.", "translation": "公司发布公开道歉以安抚愤怒的顾客。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001163-6001-0000-0000-000000000000', 'platitude', '/ˈplætɪtuːd/', 'n.', '[{"pos": "n.", "meaning": "陈词滥调，老生常谈", "example": "The speech was full of platitudes that failed to inspire action.", "translation": "演讲充满了未能激发行动的陈词滥调。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001164-6001-0000-0000-000000000000', 'polemical', '/pəˈlemɪkəl/', 'adj.', '[{"pos": "adj.", "meaning": "好争论的，论战的", "example": "His polemical essay sparked a fierce debate in academic circles.", "translation": "他论战性的论文在学术界引发了激烈的辩论。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001165-6001-0000-0000-000000000000', 'prescient', '/ˈpreʃiənt/', 'adj.', '[{"pos": "adj.", "meaning": "有先见之明的", "example": "Her prescient warnings about the economic bubble were ignored.", "translation": "她对经济泡沫的先知性警告被忽视了。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001166-6001-0000-0000-000000000000', 'proclivity', '/proʊˈklɪvəti/', 'n.', '[{"pos": "n.", "meaning": "倾向，嗜好", "example": "He had a proclivity for exaggeration in his storytelling.", "translation": "他在讲故事时有夸张的倾向。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001167-6001-0000-0000-000000000000', 'prodigal', '/ˈprɑːdɪɡəl/', 'adj.', '[{"pos": "adj.", "meaning": "挥霍的，浪费的", "example": "The prodigal son eventually returned home after squandering his inheritance.", "translation": "挥霍的儿子在挥霍掉遗产后最终回到了家。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001168-6001-0000-0000-000000000000', 'promulgate', '/ˈprɑːmʌlɡeɪt/', 'v.', '[{"pos": "v.", "meaning": "公布，颁布", "example": "The government promulgated new regulations to protect consumers.", "translation": "政府颁布了保护消费者的新法规。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001169-6001-0000-0000-000000000000', 'propitious', '/prəˈpɪʃəs/', 'adj.', '[{"pos": "adj.", "meaning": "吉利的，有利的", "example": "The propitious timing of the product launch maximized sales.", "translation": "产品发布的吉利时机最大化了销售额。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001170-6001-0000-0000-000000000000', 'prosaic', '/proʊˈzeɪɪk/', 'adj.', '[{"pos": "adj.", "meaning": "平淡的，乏味的", "example": "The prosaic details of daily life rarely make for exciting reading.", "translation": "日常生活的平淡细节很少能成为精彩的阅读内容。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001171-6001-0000-0000-000000000000', 'proscribe', '/proʊˈskraɪb/', 'v.', '[{"pos": "v.", "meaning": "禁止，排斥", "example": "The committee proscribed the use of certain chemicals in food production.", "translation": "委员会禁止在食品生产中使用某些化学品。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001172-6001-0000-0000-000000000000', 'provenance', '/ˈprɑːvənəns/', 'n.', '[{"pos": "n.", "meaning": "来源，出处", "example": "The provenance of the painting was traced back to a 17th-century Italian studio.", "translation": "这幅画的来源可追溯到17世纪的一间意大利工作室。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001173-6001-0000-0000-000000000000', 'puerile', '/ˈpjʊərɪl/', 'adj.', '[{"pos": "adj.", "meaning": "幼稚的，不成熟的", "example": "His puerile jokes were inappropriate for the formal occasion.", "translation": "他幼稚的笑话不适合正式场合。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001174-6001-0000-0000-000000000000', 'pugnacious', '/pʌɡˈneɪʃəs/', 'adj.', '[{"pos": "adj.", "meaning": "好斗的，爱争吵的", "example": "The pugnacious politician was always ready for a debate.", "translation": "这位好斗的政治家总是准备辩论。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001175-6001-0000-0000-000000000000', 'quagmire', '/ˈkwæɡmaɪər/', 'n.', '[{"pos": "n.", "meaning": "困境，泥潭", "example": "The project became a quagmire of bureaucratic red tape.", "translation": "该项目变成了官僚主义繁文缛节的泥潭。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001176-6001-0000-0000-000000000000', 'querulous', '/ˈkwerələs/', 'adj.', '[{"pos": "adj.", "meaning": "爱抱怨的，易怒的", "example": "The querulous customer complained about everything.", "translation": "爱抱怨的顾客对一切都感到不满。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001177-6001-0000-0000-000000000000', 'quixotic', '/kwɪkˈsɑːtɪk/', 'adj.', '[{"pos": "adj.", "meaning": "不切实际的，空想的", "example": "His quixotic quest for absolute perfection was doomed to fail.", "translation": "他对绝对完美的不切实际追求注定要失败。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001178-6001-0000-0000-000000000000', 'quotidian', '/kwoʊˈtɪdiən/', 'adj.', '[{"pos": "adj.", "meaning": "日常的，平凡的", "example": "She longed for adventure to escape her quotidian existence.", "translation": "她渴望冒险来逃离平凡的生活。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001179-6001-0000-0000-000000000000', 'rancorous', '/ˈræŋkərəs/', 'adj.', '[{"pos": "adj.", "meaning": "充满怨恨的，刻毒的", "example": "The rancorous divorce proceedings dragged on for months.", "translation": "充满怨恨的离婚诉讼持续了数月。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001180-6001-0000-0000-000000000000', 'rapacious', '/rəˈpeɪʃəs/', 'adj.', '[{"pos": "adj.", "meaning": "贪婪的，掠夺性的", "example": "The rapacious corporation exploited natural resources without regard for the environment.", "translation": "贪婪的公司在不顾环境的情况下掠夺自然资源。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001181-6001-0000-0000-000000000000', 'rebuff', '/rɪˈbʌf/', 'n.', '[{"pos": "n.", "meaning": "断然拒绝，挫败", "example": "The proposal met with a firm rebuff from the committee.", "translation": "该提案遭到了委员会的断然拒绝。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001182-6001-0000-0000-000000000000', 'recluse', '/rɪˈkluːs/', 'n.', '[{"pos": "n.", "meaning": "隐士，隐居者", "example": "The famous author became a recluse in her later years.", "translation": "这位著名作家晚年成了一位隐士。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001183-6001-0000-0000-000000000000', 'redoubtable', '/rɪˈdaʊtəbəl/', 'adj.', '[{"pos": "adj.", "meaning": "令人敬畏的，可怕的", "example": "She was a redoubtable opponent in any debate.", "translation": "她在任何辩论中都是令人敬畏的对手。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001184-6001-0000-0000-000000000000', 'remorseful', '/rɪˈmɔːrsfəl/', 'adj.', '[{"pos": "adj.", "meaning": "悔恨的，懊悔的", "example": "The remorseful thief returned the stolen goods to the owner.", "translation": "悔恨的小偷将偷来的物品归还给主人。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001185-6001-0000-0000-000000000000', 'remonstrate', '/ˈremənstreɪt/', 'v.', '[{"pos": "v.", "meaning": "抗议，告诫", "example": "She remonstrated with him about his reckless behavior.", "translation": "她就他的鲁莽行为对他进行告诫。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001186-6001-0000-0000-000000000000', 'renounce', '/rɪˈnaʊns/', 'v.', '[{"pos": "v.", "meaning": "放弃，声明断绝关系", "example": "He renounced his citizenship to become a citizen of another country.", "translation": "他放弃了公民身份，成为另一个国家的公民。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001187-6001-0000-0000-000000000000', 'replete', '/rɪˈpliːt/', 'adj.', '[{"pos": "adj.", "meaning": "充满的，饱食的", "example": "The book was replete with detailed illustrations.", "translation": "这本书充满了详细的插图。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
INSERT INTO words (id, spelling, phonetic, pos, definitions, level, is_builtin) VALUES
  ('b0001188-6001-0000-0000-000000000000', 'reprehensible', '/ˌreprɪˈhensəbəl/', 'adj.', '[{"pos": "adj.", "meaning": "应受谴责的，可耻的", "example": "The fraud was reprehensible and had devastating consequences.", "translation": "欺诈行为应受谴责，造成了毁灭性的后果。"}]'::jsonb, 'GRE', true)
ON CONFLICT (spelling) DO UPDATE SET phonetic = EXCLUDED.phonetic, definitions = EXCLUDED.definitions, level = EXCLUDED.level;
...
INSERT INTO word_book_items (book_id, word_id, sort_order) VALUES
  ...
  ('a0000000-0000-0000-0000-000000000003', 'b0000593-ba01-0000-0000-000000000000', 103),
  ('a0000000-0000-0000-0000-000000000003', 'b0000594-ba01-0000-0000-000000000000', 104),
  ('a0000000-0000-0000-0000-000000000003', 'b0000595-ba01-0000-0000-000000000000', 105),
  ('a0000000-0000-0000-0000-000000000003', 'b0000596-ba01-0000-0000-000000000000', 106),
  ('a0000000-0000-0000-0000-000000000003', 'b0000597-ba01-0000-0000-000000000000', 107),
  ('a0000000-0000-0000-0000-000000000003', 'b0000598-ba01-0000-0000-000000000000', 108),
  ('a0000000-0000-0000-0000-000000000003', 'b0000599-ba01-0000-0000-000000000000', 109),
  ('a0000000-0000-0000-0000-000000000003', 'b0000600-ba01-0000-0000-000000000000', 110),
  ('a0000000-0000-0000-0000-000000000003', 'b0000601-ba01-0000-0000-000000000000', 111),
  ('a0000000-0000-0000-0000-000000000003', 'b0000602-ba01-0000-0000-000000000000', 112),
  ('a0000000-0000-0000-0000-000000000003', 'b0000603-ba01-0000-0000-000000000000', 113),
  ('a0000000-0000-0000-0000-000000000003', 'b0000604-ba01-0000-0000-000000000000', 114),
  ('a0000000-0000-0000-0000-000000000003', 'b0000605-ba01-0000-0000-000000000000', 115),
  ('a0000000-0000-0000-0000-000000000003', 'b0000606-ba01-0000-0000-000000000000', 116),
  ('a0000000-0000-0000-0000-000000000003', 'b0000607-ba01-0000-0000-000000000000', 117),
  ('a0000000-0000-0000-0000-000000000003', 'b0000608-ba01-0000-0000-000000000000', 118),
  ('a0000000-0000-0000-0000-000000000003', 'b0000609-ba01-0000-0000-000000000000', 119),
  ('a0000000-0000-0000-0000-000000000003', 'b0000610-ba01-0000-0000-000000000000', 120),
  ('a0000000-0000-0000-0000-000000000003', 'b0000611-ba01-0000-0000-000000000000', 121),
  ('a0000000-0000-0000-0000-000000000003', 'b0000612-ba01-0000-0000-000000000000', 122),
  ('a0000000-0000-0000-0000-000000000003', 'b0000613-ba01-0000-0000-000000000000', 123),
  ('a0000000-0000-0000-0000-000000000003', 'b0000614-ba01-0000-0000-000000000000', 124),
  ('a0000000-0000-0000-0000-000000000003', 'b0000615-ba01-0000-0000-000000000000', 125),
  ('a0000000-0000-0000-0000-000000000003', 'b0000616-ba01-0000-0000-000000000000', 126),
  ('a0000000-0000-0000-0000-000000000003', 'b0000617-ba01-0000-0000-000000000000', 127),
  ('a0000000-0000-0000-0000-000000000003', 'b0000618-ba01-0000-0000-000000000000', 128),
  ('a0000000-0000-0000-0000-000000000003', 'b0000619-ba01-0000-0000-000000000000', 129),
  ('a0000000-0000-0000-0000-000000000003', 'b0000620-ba01-0000-0000-000000000000', 130),
  ('a0000000-0000-0000-0000-000000000003', 'b0000621-ba01-0000-0000-000000000000', 131),
  ('a0000000-0000-0000-0000-000000000003', 'b0000622-ba01-0000-0000-000000000000', 132),
  ('a0000000-0000-0000-0000-000000000003', 'b0000623-ba01-0000-0000-000000000000', 133),
  ('a0000000-0000-0000-0000-000000000003', 'b0000624-ba01-0000-0000-000000000000', 134),
  ('a0000000-0000-0000-0000-000000000003', 'b0000625-ba01-0000-0000-000000000000', 135),
  ('a0000000-0000-0000-0000-000000000003', 'b0000626-ba01-0000-0000-000000000000', 136),
  ('a0000000-0000-0000-0000-000000000003', 'b0000627-ba01-0000-0000-000000000000', 137),
  ('a0000000-0000-0000-0000-000000000003', 'b0000628-ba01-0000-0000-000000000000', 138),
  ('a0000000-0000-0000-0000-000000000003', 'b0000629-ba01-0000-0000-000000000000', 139),
  ('a0000000-0000-0000-0000-000000000003', 'b0000630-ba01-0000-0000-000000000000', 140),
  ('a0000000-0000-0000-0000-000000000003', 'b0000631-ba01-0000-0000-000000000000', 141),
  ('a0000000-0000-0000-0000-000000000003', 'b0000632-ba01-0000-0000-000000000000', 142),
  ('a0000000-0000-0000-0000-000000000003', 'b0000633-ba01-0000-0000-000000000000', 143),
  ('a0000000-0000-0000-0000-000000000003', 'b0000634-ba01-0000-0000-000000000000', 144),
  ('a0000000-0000-0000-0000-000000000003', 'b0000635-ba01-0000-0000-000000000000', 145),
  ('a0000000-0000-0000-0000-000000000003', 'b0000636-ba01-0000-0000-000000000000', 146),
  ('a0000000-0000-0000-0000-000000000003', 'b0000637-ba01-0000-0000-000000000000', 147),
  ('a0000000-0000-0000-0000-000000000003', 'b0000638-ba01-0000-0000-000000000000', 148),
  ('a0000000-0000-0000-0000-000000000003', 'b0000639-ba01-0000-0000-000000000000', 149),
  ('a0000000-0000-0000-0000-000000000003', 'b0000640-ba01-0000-0000-000000000000', 150),
  ('a0000000-0000-0000-0000-000000000003', 'b0000705-ba01-0000-0000-000000000000', 215),
  ('a0000000-0000-0000-0000-000000000003', 'b0000706-ba01-0000-0000-000000000000', 216),
  ('a0000000-0000-0000-0000-000000000003', 'b0000707-ba01-0000-0000-000000000000', 217),
  ('a0000000-0000-0000-0000-000000000003', 'b0000708-ba01-0000-0000-000000000000', 218),
  ('a0000000-0000-0000-0000-000000000003', 'b0000709-ba01-0000-0000-000000000000', 219),
  ('a0000000-0000-0000-0000-000000000003', 'b0000710-ba01-0000-0000-000000000000', 220),
  ('a0000000-0000-0000-0000-000000000003', 'b0000711-ba01-0000-0000-000000000000', 221),
  ('a0000000-0000-0000-0000-000000000003', 'b0000712-ba01-0000-0000-000000000000', 222),
  ('a0000000-0000-0000-0000-000000000003', 'b0000713-ba01-0000-0000-000000000000', 223),
  ('a0000000-0000-0000-0000-000000000003', 'b0000714-ba01-0000-0000-000000000000', 224),
  ('a0000000-0000-0000-0000-000000000003', 'b0000715-ba01-0000-0000-000000000000', 225),
  ('a0000000-0000-0000-0000-000000000003', 'b0000716-ba01-0000-0000-000000000000', 226),
  ('a0000000-0000-0000-0000-000000000003', 'b0000717-ba01-0000-0000-000000000000', 227),
  ('a0000000-0000-0000-0000-000000000003', 'b0000718-ba01-0000-0000-000000000000', 228),
  ('a0000000-0000-0000-0000-000000000003', 'b0000719-ba01-0000-0000-000000000000', 229),
  ('a0000000-0000-0000-0000-000000000003', 'b0000720-ba01-0000-0000-000000000000', 230),
  ('a0000000-0000-0000-0000-000000000003', 'b0000721-ba01-0000-0000-000000000000', 231),
  ('a0000000-0000-0000-0000-000000000003', 'b0000722-ba01-0000-0000-000000000000', 232),
  ('a0000000-0000-0000-0000-000000000003', 'b0000723-ba01-0000-0000-000000000000', 233),
  ('a0000000-0000-0000-0000-000000000003', 'b0000724-ba01-0000-0000-000000000000', 234),
  ('a0000000-0000-0000-0000-000000000003', 'b0000725-ba01-0000-0000-000000000000', 235),
  ('a0000000-0000-0000-0000-000000000003', 'b0000726-ba01-0000-0000-000000000000', 236),
  ('a0000000-0000-0000-0000-000000000003', 'b0000727-ba01-0000-0000-000000000000', 237),
  ('a0000000-0000-0000-0000-000000000003', 'b0000728-ba01-0000-0000-000000000000', 238),
  ('a0000000-0000-0000-0000-000000000003', 'b0000729-ba01-0000-0000-000000000000', 239),
  ('a0000000-0000-0000-0000-000000000003', 'b0000730-ba01-0000-0000-000000000000', 240),
  ('a0000000-0000-0000-0000-000000000003', 'b0000731-ba01-0000-0000-000000000000', 241),
  ('a0000000-0000-0000-0000-000000000003', 'b0000732-ba01-0000-0000-000000000000', 242),
  ('a0000000-0000-0000-0000-000000000003', 'b0000733-ba01-0000-0000-000000000000', 243),
  ('a0000000-0000-0000-0000-000000000003', 'b0000734-ba01-0000-0000-000000000000', 244),
  ('a0000000-0000-0000-0000-000000000003', 'b0000735-ba01-0000-0000-000000000000', 245),
  ('a0000000-0000-0000-0000-000000000003', 'b0000736-ba01-0000-0000-000000000000', 246),
  ('a0000000-0000-0000-0000-000000000003', 'b0000737-ba01-0000-0000-000000000000', 247),
  ('a0000000-0000-0000-0000-000000000003', 'b0000738-ba01-0000-0000-000000000000', 248),
  ('a0000000-0000-0000-0000-000000000003', 'b0000739-ba01-0000-0000-000000000000', 249),
  ('a0000000-0000-0000-0000-000000000003', 'b0000740-ba01-0000-0000-000000000000', 250),
  ('a0000000-0000-0000-0000-000000000003', 'b0000741-ba01-0000-0000-000000000000', 251),
  ('a0000000-0000-0000-0000-000000000003', 'b0000742-ba01-0000-0000-000000000000', 252),
  ('a0000000-0000-0000-0000-000000000003', 'b0000743-ba01-0000-0000-000000000000', 253),
  ('a0000000-0000-0000-0000-000000000003', 'b0000744-ba01-0000-0000-000000000000', 254),
  ('a0000000-0000-0000-0000-000000000003', 'b0000745-ba01-0000-0000-000000000000', 255),
  ('a0000000-0000-0000-0000-000000000003', 'b0000746-ba01-0000-0000-000000000000', 256),
  ('a0000000-0000-0000-0000-000000000003', 'b0000747-ba01-0000-0000-000000000000', 257),
  ('a0000000-0000-0000-0000-000000000003', 'b0000748-ba01-0000-0000-000000000000', 258),
  ('a0000000-0000-0000-0000-000000000003', 'b0000749-ba01-0000-0000-000000000000', 259),
  ('a0000000-0000-0000-0000-000000000003', 'b0000750-ba01-0000-0000-000000000000', 260),
  ('a0000000-0000-0000-0000-000000000003', 'b0000751-ba01-0000-0000-000000000000', 261),
  ('a0000000-0000-0000-0000-000000000003', 'b0000752-ba01-0000-0000-000000000000', 262),
  ('a0000000-0000-0000-0000-000000000003', 'b0000753-ba01-0000-0000-000000000000', 263),
  ('a0000000-0000-0000-0000-000000000003', 'b0000754-ba01-0000-0000-000000000000', 264),
  ('a0000000-0000-0000-0000-000000000003', 'b0000755-ba01-0000-0000-000000000000', 265),
  ('a0000000-0000-0000-0000-000000000003', 'b0000756-ba01-0000-0000-000000000000', 266),
  ('a0000000-0000-0000-0000-000000000003', 'b0000757-ba01-0000-0000-000000000000', 267),
  ('a0000000-0000-0000-0000-000000000003', 'b0000758-ba01-0000-0000-000000000000', 268),
  ('a0000000-0000-0000-0000-000000000003', 'b0000759-ba01-0000-0000-000000000000', 269),
  ('a0000000-0000-0000-0000-000000000003', 'b0000760-ba01-0000-0000-000000000000', 270),
  ('a0000000-0000-0000-0000-000000000003', 'b0000761-ba01-0000-0000-000000000000', 271),
  ('a0000000-0000-0000-0000-000000000003', 'b0000762-ba01-0000-0000-000000000000', 272),
  ('a0000000-0000-0000-0000-000000000003', 'b0000763-ba01-0000-0000-000000000000', 273),
  ('a0000000-0000-0000-0000-000000000003', 'b0000764-ba01-0000-0000-000000000000', 274),
  ('a0000000-0000-0000-0000-000000000003', 'b0000765-ba01-0000-0000-000000000000', 275),
  ('a0000000-0000-0000-0000-000000000003', 'b0000766-ba01-0000-0000-000000000000', 276),
  ('a0000000-0000-0000-0000-000000000003', 'b0000767-ba01-0000-0000-000000000000', 277),
  ('a0000000-0000-0000-0000-000000000003', 'b0000768-ba01-0000-0000-000000000000', 278),
  ('a0000000-0000-0000-0000-000000000003', 'b0000769-ba01-0000-0000-000000000000', 279),
  ('a0000000-0000-0000-0000-000000000003', 'b0000770-ba01-0000-0000-000000000000', 280),
  ('a0000000-0000-0000-0000-000000000003', 'b0000771-ba01-0000-0000-000000000000', 281),
  ('a0000000-0000-0000-0000-000000000003', 'b0000772-ba01-0000-0000-000000000000', 282),
  ('a0000000-0000-0000-0000-000000000003', 'b0000773-ba01-0000-0000-000000000000', 283),
  ('a0000000-0000-0000-0000-000000000003', 'b0000774-ba01-0000-0000-000000000000', 284),
  ('a0000000-0000-0000-0000-000000000003', 'b0000775-ba01-0000-0000-000000000000', 285),
  ('a0000000-0000-0000-0000-000000000003', 'b0000776-ba01-0000-0000-000000000000', 286),
  ('a0000000-0000-0000-0000-000000000003', 'b0000777-ba01-0000-0000-000000000000', 287),
  ('a0000000-0000-0000-0000-000000000003', 'b0000778-ba01-0000-0000-000000000000', 288),
  ('a0000000-0000-0000-0000-000000000003', 'b0000779-ba01-0000-0000-000000000000', 289),
  ('a0000000-0000-0000-0000-000000000003', 'b0000780-ba01-0000-0000-000000000000', 290),
  ('a0000000-0000-0000-0000-000000000003', 'b0000781-ba01-0000-0000-000000000000', 291),
  ('a0000000-0000-0000-0000-000000000003', 'b0000782-ba01-0000-0000-000000000000', 292),
  ('a0000000-0000-0000-0000-000000000003', 'b0000783-ba01-0000-0000-000000000000', 293),
  ('a0000000-0000-0000-0000-000000000003', 'b0000784-ba01-0000-0000-000000000000', 294),
  ('a0000000-0000-0000-0000-000000000003', 'b0000785-ba01-0000-0000-000000000000', 295),
  ('a0000000-0000-0000-0000-000000000003', 'b0000786-ba01-0000-0000-000000000000', 296),
  ('a0000000-0000-0000-0000-000000000003', 'b0000787-ba01-0000-0000-000000000000', 297),
  ('a0000000-0000-0000-0000-000000000003', 'b0000788-ba01-0000-0000-000000000000', 298),
  ('a0000000-0000-0000-0000-000000000003', 'b0000789-ba01-0000-0000-000000000000', 299)
ON CONFLICT (book_id, word_id) DO NOTHING;

-- IELTS book items (300)
INSERT INTO word_book_items (book_id, word_id, sort_order) VALUES
  ...
  ('a0000000-0000-0000-0000-000000000004', 'b0000595-ba01-0000-0000-000000000000', 136),
  ('a0000000-0000-0000-0000-000000000004', 'b0000597-ba01-0000-0000-000000000000', 137),
  ('a0000000-0000-0000-0000-000000000004', 'b0000617-ba01-0000-0000-000000000000', 138),
  ('a0000000-0000-0000-0000-000000000004', 'b0000618-ba01-0000-0000-000000000000', 139),
  ('a0000000-0000-0000-0000-000000000004', 'b0000620-ba01-0000-0000-000000000000', 140),
  ('a0000000-0000-0000-0000-000000000004', 'b0000621-ba01-0000-0000-000000000000', 141),
  ('a0000000-0000-0000-0000-000000000004', 'b0000626-ba01-0000-0000-000000000000', 142),
  ('a0000000-0000-0000-0000-000000000004', 'b0000655-ba01-0000-0000-000000000000', 143),
  ('a0000000-0000-0000-0000-000000000004', 'b0000659-ba01-0000-0000-000000000000', 144),
  ('a0000000-0000-0000-0000-000000000004', 'b0000875-1e01-0000-0000-000000000000', 272),
  ('a0000000-0000-0000-0000-000000000004', 'b0000876-1e01-0000-0000-000000000000', 273),
  ('a0000000-0000-0000-0000-000000000004', 'b0000877-1e01-0000-0000-000000000000', 274),
  ('a0000000-0000-0000-0000-000000000004', 'b0000878-1e01-0000-0000-000000000000', 275),
  ('a0000000-0000-0000-0000-000000000004', 'b0000879-1e01-0000-0000-000000000000', 276),
  ('a0000000-0000-0000-0000-000000000004', 'b0000880-1e01-0000-0000-000000000000', 277),
  ('a0000000-0000-0000-0000-000000000004', 'b0000881-1e01-0000-0000-000000000000', 278),
  ('a0000000-0000-0000-0000-000000000004', 'b0000882-1e01-0000-0000-000000000000', 279),
  ('a0000000-0000-0000-0000-000000000004', 'b0000883-1e01-0000-0000-000000000000', 280),
  ('a0000000-0000-0000-0000-000000000004', 'b0000884-1e01-0000-0000-000000000000', 281),
  ('a0000000-0000-0000-0000-000000000004', 'b0000885-1e01-0000-0000-000000000000', 282),
  ('a0000000-0000-0000-0000-000000000004', 'b0000886-1e01-0000-0000-000000000000', 283),
  ('a0000000-0000-0000-0000-000000000004', 'b0000887-1e01-0000-0000-000000000000', 284),
  ('a0000000-0000-0000-0000-000000000004', 'b0000888-1e01-0000-0000-000000000000', 285),
  ('a0000000-0000-0000-0000-000000000004', 'b0000889-1e01-0000-0000-000000000000', 286),
  ('a0000000-0000-0000-0000-000000000004', 'b0000890-1e01-0000-0000-000000000000', 287),
  ('a0000000-0000-0000-0000-000000000004', 'b0000891-1e01-0000-0000-000000000000', 288),
  ('a0000000-0000-0000-0000-000000000004', 'b0000892-1e01-0000-0000-000000000000', 289),
  ('a0000000-0000-0000-0000-000000000004', 'b0000893-1e01-0000-0000-000000000000', 290),
  ('a0000000-0000-0000-0000-000000000004', 'b0000894-1e01-0000-0000-000000000000', 291),
  ('a0000000-0000-0000-0000-000000000004', 'b0000895-1e01-0000-0000-000000000000', 292),
  ('a0000000-0000-0000-0000-000000000004', 'b0000896-1e01-0000-0000-000000000000', 293),
  ('a0000000-0000-0000-0000-000000000004', 'b0000897-1e01-0000-0000-000000000000', 294),
  ('a0000000-0000-0000-0000-000000000004', 'b0000898-1e01-0000-0000-000000000000', 295),
  ('a0000000-0000-0000-0000-000000000004', 'b0000899-1e01-0000-0000-000000000000', 296),
  ('a0000000-0000-0000-0000-000000000004', 'b0000900-1e01-0000-0000-000000000000', 297),
  ('a0000000-0000-0000-0000-000000000004', 'b0000901-1e01-0000-0000-000000000000', 298),
  ('a0000000-0000-0000-0000-000000000004', 'b0000902-1e01-0000-0000-000000000000', 299)
ON CONFLICT (book_id, word_id) DO NOTHING;

-- TOEFL book items (300)
INSERT INTO word_book_items (book_id, word_id, sort_order) VALUES
  ...
  ('a0000000-0000-0000-0000-000000000005', 'b0000596-ba01-0000-0000-000000000000', 80),
  ('a0000000-0000-0000-0000-000000000005', 'b0000611-ba01-0000-0000-000000000000', 81),
  ('a0000000-0000-0000-0000-000000000005', 'b0000612-ba01-0000-0000-000000000000', 82),
  ('a0000000-0000-0000-0000-000000000005', 'b0000613-ba01-0000-0000-000000000000', 83),
  ('a0000000-0000-0000-0000-000000000005', 'b0000614-ba01-0000-0000-000000000000', 84),
  ('a0000000-0000-0000-0000-000000000005', 'b0000615-ba01-0000-0000-000000000000', 85),
  ('a0000000-0000-0000-0000-000000000005', 'b0000616-ba01-0000-0000-000000000000', 86),
  ('a0000000-0000-0000-0000-000000000005', 'b0000617-ba01-0000-0000-000000000000', 87),
  ('a0000000-0000-0000-0000-000000000005', 'b0000620-ba01-0000-0000-000000000000', 88),
  ('a0000000-0000-0000-0000-000000000005', 'b0000621-ba01-0000-0000-000000000000', 89),
  ('a0000000-0000-0000-0000-000000000005', 'b0000622-ba01-0000-0000-000000000000', 90),
  ('a0000000-0000-0000-0000-000000000005', 'b0000626-ba01-0000-0000-000000000000', 91),
  ('a0000000-0000-0000-0000-000000000005', 'b0000627-ba01-0000-0000-000000000000', 92),
  ('a0000000-0000-0000-0000-000000000005', 'b0000628-ba01-0000-0000-000000000000', 93),
  ('a0000000-0000-0000-0000-000000000005', 'b0000631-ba01-0000-0000-000000000000', 94),
  ('a0000000-0000-0000-0000-000000000005', 'b0000635-ba01-0000-0000-000000000000', 95),
  ('a0000000-0000-0000-0000-000000000005', 'b0000637-ba01-0000-0000-000000000000', 96),
  ('a0000000-0000-0000-0000-000000000005', 'b0000639-ba01-0000-0000-000000000000', 97),
  ('a0000000-0000-0000-0000-000000000005', 'b0000640-ba01-0000-0000-000000000000', 98),
  ('a0000000-0000-0000-0000-000000000005', 'b0000644-ba01-0000-0000-000000000000', 99),
  ('a0000000-0000-0000-0000-000000000005', 'b0000645-ba01-0000-0000-000000000000', 100),
  ('a0000000-0000-0000-0000-000000000005', 'b0000646-ba01-0000-0000-000000000000', 101),
  ('a0000000-0000-0000-0000-000000000005', 'b0000647-ba01-0000-0000-000000000000', 102),
  ('a0000000-0000-0000-0000-000000000005', 'b0000651-ba01-0000-0000-000000000000', 103),
  ('a0000000-0000-0000-0000-000000000005', 'b0000655-ba01-0000-0000-000000000000', 104),
  ('a0000000-0000-0000-0000-000000000005', 'b0000658-ba01-0000-0000-000000000000', 105),
  ('a0000000-0000-0000-0000-000000000005', 'b0000659-ba01-0000-0000-000000000000', 106),
  ('a0000000-0000-0000-0000-000000000005', 'b0000660-ba01-0000-0000-000000000000', 107),
  ('a0000000-0000-0000-0000-000000000005', 'b0000661-ba01-0000-0000-000000000000', 108),
  ('a0000000-0000-0000-0000-000000000005', 'b0000663-ba01-0000-0000-000000000000', 109),
  ('a0000000-0000-0000-0000-000000000005', 'b0000664-ba01-0000-0000-000000000000', 110),
  ('a0000000-0000-0000-0000-000000000005', 'b0000666-ba01-0000-0000-000000000000', 111),
  ('a0000000-0000-0000-0000-000000000005', 'b0000667-ba01-0000-0000-000000000000', 112),
  ('a0000000-0000-0000-0000-000000000005', 'b0000670-ba01-0000-0000-000000000000', 113),
  ('a0000000-0000-0000-0000-000000000005', 'b0000673-ba01-0000-0000-000000000000', 114),
  ('a0000000-0000-0000-0000-000000000005', 'b0000677-ba01-0000-0000-000000000000', 115),
  ('a0000000-0000-0000-0000-000000000005', 'b0000678-ba01-0000-0000-000000000000', 116),
  ('a0000000-0000-0000-0000-000000000005', 'b0000681-ba01-0000-0000-000000000000', 117),
  ('a0000000-0000-0000-0000-000000000005', 'b0000683-ba01-0000-0000-000000000000', 118),
  ('a0000000-0000-0000-0000-000000000005', 'b0000684-ba01-0000-0000-000000000000', 119),
  ('a0000000-0000-0000-0000-000000000005', 'b0000689-ba01-0000-0000-000000000000', 120),
  ('a0000000-0000-0000-0000-000000000005', 'b0000690-ba01-0000-0000-000000000000', 121),
  ('a0000000-0000-0000-0000-000000000005', 'b0000692-ba01-0000-0000-000000000000', 122),
  ('a0000000-0000-0000-0000-000000000005', 'b0000693-ba01-0000-0000-000000000000', 123),
  ('a0000000-0000-0000-0000-000000000005', 'b0000694-ba01-0000-0000-000000000000', 124),
  ('a0000000-0000-0000-0000-000000000005', 'b0000695-ba01-0000-0000-000000000000', 125),
  ('a0000000-0000-0000-0000-000000000005', 'b0000696-ba01-0000-0000-000000000000', 126),
  ('a0000000-0000-0000-0000-000000000005', 'b0000697-ba01-0000-0000-000000000000', 127),
  ('a0000000-0000-0000-0000-000000000005', 'b0000698-ba01-0000-0000-000000000000', 128),
  ('a0000000-0000-0000-0000-000000000005', 'b0000699-ba01-0000-0000-000000000000', 129),
  ('a0000000-0000-0000-0000-000000000005', 'b0000700-ba01-0000-0000-000000000000', 130),
  ('a0000000-0000-0000-0000-000000000005', 'b0000701-ba01-0000-0000-000000000000', 131),
  ('a0000000-0000-0000-0000-000000000005', 'b0000702-ba01-0000-0000-000000000000', 132),
  ('a0000000-0000-0000-0000-000000000005', 'b0000703-ba01-0000-0000-000000000000', 133),
  ('a0000000-0000-0000-0000-000000000005', 'b0000704-ba01-0000-0000-000000000000', 134),
  ('a0000000-0000-0000-0000-000000000005', 'b0000707-ba01-0000-0000-000000000000', 135),
  ('a0000000-0000-0000-0000-000000000005', 'b0000708-ba01-0000-0000-000000000000', 136),
  ('a0000000-0000-0000-0000-000000000005', 'b0000711-ba01-0000-0000-000000000000', 137),
  ('a0000000-0000-0000-0000-000000000005', 'b0000715-ba01-0000-0000-000000000000', 138),
  ('a0000000-0000-0000-0000-000000000005', 'b0000717-ba01-0000-0000-000000000000', 139),
  ('a0000000-0000-0000-0000-000000000005', 'b0000718-ba01-0000-0000-000000000000', 140),
  ('a0000000-0000-0000-0000-000000000005', 'b0000719-ba01-0000-0000-000000000000', 141),
  ('a0000000-0000-0000-0000-000000000005', 'b0000720-ba01-0000-0000-000000000000', 142),
  ('a0000000-0000-0000-0000-000000000005', 'b0000721-ba01-0000-0000-000000000000', 143),
  ('a0000000-0000-0000-0000-000000000005', 'b0000722-ba01-0000-0000-000000000000', 144),
  ('a0000000-0000-0000-0000-000000000005', 'b0000723-ba01-0000-0000-000000000000', 145),
  ('a0000000-0000-0000-0000-000000000005', 'b0000725-ba01-0000-0000-000000000000', 146),
  ('a0000000-0000-0000-0000-000000000005', 'b0000727-ba01-0000-0000-000000000000', 147),
  ('a0000000-0000-0000-0000-000000000005', 'b0000732-ba01-0000-0000-000000000000', 148),
  ('a0000000-0000-0000-0000-000000000005', 'b0000733-ba01-0000-0000-000000000000', 149),
  ('a0000000-0000-0000-0000-000000000005', 'b0000735-ba01-0000-0000-000000000000', 150),
  ('a0000000-0000-0000-0000-000000000005', 'b0000736-ba01-0000-0000-000000000000', 151),
  ('a0000000-0000-0000-0000-000000000005', 'b0000738-ba01-0000-0000-000000000000', 152),
  ('a0000000-0000-0000-0000-000000000005', 'b0000739-ba01-0000-0000-000000000000', 153),
  ('a0000000-0000-0000-0000-000000000005', 'b0000740-ba01-0000-0000-000000000000', 154),
  ('a0000000-0000-0000-0000-000000000005', 'b0000741-ba01-0000-0000-000000000000', 155),
  ('a0000000-0000-0000-0000-000000000005', 'b0000742-ba01-0000-0000-000000000000', 156),
  ('a0000000-0000-0000-0000-000000000005', 'b0000743-ba01-0000-0000-000000000000', 157),
  ('a0000000-0000-0000-0000-000000000005', 'b0000744-ba01-0000-0000-000000000000', 158),
  ('a0000000-0000-0000-0000-000000000005', 'b0000748-ba01-0000-0000-000000000000', 159),
  ('a0000000-0000-0000-0000-000000000005', 'b0000749-ba01-0000-0000-000000000000', 160),
  ('a0000000-0000-0000-0000-000000000005', 'b0000750-ba01-0000-0000-000000000000', 161),
  ('a0000000-0000-0000-0000-000000000005', 'b0000751-ba01-0000-0000-000000000000', 162),
  ('a0000000-0000-0000-0000-000000000005', 'b0000752-ba01-0000-0000-000000000000', 163),
  ('a0000000-0000-0000-0000-000000000005', 'b0000753-ba01-0000-0000-000000000000', 164),
  ('a0000000-0000-0000-0000-000000000005', 'b0000754-ba01-0000-0000-000000000000', 165),
  ('a0000000-0000-0000-0000-000000000005', 'b0000756-ba01-0000-0000-000000000000', 166),
  ('a0000000-0000-0000-0000-000000000005', 'b0000757-ba01-0000-0000-000000000000', 167),
  ('a0000000-0000-0000-0000-000000000005', 'b0000758-ba01-0000-0000-000000000000', 168),
  ('a0000000-0000-0000-0000-000000000005', 'b0000762-ba01-0000-0000-000000000000', 169),
  ('a0000000-0000-0000-0000-000000000005', 'b0000763-ba01-0000-0000-000000000000', 170),
  ('a0000000-0000-0000-0000-000000000005', 'b0000766-ba01-0000-0000-000000000000', 171),
  ('a0000000-0000-0000-0000-000000000005', 'b0000767-ba01-0000-0000-000000000000', 172),
  ('a0000000-0000-0000-0000-000000000005', 'b0000771-ba01-0000-0000-000000000000', 173),
  ('a0000000-0000-0000-0000-000000000005', 'b0000772-ba01-0000-0000-000000000000', 174),
  ('a0000000-0000-0000-0000-000000000005', 'b0000774-ba01-0000-0000-000000000000', 175),
  ('a0000000-0000-0000-0000-000000000005', 'b0000775-ba01-0000-0000-000000000000', 176),
  ('a0000000-0000-0000-0000-000000000005', 'b0000850-1e01-0000-0000-000000000000', 209),
  ('a0000000-0000-0000-0000-000000000005', 'b0000851-1e01-0000-0000-000000000000', 210),
  ('a0000000-0000-0000-0000-000000000005', 'b0000852-1e01-0000-0000-000000000000', 211),
  ('a0000000-0000-0000-0000-000000000005', 'b0000853-1e01-0000-0000-000000000000', 212),
  ('a0000000-0000-0000-0000-000000000005', 'b0000854-1e01-0000-0000-000000000000', 213),
  ('a0000000-0000-0000-0000-000000000005', 'b0000856-1e01-0000-0000-000000000000', 214),
  ('a0000000-0000-0000-0000-000000000005', 'b0000857-1e01-0000-0000-000000000000', 215),
  ('a0000000-0000-0000-0000-000000000005', 'b0000858-1e01-0000-0000-000000000000', 216),
  ('a0000000-0000-0000-0000-000000000005', 'b0000859-1e01-0000-0000-000000000000', 217),
  ('a0000000-0000-0000-0000-000000000005', 'b0000861-1e01-0000-0000-000000000000', 218),
  ('a0000000-0000-0000-0000-000000000005', 'b0000862-1e01-0000-0000-000000000000', 219),
  ('a0000000-0000-0000-0000-000000000005', 'b0000864-1e01-0000-0000-000000000000', 220),
  ('a0000000-0000-0000-0000-000000000005', 'b0000865-1e01-0000-0000-000000000000', 221),
  ('a0000000-0000-0000-0000-000000000005', 'b0000866-1e01-0000-0000-000000000000', 222),
  ('a0000000-0000-0000-0000-000000000005', 'b0000868-1e01-0000-0000-000000000000', 223),
  ('a0000000-0000-0000-0000-000000000005', 'b0000875-1e01-0000-0000-000000000000', 224),
  ('a0000000-0000-0000-0000-000000000005', 'b0000876-1e01-0000-0000-000000000000', 225),
  ('a0000000-0000-0000-0000-000000000005', 'b0000878-1e01-0000-0000-000000000000', 226),
  ('a0000000-0000-0000-0000-000000000005', 'b0000880-1e01-0000-0000-000000000000', 227),
  ('a0000000-0000-0000-0000-000000000005', 'b0000883-1e01-0000-0000-000000000000', 228),
  ('a0000000-0000-0000-0000-000000000005', 'b0000887-1e01-0000-0000-000000000000', 229),
  ('a0000000-0000-0000-0000-000000000005', 'b0000888-1e01-0000-0000-000000000000', 230),
  ('a0000000-0000-0000-0000-000000000005', 'b0000889-1e01-0000-0000-000000000000', 231),
  ('a0000000-0000-0000-0000-000000000005', 'b0000890-1e01-0000-0000-000000000000', 232),
  ('a0000000-0000-0000-0000-000000000005', 'b0000891-1e01-0000-0000-000000000000', 233),
  ('a0000000-0000-0000-0000-000000000005', 'b0000892-1e01-0000-0000-000000000000', 234),
  ('a0000000-0000-0000-0000-000000000005', 'b0000893-1e01-0000-0000-000000000000', 235),
  ('a0000000-0000-0000-0000-000000000005', 'b0000894-1e01-0000-0000-000000000000', 236),
  ('a0000000-0000-0000-0000-000000000005', 'b0000895-1e01-0000-0000-000000000000', 237),
  ('a0000000-0000-0000-0000-000000000005', 'b0000896-1e01-0000-0000-000000000000', 238),
  ('a0000000-0000-0000-0000-000000000005', 'b0000897-1e01-0000-0000-000000000000', 239),
  ('a0000000-0000-0000-0000-000000000005', 'b0000899-1e01-0000-0000-000000000000', 240),
  ('a0000000-0000-0000-0000-000000000005', 'b0000902-1e01-0000-0000-000000000000', 241),
  ('a0000000-0000-0000-0000-000000000005', 'b0000903-7001-0000-0000-000000000000', 242),
  ('a0000000-0000-0000-0000-000000000005', 'b0000904-7001-0000-0000-000000000000', 243),
  ('a0000000-0000-0000-0000-000000000005', 'b0000905-7001-0000-0000-000000000000', 244),
  ('a0000000-0000-0000-0000-000000000005', 'b0000906-7001-0000-0000-000000000000', 245),
  ('a0000000-0000-0000-0000-000000000005', 'b0000907-7001-0000-0000-000000000000', 246),
  ('a0000000-0000-0000-0000-000000000005', 'b0000908-7001-0000-0000-000000000000', 247),
  ('a0000000-0000-0000-0000-000000000005', 'b0000909-7001-0000-0000-000000000000', 248),
  ('a0000000-0000-0000-0000-000000000005', 'b0000910-7001-0000-0000-000000000000', 249),
  ('a0000000-0000-0000-0000-000000000005', 'b0000911-7001-0000-0000-000000000000', 250),
  ('a0000000-0000-0000-0000-000000000005', 'b0000912-7001-0000-0000-000000000000', 251),
  ('a0000000-0000-0000-0000-000000000005', 'b0000913-7001-0000-0000-000000000000', 252),
  ('a0000000-0000-0000-0000-000000000005', 'b0000914-7001-0000-0000-000000000000', 253),
  ('a0000000-0000-0000-0000-000000000005', 'b0000915-7001-0000-0000-000000000000', 254),
  ('a0000000-0000-0000-0000-000000000005', 'b0000916-7001-0000-0000-000000000000', 255),
  ('a0000000-0000-0000-0000-000000000005', 'b0000917-7001-0000-0000-000000000000', 256),
  ('a0000000-0000-0000-0000-000000000005', 'b0000918-7001-0000-0000-000000000000', 257),
  ('a0000000-0000-0000-0000-000000000005', 'b0000919-7001-0000-0000-000000000000', 258),
  ('a0000000-0000-0000-0000-000000000005', 'b0000920-7001-0000-0000-000000000000', 259),
  ('a0000000-0000-0000-0000-000000000005', 'b0000921-7001-0000-0000-000000000000', 260),
  ('a0000000-0000-0000-0000-000000000005', 'b0000922-7001-0000-0000-000000000000', 261),
  ('a0000000-0000-0000-0000-000000000005', 'b0000923-7001-0000-0000-000000000000', 262),
  ('a0000000-0000-0000-0000-000000000005', 'b0000924-7001-0000-0000-000000000000', 263),
  ('a0000000-0000-0000-0000-000000000005', 'b0000925-7001-0000-0000-000000000000', 264),
  ('a0000000-0000-0000-0000-000000000005', 'b0000926-7001-0000-0000-000000000000', 265),
  ('a0000000-0000-0000-0000-000000000005', 'b0000927-7001-0000-0000-000000000000', 266),
  ('a0000000-0000-0000-0000-000000000005', 'b0000928-7001-0000-0000-000000000000', 267),
  ('a0000000-0000-0000-0000-000000000005', 'b0000929-7001-0000-0000-000000000000', 268),
  ('a0000000-0000-0000-0000-000000000005', 'b0000930-7001-0000-0000-000000000000', 269),
  ('a0000000-0000-0000-0000-000000000005', 'b0000931-7001-0000-0000-000000000000', 270),
  ('a0000000-0000-0000-0000-000000000005', 'b0000932-7001-0000-0000-000000000000', 271),
  ('a0000000-0000-0000-0000-000000000005', 'b0000933-7001-0000-0000-000000000000', 272),
  ('a0000000-0000-0000-0000-000000000005', 'b0000934-7001-0000-0000-000000000000', 273),
  ('a0000000-0000-0000-0000-000000000005', 'b0000935-7001-0000-0000-000000000000', 274),
  ('a0000000-0000-0000-0000-000000000005', 'b0000936-7001-0000-0000-000000000000', 275),
  ('a0000000-0000-0000-0000-000000000005', 'b0000937-7001-0000-0000-000000000000', 276),
  ('a0000000-0000-0000-0000-000000000005', 'b0000938-7001-0000-0000-000000000000', 277),
  ('a0000000-0000-0000-0000-000000000005', 'b0000939-7001-0000-0000-000000000000', 278),
  ('a0000000-0000-0000-0000-000000000005', 'b0000940-7001-0000-0000-000000000000', 279),
  ('a0000000-0000-0000-0000-000000000005', 'b0000941-7001-0000-0000-000000000000', 280),
  ('a0000000-0000-0000-0000-000000000005', 'b0000942-7001-0000-0000-000000000000', 281),
  ('a0000000-0000-0000-0000-000000000005', 'b0000943-7001-0000-0000-000000000000', 282),
  ('a0000000-0000-0000-0000-000000000005', 'b0000944-7001-0000-0000-000000000000', 283),
  ('a0000000-0000-0000-0000-000000000005', 'b0000945-7001-0000-0000-000000000000', 284),
  ('a0000000-0000-0000-0000-000000000005', 'b0000946-7001-0000-0000-000000000000', 285),
  ('a0000000-0000-0000-0000-000000000005', 'b0000947-7001-0000-0000-000000000000', 286),
  ('a0000000-0000-0000-0000-000000000005', 'b0000948-7001-0000-0000-000000000000', 287),
  ('a0000000-0000-0000-0000-000000000005', 'b0000949-7001-0000-0000-000000000000', 288),
  ('a0000000-0000-0000-0000-000000000005', 'b0000950-7001-0000-0000-000000000000', 289),
  ('a0000000-0000-0000-0000-000000000005', 'b0000951-7001-0000-0000-000000000000', 290),
  ('a0000000-0000-0000-0000-000000000005', 'b0000952-7001-0000-0000-000000000000', 291),
  ('a0000000-0000-0000-0000-000000000005', 'b0000953-7001-0000-0000-000000000000', 292),
  ('a0000000-0000-0000-0000-000000000005', 'b0000954-7001-0000-0000-000000000000', 293),
  ('a0000000-0000-0000-0000-000000000005', 'b0000955-7001-0000-0000-000000000000', 294),
  ('a0000000-0000-0000-0000-000000000005', 'b0000956-7001-0000-0000-000000000000', 295),
  ('a0000000-0000-0000-0000-000000000005', 'b0000957-7001-0000-0000-000000000000', 296),
  ('a0000000-0000-0000-0000-000000000005', 'b0000958-7001-0000-0000-000000000000', 297),
  ('a0000000-0000-0000-0000-000000000005', 'b0000959-7001-0000-0000-000000000000', 298),
  ('a0000000-0000-0000-0000-000000000005', 'b0000960-7001-0000-0000-000000000000', 299)
ON CONFLICT (book_id, word_id) DO NOTHING;
...
INSERT INTO word_book_items (book_id, word_id, sort_order) VALUES
  ...
  ('a0000000-0000-0000-0000-000000000006', 'b0000640-ba01-0000-0000-000000000000', 68),
  ('a0000000-0000-0000-0000-000000000006', 'b0000653-ba01-0000-0000-000000000000', 69),
  ('a0000000-0000-0000-0000-000000000006', 'b0000907-7001-0000-0000-000000000000', 70),
  ('a0000000-0000-0000-0000-000000000006', 'b0000961-6001-0000-0000-000000000000', 71),
